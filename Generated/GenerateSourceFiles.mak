...
CpCppCore:   $(proxyCppCore)CpUpnpOrgAVTransport1.cpp $(proxyCppCore)CpUpnpOrgAVTransport2.cpp $(proxyCppCore)CpUpnpOrgConnectionManager1.cpp $(proxyCppCore)CpUpnpOrgConnectionManager2.cpp $(proxyCppCore)CpUpnpOrgContentDirectory1.cpp $(proxyCppCore)CpUpnpOrgContentDirectory2.cpp $(proxyCppCore)CpUpnpOrgContentDirectory3.cpp $(proxyCppCore)CpUpnpOrgRenderingControl1.cpp $(proxyCppCore)CpUpnpOrgRenderingControl2.cpp $(proxyCppCore)CpUpnpOrgScheduledRecording1.cpp $(proxyCppCore)CpUpnpOrgScheduledRecording2.cpp $(proxyCppCore)CpUpnpOrgSwitchPower1.cpp $(proxyCppCore)CpUpnpOrgDimming1.cpp $(proxyCppCore)CpAvOpenhomeOrgInfo1.cpp $(proxyCppCore)CpAvOpenhomeOrgTime1.cpp $(proxyCppCore)CpAvOpenhomeOrgPlaylist1.cpp $(proxyCppCore)CpAvOpenhomeOrgVolume1.cpp $(proxyCppCore)CpAvOpenhomeOrgHardwareConfig1.cpp $(proxyCppCore)CpAvOpenhomeOrgTestResamplerConfig1.cpp $(proxyCppCore)CpAvOpenhomeOrgWebRendererConfig1.cpp $(proxyCppCore)CpAvOpenhomeOrgWebDeviceConfig1.cpp $(proxyCppCore)CpAvOpenhomeOrgWebProcessorConfig1.cpp $(proxyCppCore)CpAvOpenhomeOrgWebDACConfig1.cpp $(proxyCppCore)CpAvOpenhomeOrgWebClockConfig1.cpp $(proxyCppCore)CpAvOpenhomeOrgDACConfig1.cpp $(proxyCppCore)CpAvOpenhomeOrgCredentials1.cpp $(proxyCppCore)CpAvOpenhomeOrgServerConfig1.cpp $(proxyCppCore)CpAvOpenhomeOrgMessageCenter1.cpp $(proxyCppCore)CpAvOpenhomeOrgRenderingInfo1.cpp $(proxyCppCore)CpAvOpenhomeOrgGroupConfig1.cpp $(proxyCppCore)CpAvOpenhomeOrgRoon1.cpp $(proxyCppCore)CpAvOpenhomeOrgTidalConnect1.cpp $(proxyCppCore)CpAvOpenhomeOrgBluetooth1.cpp $(proxyCppCore)CpAvOpenhomeOrgAirplay1.cpp $(proxyCppCore)CpAvOpenhomeOrgMusicStation1.cpp $(proxyCppCore)CpAvOpenhomeOrgSpotify1.cpp $(proxyCppCore)CpAvOpenhomeOrgInternetRadio1.cpp $(proxyCppCore)CpAvOpenhomeOrgStreaming1.cpp $(proxyCppCore)CpAvOpenhomeOrgProduct1.cpp $(proxyCppCore)CpAvOpenhomeOrgRadio1.cpp $(proxyCppCore)CpAvOpenhomeOrgReceiver1.cpp $(proxyCppCore)CpAvOpenhomeOrgSender1.cpp $(proxyCppCore)CpAvOpenhomeOrgPlaylistManager1.cpp $(proxyCppCore)CpAvOpenhomeOrgMediaServer1.cpp $(proxyCppCore)CpAvOpenhomeOrgNetworkMonitor1.cpp $(proxyCppCore)CpOpenhomeOrgTestBasic1.cpp $(proxyCppCore)CpOpenhomeOrgTestLights1.cpp $(proxyCppCore)CpOpenhomeOrgSubscriptionLongPoll1.cpp $(proxyCppCore)CpTencentComQPlay1.cpp
...
$(proxyCppCore)CpAvOpenhomeOrgHardwareConfig1.cpp : $(tt) OpenHome/Net/T4/Templates/CpUpnpCppBufferSource.tt OpenHome/Net/T4/Templates/CpUpnpCppHeader.tt OpenHome/Net/Service/Upnp/OpenHome/HardwareConfig1.xml
	echo CpAvOpenhomeOrgHardwareConfig1.cpp
	$(ohNetGen) --language=cppcore --stack=cp "--xml=OpenHome/Net/Service/Upnp/OpenHome/HardwareConfig1.xml" --output=$(proxyCppCore) --domain=av.openhome.org --type=HardwareConfig --version=1
$(proxyCppCore)CpAvOpenhomeOrgTestResamplerConfig1.cpp : $(tt) OpenHome/Net/T4/Templates/CpUpnpCppBufferSource.tt OpenHome/Net/T4/Templates/CpUpnpCppHeader.tt OpenHome/Net/Service/Upnp/OpenHome/TestResamplerConfig1.xml
	echo CpAvOpenhomeOrgTestResamplerConfig1.cpp
	$(ohNetGen) --language=cppcore --stack=cp "--xml=OpenHome/Net/Service/Upnp/OpenHome/TestResamplerConfig1.xml" --output=$(proxyCppCore) --domain=av.openhome.org --type=TestResamplerConfig --version=1
$(proxyCppCore)CpAvOpenhomeOrgWebRendererConfig1.cpp : $(tt) OpenHome/Net/T4/Templates/CpUpnpCppBufferSource.tt OpenHome/Net/T4/Templates/CpUpnpCppHeader.tt OpenHome/Net/Service/Upnp/OpenHome/WebRendererConfig1.xml
	echo CpAvOpenhomeOrgWebRendererConfig1.cpp
	$(ohNetGen) --language=cppcore --stack=cp "--xml=OpenHome/Net/Service/Upnp/OpenHome/WebRendererConfig1.xml" --output=$(proxyCppCore) --domain=av.openhome.org --type=WebRendererConfig --version=1
$(proxyCppCore)CpAvOpenhomeOrgWebDeviceConfig1.cpp : $(tt) OpenHome/Net/T4/Templates/CpUpnpCppBufferSource.tt OpenHome/Net/T4/Templates/CpUpnpCppHeader.tt OpenHome/Net/Service/Upnp/OpenHome/WebDeviceConfig1.xml
	echo CpAvOpenhomeOrgWebDeviceConfig1.cpp
	$(ohNetGen) --language=cppcore --stack=cp "--xml=OpenHome/Net/Service/Upnp/OpenHome/WebDeviceConfig1.xml" --output=$(proxyCppCore) --domain=av.openhome.org --type=WebDeviceConfig --version=1
$(proxyCppCore)CpAvOpenhomeOrgWebProcessorConfig1.cpp : $(tt) OpenHome/Net/T4/Templates/CpUpnpCppBufferSource.tt OpenHome/Net/T4/Templates/CpUpnpCppHeader.tt OpenHome/Net/Service/Upnp/OpenHome/WebProcessorConfig1.xml
	echo CpAvOpenhomeOrgWebProcessorConfig1.cpp
	$(ohNetGen) --language=cppcore --stack=cp "--xml=OpenHome/Net/Service/Upnp/OpenHome/WebProcessorConfig1.xml" --output=$(proxyCppCore) --domain=av.openhome.org --type=WebProcessorConfig --version=1
$(proxyCppCore)CpAvOpenhomeOrgWebDACConfig1.cpp : $(tt) OpenHome/Net/T4/Templates/CpUpnpCppBufferSource.tt OpenHome/Net/T4/Templates/CpUpnpCppHeader.tt OpenHome/Net/Service/Upnp/OpenHome/WebDACConfig1.xml
	echo CpAvOpenhomeOrgWebDACConfig1.cpp
	$(ohNetGen) --language=cppcore --stack=cp "--xml=OpenHome/Net/Service/Upnp/OpenHome/WebDACConfig1.xml" --output=$(proxyCppCore) --domain=av.openhome.org --type=WebDACConfig --version=1
$(proxyCppCore)CpAvOpenhomeOrgWebClockConfig1.cpp : $(tt) OpenHome/Net/T4/Templates/CpUpnpCppBufferSource.tt OpenHome/Net/T4/Templates/CpUpnpCppHeader.tt OpenHome/Net/Service/Upnp/OpenHome/WebClockConfig1.xml
	echo CpAvOpenhomeOrgWebClockConfig1.cpp
	$(ohNetGen) --language=cppcore --stack=cp "--xml=OpenHome/Net/Service/Upnp/OpenHome/WebClockConfig1.xml" --output=$(proxyCppCore) --domain=av.openhome.org --type=WebClockConfig --version=1
$(proxyCppCore)CpAvOpenhomeOrgDACConfig1.cpp : $(tt) OpenHome/Net/T4/Templates/CpUpnpCppBufferSource.tt OpenHome/Net/T4/Templates/CpUpnpCppHeader.tt OpenHome/Net/Service/Upnp/OpenHome/DACConfig1.xml
	echo CpAvOpenhomeOrgDACConfig1.cpp
	$(ohNetGen) --language=cppcore --stack=cp "--xml=OpenHome/Net/Service/Upnp/OpenHome/DACConfig1.xml" --output=$(proxyCppCore) --domain=av.openhome.org --type=DACConfig --version=1
...
$(proxyCppCore)CpAvOpenhomeOrgServerConfig1.cpp : $(tt) OpenHome/Net/T4/Templates/CpUpnpCppBufferSource.tt OpenHome/Net/T4/Templates/CpUpnpCppHeader.tt OpenHome/Net/Service/Upnp/OpenHome/ServerConfig1.xml
	echo CpAvOpenhomeOrgServerConfig1.cpp
	$(ohNetGen) --language=cppcore --stack=cp "--xml=OpenHome/Net/Service/Upnp/OpenHome/ServerConfig1.xml" --output=$(proxyCppCore) --domain=av.openhome.org --type=ServerConfig --version=1
$(proxyCppCore)CpAvOpenhomeOrgMessageCenter1.cpp : $(tt) OpenHome/Net/T4/Templates/CpUpnpCppBufferSource.tt OpenHome/Net/T4/Templates/CpUpnpCppHeader.tt OpenHome/Net/Service/Upnp/OpenHome/MessageCenter1.xml
	echo CpAvOpenhomeOrgMessageCenter1.cpp
	$(ohNetGen) --language=cppcore --stack=cp "--xml=OpenHome/Net/Service/Upnp/OpenHome/MessageCenter1.xml" --output=$(proxyCppCore) --domain=av.openhome.org --type=MessageCenter --version=1
$(proxyCppCore)CpAvOpenhomeOrgRenderingInfo1.cpp : $(tt) OpenHome/Net/T4/Templates/CpUpnpCppBufferSource.tt OpenHome/Net/T4/Templates/CpUpnpCppHeader.tt OpenHome/Net/Service/Upnp/OpenHome/RenderingInfo1.xml
	echo CpAvOpenhomeOrgRenderingInfo1.cpp
	$(ohNetGen) --language=cppcore --stack=cp "--xml=OpenHome/Net/Service/Upnp/OpenHome/RenderingInfo1.xml" --output=$(proxyCppCore) --domain=av.openhome.org --type=RenderingInfo --version=1
$(proxyCppCore)CpAvOpenhomeOrgGroupConfig1.cpp : $(tt) OpenHome/Net/T4/Templates/CpUpnpCppBufferSource.tt OpenHome/Net/T4/Templates/CpUpnpCppHeader.tt OpenHome/Net/Service/Upnp/OpenHome/GroupConfig1.xml
	echo CpAvOpenhomeOrgGroupConfig1.cpp
	$(ohNetGen) --language=cppcore --stack=cp "--xml=OpenHome/Net/Service/Upnp/OpenHome/GroupConfig1.xml" --output=$(proxyCppCore) --domain=av.openhome.org --type=GroupConfig --version=1
$(proxyCppCore)CpAvOpenhomeOrgRoon1.cpp : $(tt) OpenHome/Net/T4/Templates/CpUpnpCppBufferSource.tt OpenHome/Net/T4/Templates/CpUpnpCppHeader.tt OpenHome/Net/Service/Upnp/OpenHome/Roon1.xml
	echo CpAvOpenhomeOrgRoon1.cpp
	$(ohNetGen) --language=cppcore --stack=cp "--xml=OpenHome/Net/Service/Upnp/OpenHome/Roon1.xml" --output=$(proxyCppCore) --domain=av.openhome.org --type=Roon --version=1
$(proxyCppCore)CpAvOpenhomeOrgTidalConnect1.cpp : $(tt) OpenHome/Net/T4/Templates/CpUpnpCppBufferSource.tt OpenHome/Net/T4/Templates/CpUpnpCppHeader.tt OpenHome/Net/Service/Upnp/OpenHome/TidalConnect1.xml
	echo CpAvOpenhomeOrgTidalConnect1.cpp
	$(ohNetGen) --language=cppcore --stack=cp "--xml=OpenHome/Net/Service/Upnp/OpenHome/TidalConnect1.xml" --output=$(proxyCppCore) --domain=av.openhome.org --type=TidalConnect --version=1
$(proxyCppCore)CpAvOpenhomeOrgBluetooth1.cpp : $(tt) OpenHome/Net/T4/Templates/CpUpnpCppBufferSource.tt OpenHome/Net/T4/Templates/CpUpnpCppHeader.tt OpenHome/Net/Service/Upnp/OpenHome/Bluetooth1.xml
	echo CpAvOpenhomeOrgBluetooth1.cpp
	$(ohNetGen) --language=cppcore --stack=cp "--xml=OpenHome/Net/Service/Upnp/OpenHome/Bluetooth1.xml" --output=$(proxyCppCore) --domain=av.openhome.org --type=Bluetooth --version=1
$(proxyCppCore)CpAvOpenhomeOrgAirplay1.cpp : $(tt) OpenHome/Net/T4/Templates/CpUpnpCppBufferSource.tt OpenHome/Net/T4/Templates/CpUpnpCppHeader.tt OpenHome/Net/Service/Upnp/OpenHome/Airplay1.xml
	echo CpAvOpenhomeOrgAirplay1.cpp
	$(ohNetGen) --language=cppcore --stack=cp "--xml=OpenHome/Net/Service/Upnp/OpenHome/Airplay1.xml" --output=$(proxyCppCore) --domain=av.openhome.org --type=Airplay --version=1
$(proxyCppCore)CpAvOpenhomeOrgMusicStation1.cpp : $(tt) OpenHome/Net/T4/Templates/CpUpnpCppBufferSource.tt OpenHome/Net/T4/Templates/CpUpnpCppHeader.tt OpenHome/Net/Service/Upnp/OpenHome/MusicStation1.xml
	echo CpAvOpenhomeOrgMusicStation1.cpp
	$(ohNetGen) --language=cppcore --stack=cp "--xml=OpenHome/Net/Service/Upnp/OpenHome/MusicStation1.xml" --output=$(proxyCppCore) --domain=av.openhome.org --type=MusicStation --version=1
$(proxyCppCore)CpAvOpenhomeOrgSpotify1.cpp : $(tt) OpenHome/Net/T4/Templates/CpUpnpCppBufferSource.tt OpenHome/Net/T4/Templates/CpUpnpCppHeader.tt OpenHome/Net/Service/Upnp/OpenHome/Spotify1.xml
	echo CpAvOpenhomeOrgSpotify1.cpp
	$(ohNetGen) --language=cppcore --stack=cp "--xml=OpenHome/Net/Service/Upnp/OpenHome/Spotify1.xml" --output=$(proxyCppCore) --domain=av.openhome.org --type=Spotify --version=1
$(proxyCppCore)CpAvOpenhomeOrgInternetRadio1.cpp : $(tt) OpenHome/Net/T4/Templates/CpUpnpCppBufferSource.tt OpenHome/Net/T4/Templates/CpUpnpCppHeader.tt OpenHome/Net/Service/Upnp/OpenHome/InternetRadio1.xml
	echo CpAvOpenhomeOrgInternetRadio1.cpp
	$(ohNetGen) --language=cppcore --stack=cp "--xml=OpenHome/Net/Service/Upnp/OpenHome/InternetRadio1.xml" --output=$(proxyCppCore) --domain=av.openhome.org --type=InternetRadio --version=1
$(proxyCppCore)CpAvOpenhomeOrgStreaming1.cpp : $(tt) OpenHome/Net/T4/Templates/CpUpnpCppBufferSource.tt OpenHome/Net/T4/Templates/CpUpnpCppHeader.tt OpenHome/Net/Service/Upnp/OpenHome/Streaming1.xml
	echo CpAvOpenhomeOrgStreaming1.cpp
	$(ohNetGen) --language=cppcore --stack=cp "--xml=OpenHome/Net/Service/Upnp/OpenHome/Streaming1.xml" --output=$(proxyCppCore) --domain=av.openhome.org --type=Streaming --version=1
...
$(proxyCppCore)CpTencentComQPlay1.cpp : $(tt) OpenHome/Net/T4/Templates/CpUpnpCppBufferSource.tt OpenHome/Net/T4/Templates/CpUpnpCppHeader.tt OpenHome/Net/Service/Upnp/Upnp/MediaServer_3/QPlay1.xml
	echo CpTencentComQPlay1.cpp
	$(ohNetGen) --language=cppcore --stack=cp "--xml=OpenHome/Net/Service/Upnp/Upnp/MediaServer_3/QPlay1.xml" --output=$(proxyCppCore) --domain=tencent.com --type=QPlay --version=1

CpCppStd:   $(proxyCppStd)CpUpnpOrgAVTransport1Std.cpp $(proxyCppStd)CpUpnpOrgAVTransport2Std.cpp $(proxyCppStd)CpUpnpOrgConnectionManager1Std.cpp $(proxyCppStd)CpUpnpOrgConnectionManager2Std.cpp $(proxyCppStd)CpUpnpOrgContentDirectory1Std.cpp $(proxyCppStd)CpUpnpOrgContentDirectory2Std.cpp $(proxyCppStd)CpUpnpOrgContentDirectory3Std.cpp $(proxyCppStd)CpUpnpOrgRenderingControl1Std.cpp $(proxyCppStd)CpUpnpOrgRenderingControl2Std.cpp $(proxyCppStd)CpUpnpOrgScheduledRecording1Std.cpp $(proxyCppStd)CpUpnpOrgScheduledRecording2Std.cpp $(proxyCppStd)CpUpnpOrgSwitchPower1Std.cpp $(proxyCppStd)CpUpnpOrgDimming1Std.cpp $(proxyCppStd)CpAvOpenhomeOrgInfo1Std.cpp $(proxyCppStd)CpAvOpenhomeOrgTime1Std.cpp $(proxyCppStd)CpAvOpenhomeOrgPlaylist1Std.cpp $(proxyCppStd)CpAvOpenhomeOrgVolume1Std.cpp $(proxyCppStd)CpAvOpenhomeOrgHardwareConfig1Std.cpp $(proxyCppStd)CpAvOpenhomeOrgTestResamplerConfig1Std.cpp $(proxyCppStd)CpAvOpenhomeOrgWebRendererConfig1Std.cpp $(proxyCppStd)CpAvOpenhomeOrgWebDeviceConfig1Std.cpp $(proxyCppStd)CpAvOpenhomeOrgWebProcessorConfig1Std.cpp $(proxyCppStd)CpAvOpenhomeOrgWebDACConfig1Std.cpp $(proxyCppStd)CpAvOpenhomeOrgWebClockConfig1Std.cpp $(proxyCppStd)CpAvOpenhomeOrgDACConfig1Std.cpp $(proxyCppStd)CpAvOpenhomeOrgCredentials1Std.cpp $(proxyCppStd)CpAvOpenhomeOrgServerConfig1Std.cpp $(proxyCppStd)CpAvOpenhomeOrgMessageCenter1Std.cpp $(proxyCppStd)CpAvOpenhomeOrgRenderingInfo1Std.cpp $(proxyCppStd)CpAvOpenhomeOrgGroupConfig1Std.cpp $(proxyCppStd)CpAvOpenhomeOrgRoon1Std.cpp $(proxyCppStd)CpAvOpenhomeOrgTidalConnect1Std.cpp $(proxyCppStd)CpAvOpenhomeOrgBluetooth1Std.cpp $(proxyCppStd)CpAvOpenhomeOrgAirplay1Std.cpp $(proxyCppStd)CpAvOpenhomeOrgMusicStation1Std.cpp $(proxyCppStd)CpAvOpenhomeOrgSpotify1Std.cpp $(proxyCppStd)CpAvOpenhomeOrgInternetRadio1Std.cpp $(proxyCppStd)CpAvOpenhomeOrgStreaming1Std.cpp $(proxyCppStd)CpAvOpenhomeOrgProduct1Std.cpp $(proxyCppStd)CpAvOpenhomeOrgRadio1Std.cpp $(proxyCppStd)CpAvOpenhomeOrgReceiver1Std.cpp $(proxyCppStd)CpAvOpenhomeOrgSender1Std.cpp $(proxyCppStd)CpAvOpenhomeOrgPlaylistManager1Std.cpp $(proxyCppStd)CpAvOpenhomeOrgMediaServer1Std.cpp $(proxyCppStd)CpAvOpenhomeOrgNetworkMonitor1Std.cpp $(proxyCppStd)CpOpenhomeOrgTestBasic1Std.cpp $(proxyCppStd)CpOpenhomeOrgTestLights1Std.cpp $(proxyCppStd)CpOpenhomeOrgSubscriptionLongPoll1Std.cpp $(proxyCppStd)CpTencentComQPlay1Std.cpp
...
$(proxyCppStd)CpAvOpenhomeOrgHardwareConfig1Std.cpp : $(tt) OpenHome/Net/T4/Templates/CpUpnpCppStringSource.tt OpenHome/Net/T4/Templates/CpUpnpCppHeader.tt OpenHome/Net/Service/Upnp/OpenHome/HardwareConfig1.xml
	echo CpAvOpenhomeOrgHardwareConfig1Std.cpp
	$(ohNetGen) --language=cpp --stack=cp "--xml=OpenHome/Net/Service/Upnp/OpenHome/HardwareConfig1.xml" --output=$(proxyCppStd) --domain=av.openhome.org --type=HardwareConfig --version=1
$(proxyCppStd)CpAvOpenhomeOrgTestResamplerConfig1Std.cpp : $(tt) OpenHome/Net/T4/Templates/CpUpnpCppStringSource.tt OpenHome/Net/T4/Templates/CpUpnpCppHeader.tt OpenHome/Net/Service/Upnp/OpenHome/TestResamplerConfig1.xml
	echo CpAvOpenhomeOrgTestResamplerConfig1Std.cpp
	$(ohNetGen) --language=cpp --stack=cp "--xml=OpenHome/Net/Service/Upnp/OpenHome/TestResamplerConfig1.xml" --output=$(proxyCppStd) --domain=av.openhome.org --type=TestResamplerConfig --version=1
$(proxyCppStd)CpAvOpenhomeOrgWebRendererConfig1Std.cpp : $(tt) OpenHome/Net/T4/Templates/CpUpnpCppStringSource.tt OpenHome/Net/T4/Templates/CpUpnpCppHeader.tt OpenHome/Net/Service/Upnp/OpenHome/WebRendererConfig1.xml
	echo CpAvOpenhomeOrgWebRendererConfig1Std.cpp
	$(ohNetGen) --language=cpp --stack=cp "--xml=OpenHome/Net/Service/Upnp/OpenHome/WebRendererConfig1.xml" --output=$(proxyCppStd) --domain=av.openhome.org --type=WebRendererConfig --version=1
$(proxyCppStd)CpAvOpenhomeOrgWebDeviceConfig1Std.cpp : $(tt) OpenHome/Net/T4/Templates/CpUpnpCppStringSource.tt OpenHome/Net/T4/Templates/CpUpnpCppHeader.tt OpenHome/Net/Service/Upnp/OpenHome/WebDeviceConfig1.xml
	echo CpAvOpenhomeOrgWebDeviceConfig1Std.cpp
	$(ohNetGen) --language=cpp --stack=cp "--xml=OpenHome/Net/Service/Upnp/OpenHome/WebDeviceConfig1.xml" --output=$(proxyCppStd) --domain=av.openhome.org --type=WebDeviceConfig --version=1
$(proxyCppStd)CpAvOpenhomeOrgWebProcessorConfig1Std.cpp : $(tt) OpenHome/Net/T4/Templates/CpUpnpCppStringSource.tt OpenHome/Net/T4/Templates/CpUpnpCppHeader.tt OpenHome/Net/Service/Upnp/OpenHome/WebProcessorConfig1.xml
	echo CpAvOpenhomeOrgWebProcessorConfig1Std.cpp
	$(ohNetGen) --language=cpp --stack=cp "--xml=OpenHome/Net/Service/Upnp/OpenHome/WebProcessorConfig1.xml" --output=$(proxyCppStd) --domain=av.openhome.org --type=WebProcessorConfig --version=1
$(proxyCppStd)CpAvOpenhomeOrgWebDACConfig1Std.cpp : $(tt) OpenHome/Net/T4/Templates/CpUpnpCppStringSource.tt OpenHome/Net/T4/Templates/CpUpnpCppHeader.tt OpenHome/Net/Service/Upnp/OpenHome/WebDACConfig1.xml
	echo CpAvOpenhomeOrgWebDACConfig1Std.cpp
	$(ohNetGen) --language=cpp --stack=cp "--xml=OpenHome/Net/Service/Upnp/OpenHome/WebDACConfig1.xml" --output=$(proxyCppStd) --domain=av.openhome.org --type=WebDACConfig --version=1
$(proxyCppStd)CpAvOpenhomeOrgWebClockConfig1Std.cpp : $(tt) OpenHome/Net/T4/Templates/CpUpnpCppStringSource.tt OpenHome/Net/T4/Templates/CpUpnpCppHeader.tt OpenHome/Net/Service/Upnp/OpenHome/WebClockConfig1.xml
	echo CpAvOpenhomeOrgWebClockConfig1Std.cpp
	$(ohNetGen) --language=cpp --stack=cp "--xml=OpenHome/Net/Service/Upnp/OpenHome/WebClockConfig1.xml" --output=$(proxyCppStd) --domain=av.openhome.org --type=WebClockConfig --version=1
$(proxyCppStd)CpAvOpenhomeOrgDACConfig1Std.cpp : $(tt) OpenHome/Net/T4/Templates/CpUpnpCppStringSource.tt OpenHome/Net/T4/Templates/CpUpnpCppHeader.tt OpenHome/Net/Service/Upnp/OpenHome/DACConfig1.xml
	echo CpAvOpenhomeOrgDACConfig1Std.cpp
	$(ohNetGen) --language=cpp --stack=cp "--xml=OpenHome/Net/Service/Upnp/OpenHome/DACConfig1.xml" --output=$(proxyCppStd) --domain=av.openhome.org --type=DACConfig --version=1
...
$(proxyCppStd)CpAvOpenhomeOrgServerConfig1Std.cpp : $(tt) OpenHome/Net/T4/Templates/CpUpnpCppStringSource.tt OpenHome/Net/T4/Templates/CpUpnpCppHeader.tt OpenHome/Net/Service/Upnp/OpenHome/ServerConfig1.xml
	echo CpAvOpenhomeOrgServerConfig1Std.cpp
	$(ohNetGen) --language=cpp --stack=cp "--xml=OpenHome/Net/Service/Upnp/OpenHome/ServerConfig1.xml" --output=$(proxyCppStd) --domain=av.openhome.org --type=ServerConfig --version=1
$(proxyCppStd)CpAvOpenhomeOrgMessageCenter1Std.cpp : $(tt) OpenHome/Net/T4/Templates/CpUpnpCppStringSource.tt OpenHome/Net/T4/Templates/CpUpnpCppHeader.tt OpenHome/Net/Service/Upnp/OpenHome/MessageCenter1.xml
	echo CpAvOpenhomeOrgMessageCenter1Std.cpp
	$(ohNetGen) --language=cpp --stack=cp "--xml=OpenHome/Net/Service/Upnp/OpenHome/MessageCenter1.xml" --output=$(proxyCppStd) --domain=av.openhome.org --type=MessageCenter --version=1
$(proxyCppStd)CpAvOpenhomeOrgRenderingInfo1Std.cpp : $(tt) OpenHome/Net/T4/Templates/CpUpnpCppStringSource.tt OpenHome/Net/T4/Templates/CpUpnpCppHeader.tt OpenHome/Net/Service/Upnp/OpenHome/RenderingInfo1.xml
	echo CpAvOpenhomeOrgRenderingInfo1Std.cpp
	$(ohNetGen) --language=cpp --stack=cp "--xml=OpenHome/Net/Service/Upnp/OpenHome/RenderingInfo1.xml" --output=$(proxyCppStd) --domain=av.openhome.org --type=RenderingInfo --version=1
$(proxyCppStd)CpAvOpenhomeOrgGroupConfig1Std.cpp : $(tt) OpenHome/Net/T4/Templates/CpUpnpCppStringSource.tt OpenHome/Net/T4/Templates/CpUpnpCppHeader.tt OpenHome/Net/Service/Upnp/OpenHome/GroupConfig1.xml
	echo CpAvOpenhomeOrgGroupConfig1Std.cpp
	$(ohNetGen) --language=cpp --stack=cp "--xml=OpenHome/Net/Service/Upnp/OpenHome/GroupConfig1.xml" --output=$(proxyCppStd) --domain=av.openhome.org --type=GroupConfig --version=1
$(proxyCppStd)CpAvOpenhomeOrgRoon1Std.cpp : $(tt) OpenHome/Net/T4/Templates/CpUpnpCppStringSource.tt OpenHome/Net/T4/Templates/CpUpnpCppHeader.tt OpenHome/Net/Service/Upnp/OpenHome/Roon1.xml
	echo CpAvOpenhomeOrgRoon1Std.cpp
	$(ohNetGen) --language=cpp --stack=cp "--xml=OpenHome/Net/Service/Upnp/OpenHome/Roon1.xml" --output=$(proxyCppStd) --domain=av.openhome.org --type=Roon --version=1
$(proxyCppStd)CpAvOpenhomeOrgTidalConnect1Std.cpp : $(tt) OpenHome/Net/T4/Templates/CpUpnpCppStringSource.tt OpenHome/Net/T4/Templates/CpUpnpCppHeader.tt OpenHome/Net/Service/Upnp/OpenHome/TidalConnect1.xml
	echo CpAvOpenhomeOrgTidalConnect1Std.cpp
	$(ohNetGen) --language=cpp --stack=cp "--xml=OpenHome/Net/Service/Upnp/OpenHome/TidalConnect1.xml" --output=$(proxyCppStd) --domain=av.openhome.org --type=TidalConnect --version=1
$(proxyCppStd)CpAvOpenhomeOrgBluetooth1Std.cpp : $(tt) OpenHome/Net/T4/Templates/CpUpnpCppStringSource.tt OpenHome/Net/T4/Templates/CpUpnpCppHeader.tt OpenHome/Net/Service/Upnp/OpenHome/Bluetooth1.xml
	echo CpAvOpenhomeOrgBluetooth1Std.cpp
	$(ohNetGen) --language=cpp --stack=cp "--xml=OpenHome/Net/Service/Upnp/OpenHome/Bluetooth1.xml" --output=$(proxyCppStd) --domain=av.openhome.org --type=Bluetooth --version=1
$(proxyCppStd)CpAvOpenhomeOrgAirplay1Std.cpp : $(tt) OpenHome/Net/T4/Templates/CpUpnpCppStringSource.tt OpenHome/Net/T4/Templates/CpUpnpCppHeader.tt OpenHome/Net/Service/Upnp/OpenHome/Airplay1.xml
	echo CpAvOpenhomeOrgAirplay1Std.cpp
	$(ohNetGen) --language=cpp --stack=cp "--xml=OpenHome/Net/Service/Upnp/OpenHome/Airplay1.xml" --output=$(proxyCppStd) --domain=av.openhome.org --type=Airplay --version=1
$(proxyCppStd)CpAvOpenhomeOrgMusicStation1Std.cpp : $(tt) OpenHome/Net/T4/Templates/CpUpnpCppStringSource.tt OpenHome/Net/T4/Templates/CpUpnpCppHeader.tt OpenHome/Net/Service/Upnp/OpenHome/MusicStation1.xml
	echo CpAvOpenhomeOrgMusicStation1Std.cpp
	$(ohNetGen) --language=cpp --stack=cp "--xml=OpenHome/Net/Service/Upnp/OpenHome/MusicStation1.xml" --output=$(proxyCppStd) --domain=av.openhome.org --type=MusicStation --version=1
$(proxyCppStd)CpAvOpenhomeOrgSpotify1Std.cpp : $(tt) OpenHome/Net/T4/Templates/CpUpnpCppStringSource.tt OpenHome/Net/T4/Templates/CpUpnpCppHeader.tt OpenHome/Net/Service/Upnp/OpenHome/Spotify1.xml
	echo CpAvOpenhomeOrgSpotify1Std.cpp
	$(ohNetGen) --language=cpp --stack=cp "--xml=OpenHome/Net/Service/Upnp/OpenHome/Spotify1.xml" --output=$(proxyCppStd) --domain=av.openhome.org --type=Spotify --version=1
$(proxyCppStd)CpAvOpenhomeOrgInternetRadio1Std.cpp : $(tt) OpenHome/Net/T4/Templates/CpUpnpCppStringSource.tt OpenHome/Net/T4/Templates/CpUpnpCppHeader.tt OpenHome/Net/Service/Upnp/OpenHome/InternetRadio1.xml
	echo CpAvOpenhomeOrgInternetRadio1Std.cpp
	$(ohNetGen) --language=cpp --stack=cp "--xml=OpenHome/Net/Service/Upnp/OpenHome/InternetRadio1.xml" --output=$(proxyCppStd) --domain=av.openhome.org --type=InternetRadio --version=1
$(proxyCppStd)CpAvOpenhomeOrgStreaming1Std.cpp : $(tt) OpenHome/Net/T4/Templates/CpUpnpCppStringSource.tt OpenHome/Net/T4/Templates/CpUpnpCppHeader.tt OpenHome/Net/Service/Upnp/OpenHome/Streaming1.xml
	echo CpAvOpenhomeOrgStreaming1Std.cpp
	$(ohNetGen) --language=cpp --stack=cp "--xml=OpenHome/Net/Service/Upnp/OpenHome/Streaming1.xml" --output=$(proxyCppStd) --domain=av.openhome.org --type=Streaming --version=1
...
$(proxyCppStd)CpTencentComQPlay1Std.cpp : $(tt) OpenHome/Net/T4/Templates/CpUpnpCppStringSource.tt OpenHome/Net/T4/Templates/CpUpnpCppHeader.tt OpenHome/Net/Service/Upnp/Upnp/MediaServer_3/QPlay1.xml
	echo CpTencentComQPlay1Std.cpp
	$(ohNetGen) --language=cpp --stack=cp "--xml=OpenHome/Net/Service/Upnp/Upnp/MediaServer_3/QPlay1.xml" --output=$(proxyCppStd) --domain=tencent.com --type=QPlay --version=1

CpC:   $(proxyC)CpUpnpOrgAVTransport1C.cpp $(proxyC)CpUpnpOrgAVTransport2C.cpp $(proxyC)CpUpnpOrgConnectionManager1C.cpp $(proxyC)CpUpnpOrgConnectionManager2C.cpp $(proxyC)CpUpnpOrgContentDirectory1C.cpp $(proxyC)CpUpnpOrgContentDirectory2C.cpp $(proxyC)CpUpnpOrgContentDirectory3C.cpp $(proxyC)CpUpnpOrgRenderingControl1C.cpp $(proxyC)CpUpnpOrgRenderingControl2C.cpp $(proxyC)CpUpnpOrgScheduledRecording1C.cpp $(proxyC)CpUpnpOrgScheduledRecording2C.cpp $(proxyC)CpUpnpOrgSwitchPower1C.cpp $(proxyC)CpUpnpOrgDimming1C.cpp $(proxyC)CpAvOpenhomeOrgInfo1C.cpp $(proxyC)CpAvOpenhomeOrgTime1C.cpp $(proxyC)CpAvOpenhomeOrgPlaylist1C.cpp $(proxyC)CpAvOpenhomeOrgVolume1C.cpp $(proxyC)CpAvOpenhomeOrgHardwareConfig1C.cpp $(proxyC)CpAvOpenhomeOrgTestResamplerConfig1C.cpp $(proxyC)CpAvOpenhomeOrgWebRendererConfig1C.cpp $(proxyC)CpAvOpenhomeOrgWebDeviceConfig1C.cpp $(proxyC)CpAvOpenhomeOrgWebProcessorConfig1C.cpp $(proxyC)CpAvOpenhomeOrgWebDACConfig1C.cpp $(proxyC)CpAvOpenhomeOrgWebClockConfig1C.cpp $(proxyC)CpAvOpenhomeOrgDACConfig1C.cpp $(proxyC)CpAvOpenhomeOrgCredentials1C.cpp $(proxyC)CpAvOpenhomeOrgServerConfig1C.cpp $(proxyC)CpAvOpenhomeOrgMessageCenter1C.cpp $(proxyC)CpAvOpenhomeOrgRenderingInfo1C.cpp $(proxyC)CpAvOpenhomeOrgGroupConfig1C.cpp $(proxyC)CpAvOpenhomeOrgRoon1C.cpp $(proxyC)CpAvOpenhomeOrgTidalConnect1C.cpp $(proxyC)CpAvOpenhomeOrgBluetooth1C.cpp $(proxyC)CpAvOpenhomeOrgAirplay1C.cpp $(proxyC)CpAvOpenhomeOrgMusicStation1C.cpp $(proxyC)CpAvOpenhomeOrgSpotify1C.cpp $(proxyC)CpAvOpenhomeOrgInternetRadio1C.cpp $(proxyC)CpAvOpenhomeOrgStreaming1C.cpp $(proxyC)CpAvOpenhomeOrgProduct1C.cpp $(proxyC)CpAvOpenhomeOrgRadio1C.cpp $(proxyC)CpAvOpenhomeOrgReceiver1C.cpp $(proxyC)CpAvOpenhomeOrgSender1C.cpp $(proxyC)CpAvOpenhomeOrgPlaylistManager1C.cpp $(proxyC)CpAvOpenhomeOrgMediaServer1C.cpp $(proxyC)CpAvOpenhomeOrgNetworkMonitor1C.cpp $(proxyC)CpOpenhomeOrgTestBasic1C.cpp $(proxyC)CpOpenhomeOrgTestLights1C.cpp $(proxyC)CpOpenhomeOrgSubscriptionLongPoll1C.cpp $(proxyC)CpTencentComQPlay1C.cpp
...
$(proxyC)CpAvOpenhomeOrgHardwareConfig1C.cpp : $(tt) OpenHome/Net/T4/Templates/CpUpnpCSource.tt OpenHome/Net/T4/Templates/CpUpnpCHeader.tt OpenHome/Net/Service/Upnp/OpenHome/HardwareConfig1.xml
	echo CpAvOpenhomeOrgHardwareConfig1C.cpp
	$(ohNetGen) --language=c --stack=cp "--xml=OpenHome/Net/Service/Upnp/OpenHome/HardwareConfig1.xml" --output=$(proxyC) --domain=av.openhome.org --type=HardwareConfig --version=1
$(proxyC)CpAvOpenhomeOrgTestResamplerConfig1C.cpp : $(tt) OpenHome/Net/T4/Templates/CpUpnpCSource.tt OpenHome/Net/T4/Templates/CpUpnpCHeader.tt OpenHome/Net/Service/Upnp/OpenHome/TestResamplerConfig1.xml
	echo CpAvOpenhomeOrgTestResamplerConfig1C.cpp
	$(ohNetGen) --language=c --stack=cp "--xml=OpenHome/Net/Service/Upnp/OpenHome/TestResamplerConfig1.xml" --output=$(proxyC) --domain=av.openhome.org --type=TestResamplerConfig --version=1
$(proxyC)CpAvOpenhomeOrgWebRendererConfig1C.cpp : $(tt) OpenHome/Net/T4/Templates/CpUpnpCSource.tt OpenHome/Net/T4/Templates/CpUpnpCHeader.tt OpenHome/Net/Service/Upnp/OpenHome/WebRendererConfig1.xml
	echo CpAvOpenhomeOrgWebRendererConfig1C.cpp
	$(ohNetGen) --language=c --stack=cp "--xml=OpenHome/Net/Service/Upnp/OpenHome/WebRendererConfig1.xml" --output=$(proxyC) --domain=av.openhome.org --type=WebRendererConfig --version=1
$(proxyC)CpAvOpenhomeOrgWebDeviceConfig1C.cpp : $(tt) OpenHome/Net/T4/Templates/CpUpnpCSource.tt OpenHome/Net/T4/Templates/CpUpnpCHeader.tt OpenHome/Net/Service/Upnp/OpenHome/WebDeviceConfig1.xml
	echo CpAvOpenhomeOrgWebDeviceConfig1C.cpp
	$(ohNetGen) --language=c --stack=cp "--xml=OpenHome/Net/Service/Upnp/OpenHome/WebDeviceConfig1.xml" --output=$(proxyC) --domain=av.openhome.org --type=WebDeviceConfig --version=1
$(proxyC)CpAvOpenhomeOrgWebProcessorConfig1C.cpp : $(tt) OpenHome/Net/T4/Templates/CpUpnpCSource.tt OpenHome/Net/T4/Templates/CpUpnpCHeader.tt OpenHome/Net/Service/Upnp/OpenHome/WebProcessorConfig1.xml
	echo CpAvOpenhomeOrgWebProcessorConfig1C.cpp
	$(ohNetGen) --language=c --stack=cp "--xml=OpenHome/Net/Service/Upnp/OpenHome/WebProcessorConfig1.xml" --output=$(proxyC) --domain=av.openhome.org --type=WebProcessorConfig --version=1
$(proxyC)CpAvOpenhomeOrgWebDACConfig1C.cpp : $(tt) OpenHome/Net/T4/Templates/CpUpnpCSource.tt OpenHome/Net/T4/Templates/CpUpnpCHeader.tt OpenHome/Net/Service/Upnp/OpenHome/WebDACConfig1.xml
	echo CpAvOpenhomeOrgWebDACConfig1C.cpp
	$(ohNetGen) --language=c --stack=cp "--xml=OpenHome/Net/Service/Upnp/OpenHome/WebDACConfig1.xml" --output=$(proxyC) --domain=av.openhome.org --type=WebDACConfig --version=1
$(proxyC)CpAvOpenhomeOrgWebClockConfig1C.cpp : $(tt) OpenHome/Net/T4/Templates/CpUpnpCSource.tt OpenHome/Net/T4/Templates/CpUpnpCHeader.tt OpenHome/Net/Service/Upnp/OpenHome/WebClockConfig1.xml
	echo CpAvOpenhomeOrgWebClockConfig1C.cpp
	$(ohNetGen) --language=c --stack=cp "--xml=OpenHome/Net/Service/Upnp/OpenHome/WebClockConfig1.xml" --output=$(proxyC) --domain=av.openhome.org --type=WebClockConfig --version=1
$(proxyC)CpAvOpenhomeOrgDACConfig1C.cpp : $(tt) OpenHome/Net/T4/Templates/CpUpnpCSource.tt OpenHome/Net/T4/Templates/CpUpnpCHeader.tt OpenHome/Net/Service/Upnp/OpenHome/DACConfig1.xml
	echo CpAvOpenhomeOrgDACConfig1C.cpp
	$(ohNetGen) --language=c --stack=cp "--xml=OpenHome/Net/Service/Upnp/OpenHome/DACConfig1.xml" --output=$(proxyC) --domain=av.openhome.org --type=DACConfig --version=1
...
$(proxyC)CpAvOpenhomeOrgServerConfig1C.cpp : $(tt) OpenHome/Net/T4/Templates/CpUpnpCSource.tt OpenHome/Net/T4/Templates/CpUpnpCHeader.tt OpenHome/Net/Service/Upnp/OpenHome/ServerConfig1.xml
	echo CpAvOpenhomeOrgServerConfig1C.cpp
	$(ohNetGen) --language=c --stack=cp "--xml=OpenHome/Net/Service/Upnp/OpenHome/ServerConfig1.xml" --output=$(proxyC) --domain=av.openhome.org --type=ServerConfig --version=1
$(proxyC)CpAvOpenhomeOrgMessageCenter1C.cpp : $(tt) OpenHome/Net/T4/Templates/CpUpnpCSource.tt OpenHome/Net/T4/Templates/CpUpnpCHeader.tt OpenHome/Net/Service/Upnp/OpenHome/MessageCenter1.xml
	echo CpAvOpenhomeOrgMessageCenter1C.cpp
	$(ohNetGen) --language=c --stack=cp "--xml=OpenHome/Net/Service/Upnp/OpenHome/MessageCenter1.xml" --output=$(proxyC) --domain=av.openhome.org --type=MessageCenter --version=1
$(proxyC)CpAvOpenhomeOrgRenderingInfo1C.cpp : $(tt) OpenHome/Net/T4/Templates/CpUpnpCSource.tt OpenHome/Net/T4/Templates/CpUpnpCHeader.tt OpenHome/Net/Service/Upnp/OpenHome/RenderingInfo1.xml
	echo CpAvOpenhomeOrgRenderingInfo1C.cpp
	$(ohNetGen) --language=c --stack=cp "--xml=OpenHome/Net/Service/Upnp/OpenHome/RenderingInfo1.xml" --output=$(proxyC) --domain=av.openhome.org --type=RenderingInfo --version=1
$(proxyC)CpAvOpenhomeOrgGroupConfig1C.cpp : $(tt) OpenHome/Net/T4/Templates/CpUpnpCSource.tt OpenHome/Net/T4/Templates/CpUpnpCHeader.tt OpenHome/Net/Service/Upnp/OpenHome/GroupConfig1.xml
	echo CpAvOpenhomeOrgGroupConfig1C.cpp
	$(ohNetGen) --language=c --stack=cp "--xml=OpenHome/Net/Service/Upnp/OpenHome/GroupConfig1.xml" --output=$(proxyC) --domain=av.openhome.org --type=GroupConfig --version=1
$(proxyC)CpAvOpenhomeOrgRoon1C.cpp : $(tt) OpenHome/Net/T4/Templates/CpUpnpCSource.tt OpenHome/Net/T4/Templates/CpUpnpCHeader.tt OpenHome/Net/Service/Upnp/OpenHome/Roon1.xml
	echo CpAvOpenhomeOrgRoon1C.cpp
	$(ohNetGen) --language=c --stack=cp "--xml=OpenHome/Net/Service/Upnp/OpenHome/Roon1.xml" --output=$(proxyC) --domain=av.openhome.org --type=Roon --version=1
$(proxyC)CpAvOpenhomeOrgTidalConnect1C.cpp : $(tt) OpenHome/Net/T4/Templates/CpUpnpCSource.tt OpenHome/Net/T4/Templates/CpUpnpCHeader.tt OpenHome/Net/Service/Upnp/OpenHome/TidalConnect1.xml
	echo CpAvOpenhomeOrgTidalConnect1C.cpp
	$(ohNetGen) --language=c --stack=cp "--xml=OpenHome/Net/Service/Upnp/OpenHome/TidalConnect1.xml" --output=$(proxyC) --domain=av.openhome.org --type=TidalConnect --version=1
$(proxyC)CpAvOpenhomeOrgBluetooth1C.cpp : $(tt) OpenHome/Net/T4/Templates/CpUpnpCSource.tt OpenHome/Net/T4/Templates/CpUpnpCHeader.tt OpenHome/Net/Service/Upnp/OpenHome/Bluetooth1.xml
	echo CpAvOpenhomeOrgBluetooth1C.cpp
	$(ohNetGen) --language=c --stack=cp "--xml=OpenHome/Net/Service/Upnp/OpenHome/Bluetooth1.xml" --output=$(proxyC) --domain=av.openhome.org --type=Bluetooth --version=1
$(proxyC)CpAvOpenhomeOrgAirplay1C.cpp : $(tt) OpenHome/Net/T4/Templates/CpUpnpCSource.tt OpenHome/Net/T4/Templates/CpUpnpCHeader.tt OpenHome/Net/Service/Upnp/OpenHome/Airplay1.xml
	echo CpAvOpenhomeOrgAirplay1C.cpp
	$(ohNetGen) --language=c --stack=cp "--xml=OpenHome/Net/Service/Upnp/OpenHome/Airplay1.xml" --output=$(proxyC) --domain=av.openhome.org --type=Airplay --version=1
$(proxyC)CpAvOpenhomeOrgMusicStation1C.cpp : $(tt) OpenHome/Net/T4/Templates/CpUpnpCSource.tt OpenHome/Net/T4/Templates/CpUpnpCHeader.tt OpenHome/Net/Service/Upnp/OpenHome/MusicStation1.xml
	echo CpAvOpenhomeOrgMusicStation1C.cpp
	$(ohNetGen) --language=c --stack=cp "--xml=OpenHome/Net/Service/Upnp/OpenHome/MusicStation1.xml" --output=$(proxyC) --domain=av.openhome.org --type=MusicStation --version=1
$(proxyC)CpAvOpenhomeOrgSpotify1C.cpp : $(tt) OpenHome/Net/T4/Templates/CpUpnpCSource.tt OpenHome/Net/T4/Templates/CpUpnpCHeader.tt OpenHome/Net/Service/Upnp/OpenHome/Spotify1.xml
	echo CpAvOpenhomeOrgSpotify1C.cpp
	$(ohNetGen) --language=c --stack=cp "--xml=OpenHome/Net/Service/Upnp/OpenHome/Spotify1.xml" --output=$(proxyC) --domain=av.openhome.org --type=Spotify --version=1
$(proxyC)CpAvOpenhomeOrgInternetRadio1C.cpp : $(tt) OpenHome/Net/T4/Templates/CpUpnpCSource.tt OpenHome/Net/T4/Templates/CpUpnpCHeader.tt OpenHome/Net/Service/Upnp/OpenHome/InternetRadio1.xml
	echo CpAvOpenhomeOrgInternetRadio1C.cpp
	$(ohNetGen) --language=c --stack=cp "--xml=OpenHome/Net/Service/Upnp/OpenHome/InternetRadio1.xml" --output=$(proxyC) --domain=av.openhome.org --type=InternetRadio --version=1
$(proxyC)CpAvOpenhomeOrgStreaming1C.cpp : $(tt) OpenHome/Net/T4/Templates/CpUpnpCSource.tt OpenHome/Net/T4/Templates/CpUpnpCHeader.tt OpenHome/Net/Service/Upnp/OpenHome/Streaming1.xml
	echo CpAvOpenhomeOrgStreaming1C.cpp
	$(ohNetGen) --language=c --stack=cp "--xml=OpenHome/Net/Service/Upnp/OpenHome/Streaming1.xml" --output=$(proxyC) --domain=av.openhome.org --type=Streaming --version=1
...
$(proxyC)CpTencentComQPlay1C.cpp : $(tt) OpenHome/Net/T4/Templates/CpUpnpCSource.tt OpenHome/Net/T4/Templates/CpUpnpCHeader.tt OpenHome/Net/Service/Upnp/Upnp/MediaServer_3/QPlay1.xml
	echo CpTencentComQPlay1C.cpp
	$(ohNetGen) --language=c --stack=cp "--xml=OpenHome/Net/Service/Upnp/Upnp/MediaServer_3/QPlay1.xml" --output=$(proxyC) --domain=tencent.com --type=QPlay --version=1

CpCs:   $(proxyCs)CpUpnpOrgAVTransport1.cs $(proxyCs)CpUpnpOrgAVTransport2.cs $(proxyCs)CpUpnpOrgConnectionManager1.cs $(proxyCs)CpUpnpOrgConnectionManager2.cs $(proxyCs)CpUpnpOrgContentDirectory1.cs $(proxyCs)CpUpnpOrgContentDirectory2.cs $(proxyCs)CpUpnpOrgContentDirectory3.cs $(proxyCs)CpUpnpOrgRenderingControl1.cs $(proxyCs)CpUpnpOrgRenderingControl2.cs $(proxyCs)CpUpnpOrgScheduledRecording1.cs $(proxyCs)CpUpnpOrgScheduledRecording2.cs $(proxyCs)CpUpnpOrgSwitchPower1.cs $(proxyCs)CpUpnpOrgDimming1.cs $(proxyCs)CpAvOpenhomeOrgInfo1.cs $(proxyCs)CpAvOpenhomeOrgTime1.cs $(proxyCs)CpAvOpenhomeOrgPlaylist1.cs $(proxyCs)CpAvOpenhomeOrgVolume1.cs $(proxyCs)CpAvOpenhomeOrgHardwareConfig1.cs $(proxyCs)CpAvOpenhomeOrgTestResamplerConfig1.cs $(proxyCs)CpAvOpenhomeOrgWebRendererConfig1.cs $(proxyCs)CpAvOpenhomeOrgWebDeviceConfig1.cs $(proxyCs)CpAvOpenhomeOrgWebProcessorConfig1.cs $(proxyCs)CpAvOpenhomeOrgWebDACConfig1.cs $(proxyCs)CpAvOpenhomeOrgWebClockConfig1.cs $(proxyCs)CpAvOpenhomeOrgDACConfig1.cs $(proxyCs)CpAvOpenhomeOrgCredentials1.cs $(proxyCs)CpAvOpenhomeOrgServerConfig1.cs $(proxyCs)CpAvOpenhomeOrgMessageCenter1.cs $(proxyCs)CpAvOpenhomeOrgRenderingInfo1.cs $(proxyCs)CpAvOpenhomeOrgGroupConfig1.cs $(proxyCs)CpAvOpenhomeOrgRoon1.cs $(proxyCs)CpAvOpenhomeOrgTidalConnect1.cs $(proxyCs)CpAvOpenhomeOrgBluetooth1.cs $(proxyCs)CpAvOpenhomeOrgAirplay1.cs $(proxyCs)CpAvOpenhomeOrgMusicStation1.cs $(proxyCs)CpAvOpenhomeOrgSpotify1.cs $(proxyCs)CpAvOpenhomeOrgInternetRadio1.cs $(proxyCs)CpAvOpenhomeOrgStreaming1.cs $(proxyCs)CpAvOpenhomeOrgProduct1.cs $(proxyCs)CpAvOpenhomeOrgRadio1.cs $(proxyCs)CpAvOpenhomeOrgReceiver1.cs $(proxyCs)CpAvOpenhomeOrgSender1.cs $(proxyCs)CpAvOpenhomeOrgPlaylistManager1.cs $(proxyCs)CpAvOpenhomeOrgMediaServer1.cs $(proxyCs)CpAvOpenhomeOrgNetworkMonitor1.cs $(proxyCs)CpOpenhomeOrgTestBasic1.cs $(proxyCs)CpOpenhomeOrgTestLights1.cs $(proxyCs)CpOpenhomeOrgSubscriptionLongPoll1.cs $(proxyCs)CpTencentComQPlay1.cs
...
$(proxyCs)CpAvOpenhomeOrgHardwareConfig1.cs : $(tt) OpenHome/Net/T4/Templates/CpUpnpCs.tt OpenHome/Net/Service/Upnp/OpenHome/HardwareConfig1.xml
	echo CpAvOpenhomeOrgHardwareConfig1.cs
	$(ohNetGen) --language=cs --stack=cp "--xml=OpenHome/Net/Service/Upnp/OpenHome/HardwareConfig1.xml" --output=$(proxyCs) --domain=av.openhome.org --type=HardwareConfig --version=1
$(proxyCs)CpAvOpenhomeOrgTestResamplerConfig1.cs : $(tt) OpenHome/Net/T4/Templates/CpUpnpCs.tt OpenHome/Net/Service/Upnp/OpenHome/TestResamplerConfig1.xml
	echo CpAvOpenhomeOrgTestResamplerConfig1.cs
	$(ohNetGen) --language=cs --stack=cp "--xml=OpenHome/Net/Service/Upnp/OpenHome/TestResamplerConfig1.xml" --output=$(proxyCs) --domain=av.openhome.org --type=TestResamplerConfig --version=1
$(proxyCs)CpAvOpenhomeOrgWebRendererConfig1.cs : $(tt) OpenHome/Net/T4/Templates/CpUpnpCs.tt OpenHome/Net/Service/Upnp/OpenHome/WebRendererConfig1.xml
	echo CpAvOpenhomeOrgWebRendererConfig1.cs
	$(ohNetGen) --language=cs --stack=cp "--xml=OpenHome/Net/Service/Upnp/OpenHome/WebRendererConfig1.xml" --output=$(proxyCs) --domain=av.openhome.org --type=WebRendererConfig --version=1
$(proxyCs)CpAvOpenhomeOrgWebDeviceConfig1.cs : $(tt) OpenHome/Net/T4/Templates/CpUpnpCs.tt OpenHome/Net/Service/Upnp/OpenHome/WebDeviceConfig1.xml
	echo CpAvOpenhomeOrgWebDeviceConfig1.cs
	$(ohNetGen) --language=cs --stack=cp "--xml=OpenHome/Net/Service/Upnp/OpenHome/WebDeviceConfig1.xml" --output=$(proxyCs) --domain=av.openhome.org --type=WebDeviceConfig --version=1
$(proxyCs)CpAvOpenhomeOrgWebProcessorConfig1.cs : $(tt) OpenHome/Net/T4/Templates/CpUpnpCs.tt OpenHome/Net/Service/Upnp/OpenHome/WebProcessorConfig1.xml
	echo CpAvOpenhomeOrgWebProcessorConfig1.cs
	$(ohNetGen) --language=cs --stack=cp "--xml=OpenHome/Net/Service/Upnp/OpenHome/WebProcessorConfig1.xml" --output=$(proxyCs) --domain=av.openhome.org --type=WebProcessorConfig --version=1
$(proxyCs)CpAvOpenhomeOrgWebDACConfig1.cs : $(tt) OpenHome/Net/T4/Templates/CpUpnpCs.tt OpenHome/Net/Service/Upnp/OpenHome/WebDACConfig1.xml
	echo CpAvOpenhomeOrgWebDACConfig1.cs
	$(ohNetGen) --language=cs --stack=cp "--xml=OpenHome/Net/Service/Upnp/OpenHome/WebDACConfig1.xml" --output=$(proxyCs) --domain=av.openhome.org --type=WebDACConfig --version=1
$(proxyCs)CpAvOpenhomeOrgWebClockConfig1.cs : $(tt) OpenHome/Net/T4/Templates/CpUpnpCs.tt OpenHome/Net/Service/Upnp/OpenHome/WebClockConfig1.xml
	echo CpAvOpenhomeOrgWebClockConfig1.cs
	$(ohNetGen) --language=cs --stack=cp "--xml=OpenHome/Net/Service/Upnp/OpenHome/WebClockConfig1.xml" --output=$(proxyCs) --domain=av.openhome.org --type=WebClockConfig --version=1
$(proxyCs)CpAvOpenhomeOrgDACConfig1.cs : $(tt) OpenHome/Net/T4/Templates/CpUpnpCs.tt OpenHome/Net/Service/Upnp/OpenHome/DACConfig1.xml
	echo CpAvOpenhomeOrgDACConfig1.cs
	$(ohNetGen) --language=cs --stack=cp "--xml=OpenHome/Net/Service/Upnp/OpenHome/DACConfig1.xml" --output=$(proxyCs) --domain=av.openhome.org --type=DACConfig --version=1
...
$(proxyCs)CpAvOpenhomeOrgServerConfig1.cs : $(tt) OpenHome/Net/T4/Templates/CpUpnpCs.tt OpenHome/Net/Service/Upnp/OpenHome/ServerConfig1.xml
	echo CpAvOpenhomeOrgServerConfig1.cs
	$(ohNetGen) --language=cs --stack=cp "--xml=OpenHome/Net/Service/Upnp/OpenHome/ServerConfig1.xml" --output=$(proxyCs) --domain=av.openhome.org --type=ServerConfig --version=1
$(proxyCs)CpAvOpenhomeOrgMessageCenter1.cs : $(tt) OpenHome/Net/T4/Templates/CpUpnpCs.tt OpenHome/Net/Service/Upnp/OpenHome/MessageCenter1.xml
	echo CpAvOpenhomeOrgMessageCenter1.cs
	$(ohNetGen) --language=cs --stack=cp "--xml=OpenHome/Net/Service/Upnp/OpenHome/MessageCenter1.xml" --output=$(proxyCs) --domain=av.openhome.org --type=MessageCenter --version=1
$(proxyCs)CpAvOpenhomeOrgRenderingInfo1.cs : $(tt) OpenHome/Net/T4/Templates/CpUpnpCs.tt OpenHome/Net/Service/Upnp/OpenHome/RenderingInfo1.xml
	echo CpAvOpenhomeOrgRenderingInfo1.cs
	$(ohNetGen) --language=cs --stack=cp "--xml=OpenHome/Net/Service/Upnp/OpenHome/RenderingInfo1.xml" --output=$(proxyCs) --domain=av.openhome.org --type=RenderingInfo --version=1
$(proxyCs)CpAvOpenhomeOrgGroupConfig1.cs : $(tt) OpenHome/Net/T4/Templates/CpUpnpCs.tt OpenHome/Net/Service/Upnp/OpenHome/GroupConfig1.xml
	echo CpAvOpenhomeOrgGroupConfig1.cs
	$(ohNetGen) --language=cs --stack=cp "--xml=OpenHome/Net/Service/Upnp/OpenHome/GroupConfig1.xml" --output=$(proxyCs) --domain=av.openhome.org --type=GroupConfig --version=1
$(proxyCs)CpAvOpenhomeOrgRoon1.cs : $(tt) OpenHome/Net/T4/Templates/CpUpnpCs.tt OpenHome/Net/Service/Upnp/OpenHome/Roon1.xml
	echo CpAvOpenhomeOrgRoon1.cs
	$(ohNetGen) --language=cs --stack=cp "--xml=OpenHome/Net/Service/Upnp/OpenHome/Roon1.xml" --output=$(proxyCs) --domain=av.openhome.org --type=Roon --version=1
$(proxyCs)CpAvOpenhomeOrgTidalConnect1.cs : $(tt) OpenHome/Net/T4/Templates/CpUpnpCs.tt OpenHome/Net/Service/Upnp/OpenHome/TidalConnect1.xml
	echo CpAvOpenhomeOrgTidalConnect1.cs
	$(ohNetGen) --language=cs --stack=cp "--xml=OpenHome/Net/Service/Upnp/OpenHome/TidalConnect1.xml" --output=$(proxyCs) --domain=av.openhome.org --type=TidalConnect --version=1
$(proxyCs)CpAvOpenhomeOrgBluetooth1.cs : $(tt) OpenHome/Net/T4/Templates/CpUpnpCs.tt OpenHome/Net/Service/Upnp/OpenHome/Bluetooth1.xml
	echo CpAvOpenhomeOrgBluetooth1.cs
	$(ohNetGen) --language=cs --stack=cp "--xml=OpenHome/Net/Service/Upnp/OpenHome/Bluetooth1.xml" --output=$(proxyCs) --domain=av.openhome.org --type=Bluetooth --version=1
$(proxyCs)CpAvOpenhomeOrgAirplay1.cs : $(tt) OpenHome/Net/T4/Templates/CpUpnpCs.tt OpenHome/Net/Service/Upnp/OpenHome/Airplay1.xml
	echo CpAvOpenhomeOrgAirplay1.cs
	$(ohNetGen) --language=cs --stack=cp "--xml=OpenHome/Net/Service/Upnp/OpenHome/Airplay1.xml" --output=$(proxyCs) --domain=av.openhome.org --type=Airplay --version=1
$(proxyCs)CpAvOpenhomeOrgMusicStation1.cs : $(tt) OpenHome/Net/T4/Templates/CpUpnpCs.tt OpenHome/Net/Service/Upnp/OpenHome/MusicStation1.xml
	echo CpAvOpenhomeOrgMusicStation1.cs
	$(ohNetGen) --language=cs --stack=cp "--xml=OpenHome/Net/Service/Upnp/OpenHome/MusicStation1.xml" --output=$(proxyCs) --domain=av.openhome.org --type=MusicStation --version=1
$(proxyCs)CpAvOpenhomeOrgSpotify1.cs : $(tt) OpenHome/Net/T4/Templates/CpUpnpCs.tt OpenHome/Net/Service/Upnp/OpenHome/Spotify1.xml
	echo CpAvOpenhomeOrgSpotify1.cs
	$(ohNetGen) --language=cs --stack=cp "--xml=OpenHome/Net/Service/Upnp/OpenHome/Spotify1.xml" --output=$(proxyCs) --domain=av.openhome.org --type=Spotify --version=1
$(proxyCs)CpAvOpenhomeOrgInternetRadio1.cs : $(tt) OpenHome/Net/T4/Templates/CpUpnpCs.tt OpenHome/Net/Service/Upnp/OpenHome/InternetRadio1.xml
	echo CpAvOpenhomeOrgInternetRadio1.cs
	$(ohNetGen) --language=cs --stack=cp "--xml=OpenHome/Net/Service/Upnp/OpenHome/InternetRadio1.xml" --output=$(proxyCs) --domain=av.openhome.org --type=InternetRadio --version=1
$(proxyCs)CpAvOpenhomeOrgStreaming1.cs : $(tt) OpenHome/Net/T4/Templates/CpUpnpCs.tt OpenHome/Net/Service/Upnp/OpenHome/Streaming1.xml
	echo CpAvOpenhomeOrgStreaming1.cs
	$(ohNetGen) --language=cs --stack=cp "--xml=OpenHome/Net/Service/Upnp/OpenHome/Streaming1.xml" --output=$(proxyCs) --domain=av.openhome.org --type=Streaming --version=1
...
$(proxyCs)CpTencentComQPlay1.cs : $(tt) OpenHome/Net/T4/Templates/CpUpnpCs.tt OpenHome/Net/Service/Upnp/Upnp/MediaServer_3/QPlay1.xml
	echo CpTencentComQPlay1.cs
	$(ohNetGen) --language=cs --stack=cp "--xml=OpenHome/Net/Service/Upnp/Upnp/MediaServer_3/QPlay1.xml" --output=$(proxyCs) --domain=tencent.com --type=QPlay --version=1

CpJava:   $(proxyJava)CpProxyUpnpOrgAVTransport1.java $(proxyJava)CpProxyUpnpOrgAVTransport2.java $(proxyJava)CpProxyUpnpOrgConnectionManager1.java $(proxyJava)CpProxyUpnpOrgConnectionManager2.java $(proxyJava)CpProxyUpnpOrgContentDirectory1.java $(proxyJava)CpProxyUpnpOrgContentDirectory2.java $(proxyJava)CpProxyUpnpOrgContentDirectory3.java $(proxyJava)CpProxyUpnpOrgRenderingControl1.java $(proxyJava)CpProxyUpnpOrgRenderingControl2.java $(proxyJava)CpProxyUpnpOrgScheduledRecording1.java $(proxyJava)CpProxyUpnpOrgScheduledRecording2.java $(proxyJava)CpProxyUpnpOrgSwitchPower1.java $(proxyJava)CpProxyUpnpOrgDimming1.java $(proxyJava)CpProxyAvOpenhomeOrgInfo1.java $(proxyJava)CpProxyAvOpenhomeOrgTime1.java $(proxyJava)CpProxyAvOpenhomeOrgPlaylist1.java $(proxyJava)CpProxyAvOpenhomeOrgVolume1.java $(proxyJava)CpProxyAvOpenhomeOrgHardwareConfig1.java $(proxyJava)CpProxyAvOpenhomeOrgTestResamplerConfig1.java $(proxyJava)CpProxyAvOpenhomeOrgWebRendererConfig1.java $(proxyJava)CpProxyAvOpenhomeOrgWebDeviceConfig1.java $(proxyJava)CpProxyAvOpenhomeOrgWebProcessorConfig1.java $(proxyJava)CpProxyAvOpenhomeOrgWebDACConfig1.java $(proxyJava)CpProxyAvOpenhomeOrgWebClockConfig1.java $(proxyJava)CpProxyAvOpenhomeOrgDACConfig1.java $(proxyJava)CpProxyAvOpenhomeOrgCredentials1.java $(proxyJava)CpProxyAvOpenhomeOrgServerConfig1.java $(proxyJava)CpProxyAvOpenhomeOrgMessageCenter1.java $(proxyJava)CpProxyAvOpenhomeOrgRenderingInfo1.java $(proxyJava)CpProxyAvOpenhomeOrgGroupConfig1.java $(proxyJava)CpProxyAvOpenhomeOrgRoon1.java $(proxyJava)CpProxyAvOpenhomeOrgTidalConnect1.java $(proxyJava)CpProxyAvOpenhomeOrgBluetooth1.java $(proxyJava)CpProxyAvOpenhomeOrgAirplay1.java $(proxyJava)CpProxyAvOpenhomeOrgMusicStation1.java $(proxyJava)CpProxyAvOpenhomeOrgSpotify1.java $(proxyJava)CpProxyAvOpenhomeOrgInternetRadio1.java $(proxyJava)CpProxyAvOpenhomeOrgStreaming1.java $(proxyJava)CpProxyAvOpenhomeOrgProduct1.java $(proxyJava)CpProxyAvOpenhomeOrgRadio1.java $(proxyJava)CpProxyAvOpenhomeOrgReceiver1.java $(proxyJava)CpProxyAvOpenhomeOrgSender1.java $(proxyJava)CpProxyAvOpenhomeOrgPlaylistManager1.java $(proxyJava)CpProxyAvOpenhomeOrgMediaServer1.java $(proxyJava)CpProxyAvOpenhomeOrgNetworkMonitor1.java $(proxyJava)CpProxyOpenhomeOrgTestBasic1.java $(proxyJava)CpProxyOpenhomeOrgTestLights1.java $(proxyJava)CpProxyOpenhomeOrgSubscriptionLongPoll1.java $(proxyJava)CpProxyTencentComQPlay1.java
...
$(proxyJava)CpProxyAvOpenhomeOrgHardwareConfig1.java : $(tt) OpenHome/Net/T4/Templates/CpUpnpJava.tt OpenHome/Net/Service/Upnp/OpenHome/HardwareConfig1.xml
	echo CpProxyAvOpenhomeOrgHardwareConfig1.java
	$(ohNetGen) --language=java --stack=cp "--xml=OpenHome/Net/Service/Upnp/OpenHome/HardwareConfig1.xml" --output=$(proxyJava) --domain=av.openhome.org --type=HardwareConfig --version=1
$(proxyJava)CpProxyAvOpenhomeOrgTestResamplerConfig1.java : $(tt) OpenHome/Net/T4/Templates/CpUpnpJava.tt OpenHome/Net/Service/Upnp/OpenHome/TestResamplerConfig1.xml
	echo CpProxyAvOpenhomeOrgTestResamplerConfig1.java
	$(ohNetGen) --language=java --stack=cp "--xml=OpenHome/Net/Service/Upnp/OpenHome/TestResamplerConfig1.xml" --output=$(proxyJava) --domain=av.openhome.org --type=TestResamplerConfig --version=1
$(proxyJava)CpProxyAvOpenhomeOrgWebRendererConfig1.java : $(tt) OpenHome/Net/T4/Templates/CpUpnpJava.tt OpenHome/Net/Service/Upnp/OpenHome/WebRendererConfig1.xml
	echo CpProxyAvOpenhomeOrgWebRendererConfig1.java
	$(ohNetGen) --language=java --stack=cp "--xml=OpenHome/Net/Service/Upnp/OpenHome/WebRendererConfig1.xml" --output=$(proxyJava) --domain=av.openhome.org --type=WebRendererConfig --version=1
$(proxyJava)CpProxyAvOpenhomeOrgWebDeviceConfig1.java : $(tt) OpenHome/Net/T4/Templates/CpUpnpJava.tt OpenHome/Net/Service/Upnp/OpenHome/WebDeviceConfig1.xml
	echo CpProxyAvOpenhomeOrgWebDeviceConfig1.java
	$(ohNetGen) --language=java --stack=cp "--xml=OpenHome/Net/Service/Upnp/OpenHome/WebDeviceConfig1.xml" --output=$(proxyJava) --domain=av.openhome.org --type=WebDeviceConfig --version=1
$(proxyJava)CpProxyAvOpenhomeOrgWebProcessorConfig1.java : $(tt) OpenHome/Net/T4/Templates/CpUpnpJava.tt OpenHome/Net/Service/Upnp/OpenHome/WebProcessorConfig1.xml
	echo CpProxyAvOpenhomeOrgWebProcessorConfig1.java
	$(ohNetGen) --language=java --stack=cp "--xml=OpenHome/Net/Service/Upnp/OpenHome/WebProcessorConfig1.xml" --output=$(proxyJava) --domain=av.openhome.org --type=WebProcessorConfig --version=1
$(proxyJava)CpProxyAvOpenhomeOrgWebDACConfig1.java : $(tt) OpenHome/Net/T4/Templates/CpUpnpJava.tt OpenHome/Net/Service/Upnp/OpenHome/WebDACConfig1.xml
	echo CpProxyAvOpenhomeOrgWebDACConfig1.java
	$(ohNetGen) --language=java --stack=cp "--xml=OpenHome/Net/Service/Upnp/OpenHome/WebDACConfig1.xml" --output=$(proxyJava) --domain=av.openhome.org --type=WebDACConfig --version=1
$(proxyJava)CpProxyAvOpenhomeOrgWebClockConfig1.java : $(tt) OpenHome/Net/T4/Templates/CpUpnpJava.tt OpenHome/Net/Service/Upnp/OpenHome/WebClockConfig1.xml
	echo CpProxyAvOpenhomeOrgWebClockConfig1.java
	$(ohNetGen) --language=java --stack=cp "--xml=OpenHome/Net/Service/Upnp/OpenHome/WebClockConfig1.xml" --output=$(proxyJava) --domain=av.openhome.org --type=WebClockConfig --version=1
$(proxyJava)CpProxyAvOpenhomeOrgDACConfig1.java : $(tt) OpenHome/Net/T4/Templates/CpUpnpJava.tt OpenHome/Net/Service/Upnp/OpenHome/DACConfig1.xml
	echo CpProxyAvOpenhomeOrgDACConfig1.java
	$(ohNetGen) --language=java --stack=cp "--xml=OpenHome/Net/Service/Upnp/OpenHome/DACConfig1.xml" --output=$(proxyJava) --domain=av.openhome.org --type=DACConfig --version=1
...
$(proxyJava)CpProxyAvOpenhomeOrgServerConfig1.java : $(tt) OpenHome/Net/T4/Templates/CpUpnpJava.tt OpenHome/Net/Service/Upnp/OpenHome/ServerConfig1.xml
	echo CpProxyAvOpenhomeOrgServerConfig1.java
	$(ohNetGen) --language=java --stack=cp "--xml=OpenHome/Net/Service/Upnp/OpenHome/ServerConfig1.xml" --output=$(proxyJava) --domain=av.openhome.org --type=ServerConfig --version=1
$(proxyJava)CpProxyAvOpenhomeOrgMessageCenter1.java : $(tt) OpenHome/Net/T4/Templates/CpUpnpJava.tt OpenHome/Net/Service/Upnp/OpenHome/MessageCenter1.xml
	echo CpProxyAvOpenhomeOrgMessageCenter1.java
	$(ohNetGen) --language=java --stack=cp "--xml=OpenHome/Net/Service/Upnp/OpenHome/MessageCenter1.xml" --output=$(proxyJava) --domain=av.openhome.org --type=MessageCenter --version=1
$(proxyJava)CpProxyAvOpenhomeOrgRenderingInfo1.java : $(tt) OpenHome/Net/T4/Templates/CpUpnpJava.tt OpenHome/Net/Service/Upnp/OpenHome/RenderingInfo1.xml
	echo CpProxyAvOpenhomeOrgRenderingInfo1.java
	$(ohNetGen) --language=java --stack=cp "--xml=OpenHome/Net/Service/Upnp/OpenHome/RenderingInfo1.xml" --output=$(proxyJava) --domain=av.openhome.org --type=RenderingInfo --version=1
$(proxyJava)CpProxyAvOpenhomeOrgGroupConfig1.java : $(tt) OpenHome/Net/T4/Templates/CpUpnpJava.tt OpenHome/Net/Service/Upnp/OpenHome/GroupConfig1.xml
	echo CpProxyAvOpenhomeOrgGroupConfig1.java
	$(ohNetGen) --language=java --stack=cp "--xml=OpenHome/Net/Service/Upnp/OpenHome/GroupConfig1.xml" --output=$(proxyJava) --domain=av.openhome.org --type=GroupConfig --version=1
$(proxyJava)CpProxyAvOpenhomeOrgRoon1.java : $(tt) OpenHome/Net/T4/Templates/CpUpnpJava.tt OpenHome/Net/Service/Upnp/OpenHome/Roon1.xml
	echo CpProxyAvOpenhomeOrgRoon1.java
	$(ohNetGen) --language=java --stack=cp "--xml=OpenHome/Net/Service/Upnp/OpenHome/Roon1.xml" --output=$(proxyJava) --domain=av.openhome.org --type=Roon --version=1
$(proxyJava)CpProxyAvOpenhomeOrgTidalConnect1.java : $(tt) OpenHome/Net/T4/Templates/CpUpnpJava.tt OpenHome/Net/Service/Upnp/OpenHome/TidalConnect1.xml
	echo CpProxyAvOpenhomeOrgTidalConnect1.java
	$(ohNetGen) --language=java --stack=cp "--xml=OpenHome/Net/Service/Upnp/OpenHome/TidalConnect1.xml" --output=$(proxyJava) --domain=av.openhome.org --type=TidalConnect --version=1
$(proxyJava)CpProxyAvOpenhomeOrgBluetooth1.java : $(tt) OpenHome/Net/T4/Templates/CpUpnpJava.tt OpenHome/Net/Service/Upnp/OpenHome/Bluetooth1.xml
	echo CpProxyAvOpenhomeOrgBluetooth1.java
	$(ohNetGen) --language=java --stack=cp "--xml=OpenHome/Net/Service/Upnp/OpenHome/Bluetooth1.xml" --output=$(proxyJava) --domain=av.openhome.org --type=Bluetooth --version=1
$(proxyJava)CpProxyAvOpenhomeOrgAirplay1.java : $(tt) OpenHome/Net/T4/Templates/CpUpnpJava.tt OpenHome/Net/Service/Upnp/OpenHome/Airplay1.xml
	echo CpProxyAvOpenhomeOrgAirplay1.java
	$(ohNetGen) --language=java --stack=cp "--xml=OpenHome/Net/Service/Upnp/OpenHome/Airplay1.xml" --output=$(proxyJava) --domain=av.openhome.org --type=Airplay --version=1
$(proxyJava)CpProxyAvOpenhomeOrgMusicStation1.java : $(tt) OpenHome/Net/T4/Templates/CpUpnpJava.tt OpenHome/Net/Service/Upnp/OpenHome/MusicStation1.xml
	echo CpProxyAvOpenhomeOrgMusicStation1.java
	$(ohNetGen) --language=java --stack=cp "--xml=OpenHome/Net/Service/Upnp/OpenHome/MusicStation1.xml" --output=$(proxyJava) --domain=av.openhome.org --type=MusicStation --version=1
$(proxyJava)CpProxyAvOpenhomeOrgSpotify1.java : $(tt) OpenHome/Net/T4/Templates/CpUpnpJava.tt OpenHome/Net/Service/Upnp/OpenHome/Spotify1.xml
	echo CpProxyAvOpenhomeOrgSpotify1.java
	$(ohNetGen) --language=java --stack=cp "--xml=OpenHome/Net/Service/Upnp/OpenHome/Spotify1.xml" --output=$(proxyJava) --domain=av.openhome.org --type=Spotify --version=1
$(proxyJava)CpProxyAvOpenhomeOrgInternetRadio1.java : $(tt) OpenHome/Net/T4/Templates/CpUpnpJava.tt OpenHome/Net/Service/Upnp/OpenHome/InternetRadio1.xml
	echo CpProxyAvOpenhomeOrgInternetRadio1.java
	$(ohNetGen) --language=java --stack=cp "--xml=OpenHome/Net/Service/Upnp/OpenHome/InternetRadio1.xml" --output=$(proxyJava) --domain=av.openhome.org --type=InternetRadio --version=1
$(proxyJava)CpProxyAvOpenhomeOrgStreaming1.java : $(tt) OpenHome/Net/T4/Templates/CpUpnpJava.tt OpenHome/Net/Service/Upnp/OpenHome/Streaming1.xml
	echo CpProxyAvOpenhomeOrgStreaming1.java
	$(ohNetGen) --language=java --stack=cp "--xml=OpenHome/Net/Service/Upnp/OpenHome/Streaming1.xml" --output=$(proxyJava) --domain=av.openhome.org --type=Streaming --version=1
...
$(proxyJava)CpProxyTencentComQPlay1.java : $(tt) OpenHome/Net/T4/Templates/CpUpnpJava.tt OpenHome/Net/Service/Upnp/Upnp/MediaServer_3/QPlay1.xml
	echo CpProxyTencentComQPlay1.java
	$(ohNetGen) --language=java --stack=cp "--xml=OpenHome/Net/Service/Upnp/Upnp/MediaServer_3/QPlay1.xml" --output=$(proxyJava) --domain=tencent.com --type=QPlay --version=1

CpJs:   $(proxyJs)CpUpnpOrgAVTransport1.js $(proxyJs)CpUpnpOrgAVTransport2.js $(proxyJs)CpUpnpOrgConnectionManager1.js $(proxyJs)CpUpnpOrgConnectionManager2.js $(proxyJs)CpUpnpOrgContentDirectory1.js $(proxyJs)CpUpnpOrgContentDirectory2.js $(proxyJs)CpUpnpOrgContentDirectory3.js $(proxyJs)CpUpnpOrgRenderingControl1.js $(proxyJs)CpUpnpOrgRenderingControl2.js $(proxyJs)CpUpnpOrgScheduledRecording1.js $(proxyJs)CpUpnpOrgScheduledRecording2.js $(proxyJs)CpUpnpOrgSwitchPower1.js $(proxyJs)CpUpnpOrgDimming1.js $(proxyJs)CpAvOpenhomeOrgInfo1.js $(proxyJs)CpAvOpenhomeOrgTime1.js $(proxyJs)CpAvOpenhomeOrgPlaylist1.js $(proxyJs)CpAvOpenhomeOrgVolume1.js $(proxyJs)CpAvOpenhomeOrgHardwareConfig1.js $(proxyJs)CpAvOpenhomeOrgTestResamplerConfig1.js $(proxyJs)CpAvOpenhomeOrgWebRendererConfig1.js $(proxyJs)CpAvOpenhomeOrgWebDeviceConfig1.js $(proxyJs)CpAvOpenhomeOrgWebProcessorConfig1.js $(proxyJs)CpAvOpenhomeOrgWebDACConfig1.js $(proxyJs)CpAvOpenhomeOrgWebClockConfig1.js $(proxyJs)CpAvOpenhomeOrgDACConfig1.js $(proxyJs)CpAvOpenhomeOrgCredentials1.js $(proxyJs)CpAvOpenhomeOrgServerConfig1.js $(proxyJs)CpAvOpenhomeOrgMessageCenter1.js $(proxyJs)CpAvOpenhomeOrgRenderingInfo1.js $(proxyJs)CpAvOpenhomeOrgGroupConfig1.js $(proxyJs)CpAvOpenhomeOrgRoon1.js $(proxyJs)CpAvOpenhomeOrgTidalConnect1.js $(proxyJs)CpAvOpenhomeOrgBluetooth1.js $(proxyJs)CpAvOpenhomeOrgAirplay1.js $(proxyJs)CpAvOpenhomeOrgMusicStation1.js $(proxyJs)CpAvOpenhomeOrgSpotify1.js $(proxyJs)CpAvOpenhomeOrgInternetRadio1.js $(proxyJs)CpAvOpenhomeOrgStreaming1.js $(proxyJs)CpAvOpenhomeOrgProduct1.js $(proxyJs)CpAvOpenhomeOrgRadio1.js $(proxyJs)CpAvOpenhomeOrgReceiver1.js $(proxyJs)CpAvOpenhomeOrgSender1.js $(proxyJs)CpAvOpenhomeOrgPlaylistManager1.js $(proxyJs)CpAvOpenhomeOrgMediaServer1.js $(proxyJs)CpAvOpenhomeOrgNetworkMonitor1.js $(proxyJs)CpOpenhomeOrgTestBasic1.js $(proxyJs)CpOpenhomeOrgTestLights1.js $(proxyJs)CpOpenhomeOrgSubscriptionLongPoll1.js $(proxyJs)CpTencentComQPlay1.js
...
$(proxyJs)CpAvOpenhomeOrgHardwareConfig1.js : $(tt) OpenHome/Net/T4/Templates/CpUpnpJs.tt OpenHome/Net/Service/Upnp/OpenHome/HardwareConfig1.xml
	echo CpAvOpenhomeOrgHardwareConfig1.js
	$(ohNetGen) --language=js --stack=cp "--xml=OpenHome/Net/Service/Upnp/OpenHome/HardwareConfig1.xml" --output=$(proxyJs) --domain=av.openhome.org --type=HardwareConfig --version=1
$(proxyJs)CpAvOpenhomeOrgTestResamplerConfig1.js : $(tt) OpenHome/Net/T4/Templates/CpUpnpJs.tt OpenHome/Net/Service/Upnp/OpenHome/TestResamplerConfig1.xml
	echo CpAvOpenhomeOrgTestResamplerConfig1.js
	$(ohNetGen) --language=js --stack=cp "--xml=OpenHome/Net/Service/Upnp/OpenHome/TestResamplerConfig1.xml" --output=$(proxyJs) --domain=av.openhome.org --type=TestResamplerConfig --version=1
$(proxyJs)CpAvOpenhomeOrgWebRendererConfig1.js : $(tt) OpenHome/Net/T4/Templates/CpUpnpJs.tt OpenHome/Net/Service/Upnp/OpenHome/WebRendererConfig1.xml
	echo CpAvOpenhomeOrgWebRendererConfig1.js
	$(ohNetGen) --language=js --stack=cp "--xml=OpenHome/Net/Service/Upnp/OpenHome/WebRendererConfig1.xml" --output=$(proxyJs) --domain=av.openhome.org --type=WebRendererConfig --version=1
$(proxyJs)CpAvOpenhomeOrgWebDeviceConfig1.js : $(tt) OpenHome/Net/T4/Templates/CpUpnpJs.tt OpenHome/Net/Service/Upnp/OpenHome/WebDeviceConfig1.xml
	echo CpAvOpenhomeOrgWebDeviceConfig1.js
	$(ohNetGen) --language=js --stack=cp "--xml=OpenHome/Net/Service/Upnp/OpenHome/WebDeviceConfig1.xml" --output=$(proxyJs) --domain=av.openhome.org --type=WebDeviceConfig --version=1
$(proxyJs)CpAvOpenhomeOrgWebProcessorConfig1.js : $(tt) OpenHome/Net/T4/Templates/CpUpnpJs.tt OpenHome/Net/Service/Upnp/OpenHome/WebProcessorConfig1.xml
	echo CpAvOpenhomeOrgWebProcessorConfig1.js
	$(ohNetGen) --language=js --stack=cp "--xml=OpenHome/Net/Service/Upnp/OpenHome/WebProcessorConfig1.xml" --output=$(proxyJs) --domain=av.openhome.org --type=WebProcessorConfig --version=1
$(proxyJs)CpAvOpenhomeOrgWebDACConfig1.js : $(tt) OpenHome/Net/T4/Templates/CpUpnpJs.tt OpenHome/Net/Service/Upnp/OpenHome/WebDACConfig1.xml
	echo CpAvOpenhomeOrgWebDACConfig1.js
	$(ohNetGen) --language=js --stack=cp "--xml=OpenHome/Net/Service/Upnp/OpenHome/WebDACConfig1.xml" --output=$(proxyJs) --domain=av.openhome.org --type=WebDACConfig --version=1
$(proxyJs)CpAvOpenhomeOrgWebClockConfig1.js : $(tt) OpenHome/Net/T4/Templates/CpUpnpJs.tt OpenHome/Net/Service/Upnp/OpenHome/WebClockConfig1.xml
	echo CpAvOpenhomeOrgWebClockConfig1.js
	$(ohNetGen) --language=js --stack=cp "--xml=OpenHome/Net/Service/Upnp/OpenHome/WebClockConfig1.xml" --output=$(proxyJs) --domain=av.openhome.org --type=WebClockConfig --version=1
$(proxyJs)CpAvOpenhomeOrgDACConfig1.js : $(tt) OpenHome/Net/T4/Templates/CpUpnpJs.tt OpenHome/Net/Service/Upnp/OpenHome/DACConfig1.xml
	echo CpAvOpenhomeOrgDACConfig1.js
	$(ohNetGen) --language=js --stack=cp "--xml=OpenHome/Net/Service/Upnp/OpenHome/DACConfig1.xml" --output=$(proxyJs) --domain=av.openhome.org --type=DACConfig --version=1
...
$(proxyJs)CpAvOpenhomeOrgServerConfig1.js : $(tt) OpenHome/Net/T4/Templates/CpUpnpJs.tt OpenHome/Net/Service/Upnp/OpenHome/ServerConfig1.xml
	echo CpAvOpenhomeOrgServerConfig1.js
	$(ohNetGen) --language=js --stack=cp "--xml=OpenHome/Net/Service/Upnp/OpenHome/ServerConfig1.xml" --output=$(proxyJs) --domain=av.openhome.org --type=ServerConfig --version=1
$(proxyJs)CpAvOpenhomeOrgMessageCenter1.js : $(tt) OpenHome/Net/T4/Templates/CpUpnpJs.tt OpenHome/Net/Service/Upnp/OpenHome/MessageCenter1.xml
	echo CpAvOpenhomeOrgMessageCenter1.js
	$(ohNetGen) --language=js --stack=cp "--xml=OpenHome/Net/Service/Upnp/OpenHome/MessageCenter1.xml" --output=$(proxyJs) --domain=av.openhome.org --type=MessageCenter --version=1
$(proxyJs)CpAvOpenhomeOrgRenderingInfo1.js : $(tt) OpenHome/Net/T4/Templates/CpUpnpJs.tt OpenHome/Net/Service/Upnp/OpenHome/RenderingInfo1.xml
	echo CpAvOpenhomeOrgRenderingInfo1.js
	$(ohNetGen) --language=js --stack=cp "--xml=OpenHome/Net/Service/Upnp/OpenHome/RenderingInfo1.xml" --output=$(proxyJs) --domain=av.openhome.org --type=RenderingInfo --version=1
$(proxyJs)CpAvOpenhomeOrgGroupConfig1.js : $(tt) OpenHome/Net/T4/Templates/CpUpnpJs.tt OpenHome/Net/Service/Upnp/OpenHome/GroupConfig1.xml
	echo CpAvOpenhomeOrgGroupConfig1.js
	$(ohNetGen) --language=js --stack=cp "--xml=OpenHome/Net/Service/Upnp/OpenHome/GroupConfig1.xml" --output=$(proxyJs) --domain=av.openhome.org --type=GroupConfig --version=1
$(proxyJs)CpAvOpenhomeOrgRoon1.js : $(tt) OpenHome/Net/T4/Templates/CpUpnpJs.tt OpenHome/Net/Service/Upnp/OpenHome/Roon1.xml
	echo CpAvOpenhomeOrgRoon1.js
	$(ohNetGen) --language=js --stack=cp "--xml=OpenHome/Net/Service/Upnp/OpenHome/Roon1.xml" --output=$(proxyJs) --domain=av.openhome.org --type=Roon --version=1
$(proxyJs)CpAvOpenhomeOrgTidalConnect1.js : $(tt) OpenHome/Net/T4/Templates/CpUpnpJs.tt OpenHome/Net/Service/Upnp/OpenHome/TidalConnect1.xml
	echo CpAvOpenhomeOrgTidalConnect1.js
	$(ohNetGen) --language=js --stack=cp "--xml=OpenHome/Net/Service/Upnp/OpenHome/TidalConnect1.xml" --output=$(proxyJs) --domain=av.openhome.org --type=TidalConnect --version=1
$(proxyJs)CpAvOpenhomeOrgBluetooth1.js : $(tt) OpenHome/Net/T4/Templates/CpUpnpJs.tt OpenHome/Net/Service/Upnp/OpenHome/Bluetooth1.xml
	echo CpAvOpenhomeOrgBluetooth1.js
	$(ohNetGen) --language=js --stack=cp "--xml=OpenHome/Net/Service/Upnp/OpenHome/Bluetooth1.xml" --output=$(proxyJs) --domain=av.openhome.org --type=Bluetooth --version=1
$(proxyJs)CpAvOpenhomeOrgAirplay1.js : $(tt) OpenHome/Net/T4/Templates/CpUpnpJs.tt OpenHome/Net/Service/Upnp/OpenHome/Airplay1.xml
	echo CpAvOpenhomeOrgAirplay1.js
	$(ohNetGen) --language=js --stack=cp "--xml=OpenHome/Net/Service/Upnp/OpenHome/Airplay1.xml" --output=$(proxyJs) --domain=av.openhome.org --type=Airplay --version=1
$(proxyJs)CpAvOpenhomeOrgMusicStation1.js : $(tt) OpenHome/Net/T4/Templates/CpUpnpJs.tt OpenHome/Net/Service/Upnp/OpenHome/MusicStation1.xml
	echo CpAvOpenhomeOrgMusicStation1.js
	$(ohNetGen) --language=js --stack=cp "--xml=OpenHome/Net/Service/Upnp/OpenHome/MusicStation1.xml" --output=$(proxyJs) --domain=av.openhome.org --type=MusicStation --version=1
$(proxyJs)CpAvOpenhomeOrgSpotify1.js : $(tt) OpenHome/Net/T4/Templates/CpUpnpJs.tt OpenHome/Net/Service/Upnp/OpenHome/Spotify1.xml
	echo CpAvOpenhomeOrgSpotify1.js
	$(ohNetGen) --language=js --stack=cp "--xml=OpenHome/Net/Service/Upnp/OpenHome/Spotify1.xml" --output=$(proxyJs) --domain=av.openhome.org --type=Spotify --version=1
$(proxyJs)CpAvOpenhomeOrgInternetRadio1.js : $(tt) OpenHome/Net/T4/Templates/CpUpnpJs.tt OpenHome/Net/Service/Upnp/OpenHome/InternetRadio1.xml
	echo CpAvOpenhomeOrgInternetRadio1.js
	$(ohNetGen) --language=js --stack=cp "--xml=OpenHome/Net/Service/Upnp/OpenHome/InternetRadio1.xml" --output=$(proxyJs) --domain=av.openhome.org --type=InternetRadio --version=1
$(proxyJs)CpAvOpenhomeOrgStreaming1.js : $(tt) OpenHome/Net/T4/Templates/CpUpnpJs.tt OpenHome/Net/Service/Upnp/OpenHome/Streaming1.xml
	echo CpAvOpenhomeOrgStreaming1.js
	$(ohNetGen) --language=js --stack=cp "--xml=OpenHome/Net/Service/Upnp/OpenHome/Streaming1.xml" --output=$(proxyJs) --domain=av.openhome.org --type=Streaming --version=1
...
$(proxyJs)CpTencentComQPlay1.js : $(tt) OpenHome/Net/T4/Templates/CpUpnpJs.tt OpenHome/Net/Service/Upnp/Upnp/MediaServer_3/QPlay1.xml
	echo CpTencentComQPlay1.js
	$(ohNetGen) --language=js --stack=cp "--xml=OpenHome/Net/Service/Upnp/Upnp/MediaServer_3/QPlay1.xml" --output=$(proxyJs) --domain=tencent.com --type=QPlay --version=1

DvCppCore :   $(deviceCppCore)DvUpnpOrgAVTransport1.cpp $(deviceCppCore)DvUpnpOrgAVTransport2.cpp $(deviceCppCore)DvUpnpOrgConnectionManager1.cpp $(deviceCppCore)DvUpnpOrgConnectionManager2.cpp $(deviceCppCore)DvUpnpOrgContentDirectory1.cpp $(deviceCppCore)DvUpnpOrgContentDirectory2.cpp $(deviceCppCore)DvUpnpOrgContentDirectory3.cpp $(deviceCppCore)DvUpnpOrgRenderingControl1.cpp $(deviceCppCore)DvUpnpOrgRenderingControl2.cpp $(deviceCppCore)DvUpnpOrgScheduledRecording1.cpp $(deviceCppCore)DvUpnpOrgScheduledRecording2.cpp $(deviceCppCore)DvUpnpOrgSwitchPower1.cpp $(deviceCppCore)DvUpnpOrgDimming1.cpp $(deviceCppCore)DvAvOpenhomeOrgInfo1.cpp $(deviceCppCore)DvAvOpenhomeOrgTime1.cpp $(deviceCppCore)DvAvOpenhomeOrgPlaylist1.cpp $(deviceCppCore)DvAvOpenhomeOrgVolume1.cpp $(deviceCppCore)DvAvOpenhomeOrgHardwareConfig1.cpp $(deviceCppCore)DvAvOpenhomeOrgTestResamplerConfig1.cpp $(deviceCppCore)DvAvOpenhomeOrgWebRendererConfig1.cpp $(deviceCppCore)DvAvOpenhomeOrgWebDeviceConfig1.cpp $(deviceCppCore)DvAvOpenhomeOrgWebProcessorConfig1.cpp $(deviceCppCore)DvAvOpenhomeOrgWebDACConfig1.cpp $(deviceCppCore)DvAvOpenhomeOrgWebClockConfig1.cpp $(deviceCppCore)DvAvOpenhomeOrgDACConfig1.cpp $(deviceCppCore)DvAvOpenhomeOrgCredentials1.cpp $(deviceCppCore)DvAvOpenhomeOrgServerConfig1.cpp $(deviceCppCore)DvAvOpenhomeOrgMessageCenter1.cpp $(deviceCppCore)DvAvOpenhomeOrgRenderingInfo1.cpp $(deviceCppCore)DvAvOpenhomeOrgGroupConfig1.cpp $(deviceCppCore)DvAvOpenhomeOrgRoon1.cpp $(deviceCppCore)DvAvOpenhomeOrgTidalConnect1.cpp $(deviceCppCore)DvAvOpenhomeOrgBluetooth1.cpp $(deviceCppCore)DvAvOpenhomeOrgAirplay1.cpp $(deviceCppCore)DvAvOpenhomeOrgMusicStation1.cpp $(deviceCppCore)DvAvOpenhomeOrgSpotify1.cpp $(deviceCppCore)DvAvOpenhomeOrgInternetRadio1.cpp $(deviceCppCore)DvAvOpenhomeOrgStreaming1.cpp $(deviceCppCore)DvAvOpenhomeOrgProduct1.cpp $(deviceCppCore)DvAvOpenhomeOrgRadio1.cpp $(deviceCppCore)DvAvOpenhomeOrgReceiver1.cpp $(deviceCppCore)DvAvOpenhomeOrgSender1.cpp $(deviceCppCore)DvAvOpenhomeOrgPlaylistManager1.cpp $(deviceCppCore)DvAvOpenhomeOrgMediaServer1.cpp $(deviceCppCore)DvAvOpenhomeOrgNetworkMonitor1.cpp $(deviceCppCore)DvOpenhomeOrgTestBasic1.cpp $(deviceCppCore)DvOpenhomeOrgTestLights1.cpp $(deviceCppCore)DvOpenhomeOrgSubscriptionLongPoll1.cpp $(deviceCppCore)DvTencentComQPlay1.cpp
...
$(deviceCppCore)DvAvOpenhomeOrgHardwareConfig1.cpp : $(tt) OpenHome/Net/T4/Templates/DvUpnpCppCoreSource.tt OpenHome/Net/T4/Templates/DvUpnpCppCoreHeader.tt OpenHome/Net/Service/Upnp/OpenHome/HardwareConfig1.xml
	echo DvAvOpenhomeOrgHardwareConfig1.cpp
	$(ohNetGen) --language=cppcore --stack=dv "--xml=OpenHome/Net/Service/Upnp/OpenHome/HardwareConfig1.xml" --output=$(deviceCppCore) --domain=av.openhome.org --type=HardwareConfig --version=1
$(deviceCppCore)DvAvOpenhomeOrgTestResamplerConfig1.cpp : $(tt) OpenHome/Net/T4/Templates/DvUpnpCppCoreSource.tt OpenHome/Net/T4/Templates/DvUpnpCppCoreHeader.tt OpenHome/Net/Service/Upnp/OpenHome/TestResamplerConfig1.xml
	echo DvAvOpenhomeOrgTestResamplerConfig1.cpp
	$(ohNetGen) --language=cppcore --stack=dv "--xml=OpenHome/Net/Service/Upnp/OpenHome/TestResamplerConfig1.xml" --output=$(deviceCppCore) --domain=av.openhome.org --type=TestResamplerConfig --version=1
$(deviceCppCore)DvAvOpenhomeOrgWebRendererConfig1.cpp : $(tt) OpenHome/Net/T4/Templates/DvUpnpCppCoreSource.tt OpenHome/Net/T4/Templates/DvUpnpCppCoreHeader.tt OpenHome/Net/Service/Upnp/OpenHome/WebRendererConfig1.xml
	echo DvAvOpenhomeOrgWebRendererConfig1.cpp
	$(ohNetGen) --language=cppcore --stack=dv "--xml=OpenHome/Net/Service/Upnp/OpenHome/WebRendererConfig1.xml" --output=$(deviceCppCore) --domain=av.openhome.org --type=WebRendererConfig --version=1
$(deviceCppCore)DvAvOpenhomeOrgWebDeviceConfig1.cpp : $(tt) OpenHome/Net/T4/Templates/DvUpnpCppCoreSource.tt OpenHome/Net/T4/Templates/DvUpnpCppCoreHeader.tt OpenHome/Net/Service/Upnp/OpenHome/WebDeviceConfig1.xml
	echo DvAvOpenhomeOrgWebDeviceConfig1.cpp
	$(ohNetGen) --language=cppcore --stack=dv "--xml=OpenHome/Net/Service/Upnp/OpenHome/WebDeviceConfig1.xml" --output=$(deviceCppCore) --domain=av.openhome.org --type=WebDeviceConfig --version=1
$(deviceCppCore)DvAvOpenhomeOrgWebProcessorConfig1.cpp : $(tt) OpenHome/Net/T4/Templates/DvUpnpCppCoreSource.tt OpenHome/Net/T4/Templates/DvUpnpCppCoreHeader.tt OpenHome/Net/Service/Upnp/OpenHome/WebProcessorConfig1.xml
	echo DvAvOpenhomeOrgWebProcessorConfig1.cpp
	$(ohNetGen) --language=cppcore --stack=dv "--xml=OpenHome/Net/Service/Upnp/OpenHome/WebProcessorConfig1.xml" --output=$(deviceCppCore) --domain=av.openhome.org --type=WebProcessorConfig --version=1
$(deviceCppCore)DvAvOpenhomeOrgWebDACConfig1.cpp : $(tt) OpenHome/Net/T4/Templates/DvUpnpCppCoreSource.tt OpenHome/Net/T4/Templates/DvUpnpCppCoreHeader.tt OpenHome/Net/Service/Upnp/OpenHome/WebDACConfig1.xml
	echo DvAvOpenhomeOrgWebDACConfig1.cpp
	$(ohNetGen) --language=cppcore --stack=dv "--xml=OpenHome/Net/Service/Upnp/OpenHome/WebDACConfig1.xml" --output=$(deviceCppCore) --domain=av.openhome.org --type=WebDACConfig --version=1
$(deviceCppCore)DvAvOpenhomeOrgWebClockConfig1.cpp : $(tt) OpenHome/Net/T4/Templates/DvUpnpCppCoreSource.tt OpenHome/Net/T4/Templates/DvUpnpCppCoreHeader.tt OpenHome/Net/Service/Upnp/OpenHome/WebClockConfig1.xml
	echo DvAvOpenhomeOrgWebClockConfig1.cpp
	$(ohNetGen) --language=cppcore --stack=dv "--xml=OpenHome/Net/Service/Upnp/OpenHome/WebClockConfig1.xml" --output=$(deviceCppCore) --domain=av.openhome.org --type=WebClockConfig --version=1
$(deviceCppCore)DvAvOpenhomeOrgDACConfig1.cpp : $(tt) OpenHome/Net/T4/Templates/DvUpnpCppCoreSource.tt OpenHome/Net/T4/Templates/DvUpnpCppCoreHeader.tt OpenHome/Net/Service/Upnp/OpenHome/DACConfig1.xml
	echo DvAvOpenhomeOrgDACConfig1.cpp
	$(ohNetGen) --language=cppcore --stack=dv "--xml=OpenHome/Net/Service/Upnp/OpenHome/DACConfig1.xml" --output=$(deviceCppCore) --domain=av.openhome.org --type=DACConfig --version=1
...
$(deviceCppCore)DvAvOpenhomeOrgServerConfig1.cpp : $(tt) OpenHome/Net/T4/Templates/DvUpnpCppCoreSource.tt OpenHome/Net/T4/Templates/DvUpnpCppCoreHeader.tt OpenHome/Net/Service/Upnp/OpenHome/ServerConfig1.xml
	echo DvAvOpenhomeOrgServerConfig1.cpp
	$(ohNetGen) --language=cppcore --stack=dv "--xml=OpenHome/Net/Service/Upnp/OpenHome/ServerConfig1.xml" --output=$(deviceCppCore) --domain=av.openhome.org --type=ServerConfig --version=1
$(deviceCppCore)DvAvOpenhomeOrgMessageCenter1.cpp : $(tt) OpenHome/Net/T4/Templates/DvUpnpCppCoreSource.tt OpenHome/Net/T4/Templates/DvUpnpCppCoreHeader.tt OpenHome/Net/Service/Upnp/OpenHome/MessageCenter1.xml
	echo DvAvOpenhomeOrgMessageCenter1.cpp
	$(ohNetGen) --language=cppcore --stack=dv "--xml=OpenHome/Net/Service/Upnp/OpenHome/MessageCenter1.xml" --output=$(deviceCppCore) --domain=av.openhome.org --type=MessageCenter --version=1
$(deviceCppCore)DvAvOpenhomeOrgRenderingInfo1.cpp : $(tt) OpenHome/Net/T4/Templates/DvUpnpCppCoreSource.tt OpenHome/Net/T4/Templates/DvUpnpCppCoreHeader.tt OpenHome/Net/Service/Upnp/OpenHome/RenderingInfo1.xml
	echo DvAvOpenhomeOrgRenderingInfo1.cpp
	$(ohNetGen) --language=cppcore --stack=dv "--xml=OpenHome/Net/Service/Upnp/OpenHome/RenderingInfo1.xml" --output=$(deviceCppCore) --domain=av.openhome.org --type=RenderingInfo --version=1
$(deviceCppCore)DvAvOpenhomeOrgGroupConfig1.cpp : $(tt) OpenHome/Net/T4/Templates/DvUpnpCppCoreSource.tt OpenHome/Net/T4/Templates/DvUpnpCppCoreHeader.tt OpenHome/Net/Service/Upnp/OpenHome/GroupConfig1.xml
	echo DvAvOpenhomeOrgGroupConfig1.cpp
	$(ohNetGen) --language=cppcore --stack=dv "--xml=OpenHome/Net/Service/Upnp/OpenHome/GroupConfig1.xml" --output=$(deviceCppCore) --domain=av.openhome.org --type=GroupConfig --version=1
$(deviceCppCore)DvAvOpenhomeOrgRoon1.cpp : $(tt) OpenHome/Net/T4/Templates/DvUpnpCppCoreSource.tt OpenHome/Net/T4/Templates/DvUpnpCppCoreHeader.tt OpenHome/Net/Service/Upnp/OpenHome/Roon1.xml
	echo DvAvOpenhomeOrgRoon1.cpp
	$(ohNetGen) --language=cppcore --stack=dv "--xml=OpenHome/Net/Service/Upnp/OpenHome/Roon1.xml" --output=$(deviceCppCore) --domain=av.openhome.org --type=Roon --version=1
$(deviceCppCore)DvAvOpenhomeOrgTidalConnect1.cpp : $(tt) OpenHome/Net/T4/Templates/DvUpnpCppCoreSource.tt OpenHome/Net/T4/Templates/DvUpnpCppCoreHeader.tt OpenHome/Net/Service/Upnp/OpenHome/TidalConnect1.xml
	echo DvAvOpenhomeOrgTidalConnect1.cpp
	$(ohNetGen) --language=cppcore --stack=dv "--xml=OpenHome/Net/Service/Upnp/OpenHome/TidalConnect1.xml" --output=$(deviceCppCore) --domain=av.openhome.org --type=TidalConnect --version=1
$(deviceCppCore)DvAvOpenhomeOrgBluetooth1.cpp : $(tt) OpenHome/Net/T4/Templates/DvUpnpCppCoreSource.tt OpenHome/Net/T4/Templates/DvUpnpCppCoreHeader.tt OpenHome/Net/Service/Upnp/OpenHome/Bluetooth1.xml
	echo DvAvOpenhomeOrgBluetooth1.cpp
	$(ohNetGen) --language=cppcore --stack=dv "--xml=OpenHome/Net/Service/Upnp/OpenHome/Bluetooth1.xml" --output=$(deviceCppCore) --domain=av.openhome.org --type=Bluetooth --version=1
$(deviceCppCore)DvAvOpenhomeOrgAirplay1.cpp : $(tt) OpenHome/Net/T4/Templates/DvUpnpCppCoreSource.tt OpenHome/Net/T4/Templates/DvUpnpCppCoreHeader.tt OpenHome/Net/Service/Upnp/OpenHome/Airplay1.xml
	echo DvAvOpenhomeOrgAirplay1.cpp
	$(ohNetGen) --language=cppcore --stack=dv "--xml=OpenHome/Net/Service/Upnp/OpenHome/Airplay1.xml" --output=$(deviceCppCore) --domain=av.openhome.org --type=Airplay --version=1
$(deviceCppCore)DvAvOpenhomeOrgMusicStation1.cpp : $(tt) OpenHome/Net/T4/Templates/DvUpnpCppCoreSource.tt OpenHome/Net/T4/Templates/DvUpnpCppCoreHeader.tt OpenHome/Net/Service/Upnp/OpenHome/MusicStation1.xml
	echo DvAvOpenhomeOrgMusicStation1.cpp
	$(ohNetGen) --language=cppcore --stack=dv "--xml=OpenHome/Net/Service/Upnp/OpenHome/MusicStation1.xml" --output=$(deviceCppCore) --domain=av.openhome.org --type=MusicStation --version=1
$(deviceCppCore)DvAvOpenhomeOrgSpotify1.cpp : $(tt) OpenHome/Net/T4/Templates/DvUpnpCppCoreSource.tt OpenHome/Net/T4/Templates/DvUpnpCppCoreHeader.tt OpenHome/Net/Service/Upnp/OpenHome/Spotify1.xml
	echo DvAvOpenhomeOrgSpotify1.cpp
	$(ohNetGen) --language=cppcore --stack=dv "--xml=OpenHome/Net/Service/Upnp/OpenHome/Spotify1.xml" --output=$(deviceCppCore) --domain=av.openhome.org --type=Spotify --version=1
$(deviceCppCore)DvAvOpenhomeOrgInternetRadio1.cpp : $(tt) OpenHome/Net/T4/Templates/DvUpnpCppCoreSource.tt OpenHome/Net/T4/Templates/DvUpnpCppCoreHeader.tt OpenHome/Net/Service/Upnp/OpenHome/InternetRadio1.xml
	echo DvAvOpenhomeOrgInternetRadio1.cpp
	$(ohNetGen) --language=cppcore --stack=dv "--xml=OpenHome/Net/Service/Upnp/OpenHome/InternetRadio1.xml" --output=$(deviceCppCore) --domain=av.openhome.org --type=InternetRadio --version=1
$(deviceCppCore)DvAvOpenhomeOrgStreaming1.cpp : $(tt) OpenHome/Net/T4/Templates/DvUpnpCppCoreSource.tt OpenHome/Net/T4/Templates/DvUpnpCppCoreHeader.tt OpenHome/Net/Service/Upnp/OpenHome/Streaming1.xml
	echo DvAvOpenhomeOrgStreaming1.cpp
	$(ohNetGen) --language=cppcore --stack=dv "--xml=OpenHome/Net/Service/Upnp/OpenHome/Streaming1.xml" --output=$(deviceCppCore) --domain=av.openhome.org --type=Streaming --version=1
...
$(deviceCppCore)DvTencentComQPlay1.cpp : $(tt) OpenHome/Net/T4/Templates/DvUpnpCppCoreSource.tt OpenHome/Net/T4/Templates/DvUpnpCppCoreHeader.tt OpenHome/Net/Service/Upnp/Upnp/MediaServer_3/QPlay1.xml
	echo DvTencentComQPlay1.cpp
	$(ohNetGen) --language=cppcore --stack=dv "--xml=OpenHome/Net/Service/Upnp/Upnp/MediaServer_3/QPlay1.xml" --output=$(deviceCppCore) --domain=tencent.com --type=QPlay --version=1

DvCppStd :   $(deviceCppStd)DvUpnpOrgAVTransport1Std.cpp $(deviceCppStd)DvUpnpOrgAVTransport2Std.cpp $(deviceCppStd)DvUpnpOrgConnectionManager1Std.cpp $(deviceCppStd)DvUpnpOrgConnectionManager2Std.cpp $(deviceCppStd)DvUpnpOrgContentDirectory1Std.cpp $(deviceCppStd)DvUpnpOrgContentDirectory2Std.cpp $(deviceCppStd)DvUpnpOrgContentDirectory3Std.cpp $(deviceCppStd)DvUpnpOrgRenderingControl1Std.cpp $(deviceCppStd)DvUpnpOrgRenderingControl2Std.cpp $(deviceCppStd)DvUpnpOrgScheduledRecording1Std.cpp $(deviceCppStd)DvUpnpOrgScheduledRecording2Std.cpp $(deviceCppStd)DvUpnpOrgSwitchPower1Std.cpp $(deviceCppStd)DvUpnpOrgDimming1Std.cpp $(deviceCppStd)DvAvOpenhomeOrgInfo1Std.cpp $(deviceCppStd)DvAvOpenhomeOrgTime1Std.cpp $(deviceCppStd)DvAvOpenhomeOrgPlaylist1Std.cpp $(deviceCppStd)DvAvOpenhomeOrgVolume1Std.cpp $(deviceCppStd)DvAvOpenhomeOrgHardwareConfig1Std.cpp $(deviceCppStd)DvAvOpenhomeOrgTestResamplerConfig1Std.cpp $(deviceCppStd)DvAvOpenhomeOrgWebRendererConfig1Std.cpp $(deviceCppStd)DvAvOpenhomeOrgWebDeviceConfig1Std.cpp $(deviceCppStd)DvAvOpenhomeOrgWebProcessorConfig1Std.cpp $(deviceCppStd)DvAvOpenhomeOrgWebDACConfig1Std.cpp $(deviceCppStd)DvAvOpenhomeOrgWebClockConfig1Std.cpp $(deviceCppStd)DvAvOpenhomeOrgDACConfig1Std.cpp $(deviceCppStd)DvAvOpenhomeOrgCredentials1Std.cpp $(deviceCppStd)DvAvOpenhomeOrgServerConfig1Std.cpp $(deviceCppStd)DvAvOpenhomeOrgMessageCenter1Std.cpp $(deviceCppStd)DvAvOpenhomeOrgRenderingInfo1Std.cpp $(deviceCppStd)DvAvOpenhomeOrgGroupConfig1Std.cpp $(deviceCppStd)DvAvOpenhomeOrgRoon1Std.cpp $(deviceCppStd)DvAvOpenhomeOrgTidalConnect1Std.cpp $(deviceCppStd)DvAvOpenhomeOrgBluetooth1Std.cpp $(deviceCppStd)DvAvOpenhomeOrgAirplay1Std.cpp $(deviceCppStd)DvAvOpenhomeOrgMusicStation1Std.cpp $(deviceCppStd)DvAvOpenhomeOrgSpotify1Std.cpp $(deviceCppStd)DvAvOpenhomeOrgInternetRadio1Std.cpp $(deviceCppStd)DvAvOpenhomeOrgStreaming1Std.cpp $(deviceCppStd)DvAvOpenhomeOrgProduct1Std.cpp $(deviceCppStd)DvAvOpenhomeOrgRadio1Std.cpp $(deviceCppStd)DvAvOpenhomeOrgReceiver1Std.cpp $(deviceCppStd)DvAvOpenhomeOrgSender1Std.cpp $(deviceCppStd)DvAvOpenhomeOrgPlaylistManager1Std.cpp $(deviceCppStd)DvAvOpenhomeOrgMediaServer1Std.cpp $(deviceCppStd)DvAvOpenhomeOrgNetworkMonitor1Std.cpp $(deviceCppStd)DvOpenhomeOrgTestBasic1Std.cpp $(deviceCppStd)DvOpenhomeOrgTestLights1Std.cpp $(deviceCppStd)DvOpenhomeOrgSubscriptionLongPoll1Std.cpp $(deviceCppStd)DvTencentComQPlay1Std.cpp
...
$(deviceCppStd)DvAvOpenhomeOrgHardwareConfig1Std.cpp : $(tt) OpenHome/Net/T4/Templates/DvUpnpCppStdSource.tt OpenHome/Net/T4/Templates/DvUpnpCppStdHeader.tt OpenHome/Net/Service/Upnp/OpenHome/HardwareConfig1.xml
	echo DvAvOpenhomeOrgHardwareConfig1Std.cpp
	$(ohNetGen) --language=cpp --stack=dv "--xml=OpenHome/Net/Service/Upnp/OpenHome/HardwareConfig1.xml" --output=$(deviceCppStd) --domain=av.openhome.org --type=HardwareConfig --version=1
$(deviceCppStd)DvAvOpenhomeOrgTestResamplerConfig1Std.cpp : $(tt) OpenHome/Net/T4/Templates/DvUpnpCppStdSource.tt OpenHome/Net/T4/Templates/DvUpnpCppStdHeader.tt OpenHome/Net/Service/Upnp/OpenHome/TestResamplerConfig1.xml
	echo DvAvOpenhomeOrgTestResamplerConfig1Std.cpp
	$(ohNetGen) --language=cpp --stack=dv "--xml=OpenHome/Net/Service/Upnp/OpenHome/TestResamplerConfig1.xml" --output=$(deviceCppStd) --domain=av.openhome.org --type=TestResamplerConfig --version=1
$(deviceCppStd)DvAvOpenhomeOrgWebRendererConfig1Std.cpp : $(tt) OpenHome/Net/T4/Templates/DvUpnpCppStdSource.tt OpenHome/Net/T4/Templates/DvUpnpCppStdHeader.tt OpenHome/Net/Service/Upnp/OpenHome/WebRendererConfig1.xml
	echo DvAvOpenhomeOrgWebRendererConfig1Std.cpp
	$(ohNetGen) --language=cpp --stack=dv "--xml=OpenHome/Net/Service/Upnp/OpenHome/WebRendererConfig1.xml" --output=$(deviceCppStd) --domain=av.openhome.org --type=WebRendererConfig --version=1
$(deviceCppStd)DvAvOpenhomeOrgWebDeviceConfig1Std.cpp : $(tt) OpenHome/Net/T4/Templates/DvUpnpCppStdSource.tt OpenHome/Net/T4/Templates/DvUpnpCppStdHeader.tt OpenHome/Net/Service/Upnp/OpenHome/WebDeviceConfig1.xml
	echo DvAvOpenhomeOrgWebDeviceConfig1Std.cpp
	$(ohNetGen) --language=cpp --stack=dv "--xml=OpenHome/Net/Service/Upnp/OpenHome/WebDeviceConfig1.xml" --output=$(deviceCppStd) --domain=av.openhome.org --type=WebDeviceConfig --version=1
$(deviceCppStd)DvAvOpenhomeOrgWebProcessorConfig1Std.cpp : $(tt) OpenHome/Net/T4/Templates/DvUpnpCppStdSource.tt OpenHome/Net/T4/Templates/DvUpnpCppStdHeader.tt OpenHome/Net/Service/Upnp/OpenHome/WebProcessorConfig1.xml
	echo DvAvOpenhomeOrgWebProcessorConfig1Std.cpp
	$(ohNetGen) --language=cpp --stack=dv "--xml=OpenHome/Net/Service/Upnp/OpenHome/WebProcessorConfig1.xml" --output=$(deviceCppStd) --domain=av.openhome.org --type=WebProcessorConfig --version=1
$(deviceCppStd)DvAvOpenhomeOrgWebDACConfig1Std.cpp : $(tt) OpenHome/Net/T4/Templates/DvUpnpCppStdSource.tt OpenHome/Net/T4/Templates/DvUpnpCppStdHeader.tt OpenHome/Net/Service/Upnp/OpenHome/WebDACConfig1.xml
	echo DvAvOpenhomeOrgWebDACConfig1Std.cpp
	$(ohNetGen) --language=cpp --stack=dv "--xml=OpenHome/Net/Service/Upnp/OpenHome/WebDACConfig1.xml" --output=$(deviceCppStd) --domain=av.openhome.org --type=WebDACConfig --version=1
$(deviceCppStd)DvAvOpenhomeOrgWebClockConfig1Std.cpp : $(tt) OpenHome/Net/T4/Templates/DvUpnpCppStdSource.tt OpenHome/Net/T4/Templates/DvUpnpCppStdHeader.tt OpenHome/Net/Service/Upnp/OpenHome/WebClockConfig1.xml
	echo DvAvOpenhomeOrgWebClockConfig1Std.cpp
	$(ohNetGen) --language=cpp --stack=dv "--xml=OpenHome/Net/Service/Upnp/OpenHome/WebClockConfig1.xml" --output=$(deviceCppStd) --domain=av.openhome.org --type=WebClockConfig --version=1
$(deviceCppStd)DvAvOpenhomeOrgDACConfig1Std.cpp : $(tt) OpenHome/Net/T4/Templates/DvUpnpCppStdSource.tt OpenHome/Net/T4/Templates/DvUpnpCppStdHeader.tt OpenHome/Net/Service/Upnp/OpenHome/DACConfig1.xml
	echo DvAvOpenhomeOrgDACConfig1Std.cpp
	$(ohNetGen) --language=cpp --stack=dv "--xml=OpenHome/Net/Service/Upnp/OpenHome/DACConfig1.xml" --output=$(deviceCppStd) --domain=av.openhome.org --type=DACConfig --version=1
...
$(deviceCppStd)DvAvOpenhomeOrgServerConfig1Std.cpp : $(tt) OpenHome/Net/T4/Templates/DvUpnpCppStdSource.tt OpenHome/Net/T4/Templates/DvUpnpCppStdHeader.tt OpenHome/Net/Service/Upnp/OpenHome/ServerConfig1.xml
	echo DvAvOpenhomeOrgServerConfig1Std.cpp
	$(ohNetGen) --language=cpp --stack=dv "--xml=OpenHome/Net/Service/Upnp/OpenHome/ServerConfig1.xml" --output=$(deviceCppStd) --domain=av.openhome.org --type=ServerConfig --version=1
$(deviceCppStd)DvAvOpenhomeOrgMessageCenter1Std.cpp : $(tt) OpenHome/Net/T4/Templates/DvUpnpCppStdSource.tt OpenHome/Net/T4/Templates/DvUpnpCppStdHeader.tt OpenHome/Net/Service/Upnp/OpenHome/MessageCenter1.xml
	echo DvAvOpenhomeOrgMessageCenter1Std.cpp
	$(ohNetGen) --language=cpp --stack=dv "--xml=OpenHome/Net/Service/Upnp/OpenHome/MessageCenter1.xml" --output=$(deviceCppStd) --domain=av.openhome.org --type=MessageCenter --version=1
$(deviceCppStd)DvAvOpenhomeOrgRenderingInfo1Std.cpp : $(tt) OpenHome/Net/T4/Templates/DvUpnpCppStdSource.tt OpenHome/Net/T4/Templates/DvUpnpCppStdHeader.tt OpenHome/Net/Service/Upnp/OpenHome/RenderingInfo1.xml
	echo DvAvOpenhomeOrgRenderingInfo1Std.cpp
	$(ohNetGen) --language=cpp --stack=dv "--xml=OpenHome/Net/Service/Upnp/OpenHome/RenderingInfo1.xml" --output=$(deviceCppStd) --domain=av.openhome.org --type=RenderingInfo --version=1
$(deviceCppStd)DvAvOpenhomeOrgGroupConfig1Std.cpp : $(tt) OpenHome/Net/T4/Templates/DvUpnpCppStdSource.tt OpenHome/Net/T4/Templates/DvUpnpCppStdHeader.tt OpenHome/Net/Service/Upnp/OpenHome/GroupConfig1.xml
	echo DvAvOpenhomeOrgGroupConfig1Std.cpp
	$(ohNetGen) --language=cpp --stack=dv "--xml=OpenHome/Net/Service/Upnp/OpenHome/GroupConfig1.xml" --output=$(deviceCppStd) --domain=av.openhome.org --type=GroupConfig --version=1
$(deviceCppStd)DvAvOpenhomeOrgRoon1Std.cpp : $(tt) OpenHome/Net/T4/Templates/DvUpnpCppStdSource.tt OpenHome/Net/T4/Templates/DvUpnpCppStdHeader.tt OpenHome/Net/Service/Upnp/OpenHome/Roon1.xml
	echo DvAvOpenhomeOrgRoon1Std.cpp
	$(ohNetGen) --language=cpp --stack=dv "--xml=OpenHome/Net/Service/Upnp/OpenHome/Roon1.xml" --output=$(deviceCppStd) --domain=av.openhome.org --type=Roon --version=1
$(deviceCppStd)DvAvOpenhomeOrgTidalConnect1Std.cpp : $(tt) OpenHome/Net/T4/Templates/DvUpnpCppStdSource.tt OpenHome/Net/T4/Templates/DvUpnpCppStdHeader.tt OpenHome/Net/Service/Upnp/OpenHome/TidalConnect1.xml
	echo DvAvOpenhomeOrgTidalConnect1Std.cpp
	$(ohNetGen) --language=cpp --stack=dv "--xml=OpenHome/Net/Service/Upnp/OpenHome/TidalConnect1.xml" --output=$(deviceCppStd) --domain=av.openhome.org --type=TidalConnect --version=1
$(deviceCppStd)DvAvOpenhomeOrgBluetooth1Std.cpp : $(tt) OpenHome/Net/T4/Templates/DvUpnpCppStdSource.tt OpenHome/Net/T4/Templates/DvUpnpCppStdHeader.tt OpenHome/Net/Service/Upnp/OpenHome/Bluetooth1.xml
	echo DvAvOpenhomeOrgBluetooth1Std.cpp
	$(ohNetGen) --language=cpp --stack=dv "--xml=OpenHome/Net/Service/Upnp/OpenHome/Bluetooth1.xml" --output=$(deviceCppStd) --domain=av.openhome.org --type=Bluetooth --version=1
$(deviceCppStd)DvAvOpenhomeOrgAirplay1Std.cpp : $(tt) OpenHome/Net/T4/Templates/DvUpnpCppStdSource.tt OpenHome/Net/T4/Templates/DvUpnpCppStdHeader.tt OpenHome/Net/Service/Upnp/OpenHome/Airplay1.xml
	echo DvAvOpenhomeOrgAirplay1Std.cpp
	$(ohNetGen) --language=cpp --stack=dv "--xml=OpenHome/Net/Service/Upnp/OpenHome/Airplay1.xml" --output=$(deviceCppStd) --domain=av.openhome.org --type=Airplay --version=1
$(deviceCppStd)DvAvOpenhomeOrgMusicStation1Std.cpp : $(tt) OpenHome/Net/T4/Templates/DvUpnpCppStdSource.tt OpenHome/Net/T4/Templates/DvUpnpCppStdHeader.tt OpenHome/Net/Service/Upnp/OpenHome/MusicStation1.xml
	echo DvAvOpenhomeOrgMusicStation1Std.cpp
	$(ohNetGen) --language=cpp --stack=dv "--xml=OpenHome/Net/Service/Upnp/OpenHome/MusicStation1.xml" --output=$(deviceCppStd) --domain=av.openhome.org --type=MusicStation --version=1
$(deviceCppStd)DvAvOpenhomeOrgSpotify1Std.cpp : $(tt) OpenHome/Net/T4/Templates/DvUpnpCppStdSource.tt OpenHome/Net/T4/Templates/DvUpnpCppStdHeader.tt OpenHome/Net/Service/Upnp/OpenHome/Spotify1.xml
	echo DvAvOpenhomeOrgSpotify1Std.cpp
	$(ohNetGen) --language=cpp --stack=dv "--xml=OpenHome/Net/Service/Upnp/OpenHome/Spotify1.xml" --output=$(deviceCppStd) --domain=av.openhome.org --type=Spotify --version=1
$(deviceCppStd)DvAvOpenhomeOrgInternetRadio1Std.cpp : $(tt) OpenHome/Net/T4/Templates/DvUpnpCppStdSource.tt OpenHome/Net/T4/Templates/DvUpnpCppStdHeader.tt OpenHome/Net/Service/Upnp/OpenHome/InternetRadio1.xml
	echo DvAvOpenhomeOrgInternetRadio1Std.cpp
	$(ohNetGen) --language=cpp --stack=dv "--xml=OpenHome/Net/Service/Upnp/OpenHome/InternetRadio1.xml" --output=$(deviceCppStd) --domain=av.openhome.org --type=InternetRadio --version=1
$(deviceCppStd)DvAvOpenhomeOrgStreaming1Std.cpp : $(tt) OpenHome/Net/T4/Templates/DvUpnpCppStdSource.tt OpenHome/Net/T4/Templates/DvUpnpCppStdHeader.tt OpenHome/Net/Service/Upnp/OpenHome/Streaming1.xml
	echo DvAvOpenhomeOrgStreaming1Std.cpp
	$(ohNetGen) --language=cpp --stack=dv "--xml=OpenHome/Net/Service/Upnp/OpenHome/Streaming1.xml" --output=$(deviceCppStd) --domain=av.openhome.org --type=Streaming --version=1
...
$(deviceCppStd)DvTencentComQPlay1Std.cpp : $(tt) OpenHome/Net/T4/Templates/DvUpnpCppStdSource.tt OpenHome/Net/T4/Templates/DvUpnpCppStdHeader.tt OpenHome/Net/Service/Upnp/Upnp/MediaServer_3/QPlay1.xml
	echo DvTencentComQPlay1Std.cpp
	$(ohNetGen) --language=cpp --stack=dv "--xml=OpenHome/Net/Service/Upnp/Upnp/MediaServer_3/QPlay1.xml" --output=$(deviceCppStd) --domain=tencent.com --type=QPlay --version=1

DvC :   $(deviceC)DvUpnpOrgAVTransport1C.cpp $(deviceC)DvUpnpOrgAVTransport2C.cpp $(deviceC)DvUpnpOrgConnectionManager1C.cpp $(deviceC)DvUpnpOrgConnectionManager2C.cpp $(deviceC)DvUpnpOrgContentDirectory1C.cpp $(deviceC)DvUpnpOrgContentDirectory2C.cpp $(deviceC)DvUpnpOrgContentDirectory3C.cpp $(deviceC)DvUpnpOrgRenderingControl1C.cpp $(deviceC)DvUpnpOrgRenderingControl2C.cpp $(deviceC)DvUpnpOrgScheduledRecording1C.cpp $(deviceC)DvUpnpOrgScheduledRecording2C.cpp $(deviceC)DvUpnpOrgSwitchPower1C.cpp $(deviceC)DvUpnpOrgDimming1C.cpp $(deviceC)DvAvOpenhomeOrgInfo1C.cpp $(deviceC)DvAvOpenhomeOrgTime1C.cpp $(deviceC)DvAvOpenhomeOrgPlaylist1C.cpp $(deviceC)DvAvOpenhomeOrgVolume1C.cpp $(deviceC)DvAvOpenhomeOrgHardwareConfig1C.cpp $(deviceC)DvAvOpenhomeOrgTestResamplerConfig1C.cpp $(deviceC)DvAvOpenhomeOrgWebRendererConfig1C.cpp $(deviceC)DvAvOpenhomeOrgWebDeviceConfig1C.cpp $(deviceC)DvAvOpenhomeOrgWebProcessorConfig1C.cpp $(deviceC)DvAvOpenhomeOrgWebDACConfig1C.cpp $(deviceC)DvAvOpenhomeOrgWebClockConfig1C.cpp $(deviceC)DvAvOpenhomeOrgDACConfig1C.cpp $(deviceC)DvAvOpenhomeOrgCredentials1C.cpp $(deviceC)DvAvOpenhomeOrgServerConfig1C.cpp $(deviceC)DvAvOpenhomeOrgMessageCenter1C.cpp $(deviceC)DvAvOpenhomeOrgRenderingInfo1C.cpp $(deviceC)DvAvOpenhomeOrgGroupConfig1C.cpp $(deviceC)DvAvOpenhomeOrgRoon1C.cpp $(deviceC)DvAvOpenhomeOrgTidalConnect1C.cpp $(deviceC)DvAvOpenhomeOrgBluetooth1C.cpp $(deviceC)DvAvOpenhomeOrgAirplay1C.cpp $(deviceC)DvAvOpenhomeOrgMusicStation1C.cpp $(deviceC)DvAvOpenhomeOrgSpotify1C.cpp $(deviceC)DvAvOpenhomeOrgInternetRadio1C.cpp $(deviceC)DvAvOpenhomeOrgStreaming1C.cpp $(deviceC)DvAvOpenhomeOrgProduct1C.cpp $(deviceC)DvAvOpenhomeOrgRadio1C.cpp $(deviceC)DvAvOpenhomeOrgReceiver1C.cpp $(deviceC)DvAvOpenhomeOrgSender1C.cpp $(deviceC)DvAvOpenhomeOrgPlaylistManager1C.cpp $(deviceC)DvAvOpenhomeOrgMediaServer1C.cpp $(deviceC)DvAvOpenhomeOrgNetworkMonitor1C.cpp $(deviceC)DvOpenhomeOrgTestBasic1C.cpp $(deviceC)DvOpenhomeOrgTestLights1C.cpp $(deviceC)DvOpenhomeOrgSubscriptionLongPoll1C.cpp $(deviceC)DvTencentComQPlay1C.cpp
...
$(deviceC)DvAvOpenhomeOrgHardwareConfig1C.cpp : $(tt) OpenHome/Net/T4/Templates/DvUpnpCSource.tt OpenHome/Net/T4/Templates/DvUpnpCHeader.tt OpenHome/Net/Service/Upnp/OpenHome/HardwareConfig1.xml
	echo DvAvOpenhomeOrgHardwareConfig1C.cpp
	$(ohNetGen) --language=c --stack=dv "--xml=OpenHome/Net/Service/Upnp/OpenHome/HardwareConfig1.xml" --output=$(deviceC) --domain=av.openhome.org --type=HardwareConfig --version=1
$(deviceC)DvAvOpenhomeOrgTestResamplerConfig1C.cpp : $(tt) OpenHome/Net/T4/Templates/DvUpnpCSource.tt OpenHome/Net/T4/Templates/DvUpnpCHeader.tt OpenHome/Net/Service/Upnp/OpenHome/TestResamplerConfig1.xml
	echo DvAvOpenhomeOrgTestResamplerConfig1C.cpp
	$(ohNetGen) --language=c --stack=dv "--xml=OpenHome/Net/Service/Upnp/OpenHome/TestResamplerConfig1.xml" --output=$(deviceC) --domain=av.openhome.org --type=TestResamplerConfig --version=1
$(deviceC)DvAvOpenhomeOrgWebRendererConfig1C.cpp : $(tt) OpenHome/Net/T4/Templates/DvUpnpCSource.tt OpenHome/Net/T4/Templates/DvUpnpCHeader.tt OpenHome/Net/Service/Upnp/OpenHome/WebRendererConfig1.xml
	echo DvAvOpenhomeOrgWebRendererConfig1C.cpp
	$(ohNetGen) --language=c --stack=dv "--xml=OpenHome/Net/Service/Upnp/OpenHome/WebRendererConfig1.xml" --output=$(deviceC) --domain=av.openhome.org --type=WebRendererConfig --version=1
$(deviceC)DvAvOpenhomeOrgWebDeviceConfig1C.cpp : $(tt) OpenHome/Net/T4/Templates/DvUpnpCSource.tt OpenHome/Net/T4/Templates/DvUpnpCHeader.tt OpenHome/Net/Service/Upnp/OpenHome/WebDeviceConfig1.xml
	echo DvAvOpenhomeOrgWebDeviceConfig1C.cpp
	$(ohNetGen) --language=c --stack=dv "--xml=OpenHome/Net/Service/Upnp/OpenHome/WebDeviceConfig1.xml" --output=$(deviceC) --domain=av.openhome.org --type=WebDeviceConfig --version=1
$(deviceC)DvAvOpenhomeOrgWebProcessorConfig1C.cpp : $(tt) OpenHome/Net/T4/Templates/DvUpnpCSource.tt OpenHome/Net/T4/Templates/DvUpnpCHeader.tt OpenHome/Net/Service/Upnp/OpenHome/WebProcessorConfig1.xml
	echo DvAvOpenhomeOrgWebProcessorConfig1C.cpp
	$(ohNetGen) --language=c --stack=dv "--xml=OpenHome/Net/Service/Upnp/OpenHome/WebProcessorConfig1.xml" --output=$(deviceC) --domain=av.openhome.org --type=WebProcessorConfig --version=1
$(deviceC)DvAvOpenhomeOrgWebDACConfig1C.cpp : $(tt) OpenHome/Net/T4/Templates/DvUpnpCSource.tt OpenHome/Net/T4/Templates/DvUpnpCHeader.tt OpenHome/Net/Service/Upnp/OpenHome/WebDACConfig1.xml
	echo DvAvOpenhomeOrgWebDACConfig1C.cpp
	$(ohNetGen) --language=c --stack=dv "--xml=OpenHome/Net/Service/Upnp/OpenHome/WebDACConfig1.xml" --output=$(deviceC) --domain=av.openhome.org --type=WebDACConfig --version=1
$(deviceC)DvAvOpenhomeOrgWebClockConfig1C.cpp : $(tt) OpenHome/Net/T4/Templates/DvUpnpCSource.tt OpenHome/Net/T4/Templates/DvUpnpCHeader.tt OpenHome/Net/Service/Upnp/OpenHome/WebClockConfig1.xml
	echo DvAvOpenhomeOrgWebClockConfig1C.cpp
	$(ohNetGen) --language=c --stack=dv "--xml=OpenHome/Net/Service/Upnp/OpenHome/WebClockConfig1.xml" --output=$(deviceC) --domain=av.openhome.org --type=WebClockConfig --version=1
$(deviceC)DvAvOpenhomeOrgDACConfig1C.cpp : $(tt) OpenHome/Net/T4/Templates/DvUpnpCSource.tt OpenHome/Net/T4/Templates/DvUpnpCHeader.tt OpenHome/Net/Service/Upnp/OpenHome/DACConfig1.xml
	echo DvAvOpenhomeOrgDACConfig1C.cpp
	$(ohNetGen) --language=c --stack=dv "--xml=OpenHome/Net/Service/Upnp/OpenHome/DACConfig1.xml" --output=$(deviceC) --domain=av.openhome.org --type=DACConfig --version=1
...
$(deviceC)DvAvOpenhomeOrgServerConfig1C.cpp : $(tt) OpenHome/Net/T4/Templates/DvUpnpCSource.tt OpenHome/Net/T4/Templates/DvUpnpCHeader.tt OpenHome/Net/Service/Upnp/OpenHome/ServerConfig1.xml
	echo DvAvOpenhomeOrgServerConfig1C.cpp
	$(ohNetGen) --language=c --stack=dv "--xml=OpenHome/Net/Service/Upnp/OpenHome/ServerConfig1.xml" --output=$(deviceC) --domain=av.openhome.org --type=ServerConfig --version=1
$(deviceC)DvAvOpenhomeOrgMessageCenter1C.cpp : $(tt) OpenHome/Net/T4/Templates/DvUpnpCSource.tt OpenHome/Net/T4/Templates/DvUpnpCHeader.tt OpenHome/Net/Service/Upnp/OpenHome/MessageCenter1.xml
	echo DvAvOpenhomeOrgMessageCenter1C.cpp
	$(ohNetGen) --language=c --stack=dv "--xml=OpenHome/Net/Service/Upnp/OpenHome/MessageCenter1.xml" --output=$(deviceC) --domain=av.openhome.org --type=MessageCenter --version=1
$(deviceC)DvAvOpenhomeOrgRenderingInfo1C.cpp : $(tt) OpenHome/Net/T4/Templates/DvUpnpCSource.tt OpenHome/Net/T4/Templates/DvUpnpCHeader.tt OpenHome/Net/Service/Upnp/OpenHome/RenderingInfo1.xml
	echo DvAvOpenhomeOrgRenderingInfo1C.cpp
	$(ohNetGen) --language=c --stack=dv "--xml=OpenHome/Net/Service/Upnp/OpenHome/RenderingInfo1.xml" --output=$(deviceC) --domain=av.openhome.org --type=RenderingInfo --version=1
$(deviceC)DvAvOpenhomeOrgGroupConfig1C.cpp : $(tt) OpenHome/Net/T4/Templates/DvUpnpCSource.tt OpenHome/Net/T4/Templates/DvUpnpCHeader.tt OpenHome/Net/Service/Upnp/OpenHome/GroupConfig1.xml
	echo DvAvOpenhomeOrgGroupConfig1C.cpp
	$(ohNetGen) --language=c --stack=dv "--xml=OpenHome/Net/Service/Upnp/OpenHome/GroupConfig1.xml" --output=$(deviceC) --domain=av.openhome.org --type=GroupConfig --version=1
$(deviceC)DvAvOpenhomeOrgRoon1C.cpp : $(tt) OpenHome/Net/T4/Templates/DvUpnpCSource.tt OpenHome/Net/T4/Templates/DvUpnpCHeader.tt OpenHome/Net/Service/Upnp/OpenHome/Roon1.xml
	echo DvAvOpenhomeOrgRoon1C.cpp
	$(ohNetGen) --language=c --stack=dv "--xml=OpenHome/Net/Service/Upnp/OpenHome/Roon1.xml" --output=$(deviceC) --domain=av.openhome.org --type=Roon --version=1
$(deviceC)DvAvOpenhomeOrgTidalConnect1C.cpp : $(tt) OpenHome/Net/T4/Templates/DvUpnpCSource.tt OpenHome/Net/T4/Templates/DvUpnpCHeader.tt OpenHome/Net/Service/Upnp/OpenHome/TidalConnect1.xml
	echo DvAvOpenhomeOrgTidalConnect1C.cpp
	$(ohNetGen) --language=c --stack=dv "--xml=OpenHome/Net/Service/Upnp/OpenHome/TidalConnect1.xml" --output=$(deviceC) --domain=av.openhome.org --type=TidalConnect --version=1
$(deviceC)DvAvOpenhomeOrgBluetooth1C.cpp : $(tt) OpenHome/Net/T4/Templates/DvUpnpCSource.tt OpenHome/Net/T4/Templates/DvUpnpCHeader.tt OpenHome/Net/Service/Upnp/OpenHome/Bluetooth1.xml
	echo DvAvOpenhomeOrgBluetooth1C.cpp
	$(ohNetGen) --language=c --stack=dv "--xml=OpenHome/Net/Service/Upnp/OpenHome/Bluetooth1.xml" --output=$(deviceC) --domain=av.openhome.org --type=Bluetooth --version=1
$(deviceC)DvAvOpenhomeOrgAirplay1C.cpp : $(tt) OpenHome/Net/T4/Templates/DvUpnpCSource.tt OpenHome/Net/T4/Templates/DvUpnpCHeader.tt OpenHome/Net/Service/Upnp/OpenHome/Airplay1.xml
	echo DvAvOpenhomeOrgAirplay1C.cpp
	$(ohNetGen) --language=c --stack=dv "--xml=OpenHome/Net/Service/Upnp/OpenHome/Airplay1.xml" --output=$(deviceC) --domain=av.openhome.org --type=Airplay --version=1
$(deviceC)DvAvOpenhomeOrgMusicStation1C.cpp : $(tt) OpenHome/Net/T4/Templates/DvUpnpCSource.tt OpenHome/Net/T4/Templates/DvUpnpCHeader.tt OpenHome/Net/Service/Upnp/OpenHome/MusicStation1.xml
	echo DvAvOpenhomeOrgMusicStation1C.cpp
	$(ohNetGen) --language=c --stack=dv "--xml=OpenHome/Net/Service/Upnp/OpenHome/MusicStation1.xml" --output=$(deviceC) --domain=av.openhome.org --type=MusicStation --version=1
$(deviceC)DvAvOpenhomeOrgSpotify1C.cpp : $(tt) OpenHome/Net/T4/Templates/DvUpnpCSource.tt OpenHome/Net/T4/Templates/DvUpnpCHeader.tt OpenHome/Net/Service/Upnp/OpenHome/Spotify1.xml
	echo DvAvOpenhomeOrgSpotify1C.cpp
	$(ohNetGen) --language=c --stack=dv "--xml=OpenHome/Net/Service/Upnp/OpenHome/Spotify1.xml" --output=$(deviceC) --domain=av.openhome.org --type=Spotify --version=1
$(deviceC)DvAvOpenhomeOrgInternetRadio1C.cpp : $(tt) OpenHome/Net/T4/Templates/DvUpnpCSource.tt OpenHome/Net/T4/Templates/DvUpnpCHeader.tt OpenHome/Net/Service/Upnp/OpenHome/InternetRadio1.xml
	echo DvAvOpenhomeOrgInternetRadio1C.cpp
	$(ohNetGen) --language=c --stack=dv "--xml=OpenHome/Net/Service/Upnp/OpenHome/InternetRadio1.xml" --output=$(deviceC) --domain=av.openhome.org --type=InternetRadio --version=1
$(deviceC)DvAvOpenhomeOrgStreaming1C.cpp : $(tt) OpenHome/Net/T4/Templates/DvUpnpCSource.tt OpenHome/Net/T4/Templates/DvUpnpCHeader.tt OpenHome/Net/Service/Upnp/OpenHome/Streaming1.xml
	echo DvAvOpenhomeOrgStreaming1C.cpp
	$(ohNetGen) --language=c --stack=dv "--xml=OpenHome/Net/Service/Upnp/OpenHome/Streaming1.xml" --output=$(deviceC) --domain=av.openhome.org --type=Streaming --version=1
...
$(deviceC)DvTencentComQPlay1C.cpp : $(tt) OpenHome/Net/T4/Templates/DvUpnpCSource.tt OpenHome/Net/T4/Templates/DvUpnpCHeader.tt OpenHome/Net/Service/Upnp/Upnp/MediaServer_3/QPlay1.xml
	echo DvTencentComQPlay1C.cpp
	$(ohNetGen) --language=c --stack=dv "--xml=OpenHome/Net/Service/Upnp/Upnp/MediaServer_3/QPlay1.xml" --output=$(deviceC) --domain=tencent.com --type=QPlay --version=1

DvCs:   $(deviceCs)DvUpnpOrgAVTransport1.cs $(deviceCs)DvUpnpOrgAVTransport2.cs $(deviceCs)DvUpnpOrgConnectionManager1.cs $(deviceCs)DvUpnpOrgConnectionManager2.cs $(deviceCs)DvUpnpOrgContentDirectory1.cs $(deviceCs)DvUpnpOrgContentDirectory2.cs $(deviceCs)DvUpnpOrgContentDirectory3.cs $(deviceCs)DvUpnpOrgRenderingControl1.cs $(deviceCs)DvUpnpOrgRenderingControl2.cs $(deviceCs)DvUpnpOrgScheduledRecording1.cs $(deviceCs)DvUpnpOrgScheduledRecording2.cs $(deviceCs)DvUpnpOrgSwitchPower1.cs $(deviceCs)DvUpnpOrgDimming1.cs $(deviceCs)DvAvOpenhomeOrgInfo1.cs $(deviceCs)DvAvOpenhomeOrgTime1.cs $(deviceCs)DvAvOpenhomeOrgPlaylist1.cs $(deviceCs)DvAvOpenhomeOrgVolume1.cs $(deviceCs)DvAvOpenhomeOrgHardwareConfig1.cs $(deviceCs)DvAvOpenhomeOrgTestResamplerConfig1.cs $(deviceCs)DvAvOpenhomeOrgWebRendererConfig1.cs $(deviceCs)DvAvOpenhomeOrgWebDeviceConfig1.cs $(deviceCs)DvAvOpenhomeOrgWebProcessorConfig1.cs $(deviceCs)DvAvOpenhomeOrgWebDACConfig1.cs $(deviceCs)DvAvOpenhomeOrgWebClockConfig1.cs $(deviceCs)DvAvOpenhomeOrgDACConfig1.cs $(deviceCs)DvAvOpenhomeOrgCredentials1.cs $(deviceCs)DvAvOpenhomeOrgServerConfig1.cs $(deviceCs)DvAvOpenhomeOrgMessageCenter1.cs $(deviceCs)DvAvOpenhomeOrgRenderingInfo1.cs $(deviceCs)DvAvOpenhomeOrgGroupConfig1.cs $(deviceCs)DvAvOpenhomeOrgRoon1.cs $(deviceCs)DvAvOpenhomeOrgTidalConnect1.cs $(deviceCs)DvAvOpenhomeOrgBluetooth1.cs $(deviceCs)DvAvOpenhomeOrgAirplay1.cs $(deviceCs)DvAvOpenhomeOrgMusicStation1.cs $(deviceCs)DvAvOpenhomeOrgSpotify1.cs $(deviceCs)DvAvOpenhomeOrgInternetRadio1.cs $(deviceCs)DvAvOpenhomeOrgStreaming1.cs $(deviceCs)DvAvOpenhomeOrgProduct1.cs $(deviceCs)DvAvOpenhomeOrgRadio1.cs $(deviceCs)DvAvOpenhomeOrgReceiver1.cs $(deviceCs)DvAvOpenhomeOrgSender1.cs $(deviceCs)DvAvOpenhomeOrgPlaylistManager1.cs $(deviceCs)DvAvOpenhomeOrgMediaServer1.cs $(deviceCs)DvAvOpenhomeOrgNetworkMonitor1.cs $(deviceCs)DvOpenhomeOrgTestBasic1.cs $(deviceCs)DvOpenhomeOrgTestLights1.cs $(deviceCs)DvOpenhomeOrgSubscriptionLongPoll1.cs $(deviceCs)DvTencentComQPlay1.cs
...
$(deviceCs)DvAvOpenhomeOrgHardwareConfig1.cs : $(tt) OpenHome/Net/T4/Templates/DvUpnpCs.tt OpenHome/Net/Service/Upnp/OpenHome/HardwareConfig1.xml
	echo DvAvOpenhomeOrgHardwareConfig1.cs
	$(ohNetGen) --language=cs --stack=dv "--xml=OpenHome/Net/Service/Upnp/OpenHome/HardwareConfig1.xml" --output=$(deviceCs) --domain=av.openhome.org --type=HardwareConfig --version=1
$(deviceCs)DvAvOpenhomeOrgTestResamplerConfig1.cs : $(tt) OpenHome/Net/T4/Templates/DvUpnpCs.tt OpenHome/Net/Service/Upnp/OpenHome/TestResamplerConfig1.xml
	echo DvAvOpenhomeOrgTestResamplerConfig1.cs
	$(ohNetGen) --language=cs --stack=dv "--xml=OpenHome/Net/Service/Upnp/OpenHome/TestResamplerConfig1.xml" --output=$(deviceCs) --domain=av.openhome.org --type=TestResamplerConfig --version=1
$(deviceCs)DvAvOpenhomeOrgWebRendererConfig1.cs : $(tt) OpenHome/Net/T4/Templates/DvUpnpCs.tt OpenHome/Net/Service/Upnp/OpenHome/WebRendererConfig1.xml
	echo DvAvOpenhomeOrgWebRendererConfig1.cs
	$(ohNetGen) --language=cs --stack=dv "--xml=OpenHome/Net/Service/Upnp/OpenHome/WebRendererConfig1.xml" --output=$(deviceCs) --domain=av.openhome.org --type=WebRendererConfig --version=1
$(deviceCs)DvAvOpenhomeOrgWebDeviceConfig1.cs : $(tt) OpenHome/Net/T4/Templates/DvUpnpCs.tt OpenHome/Net/Service/Upnp/OpenHome/WebDeviceConfig1.xml
	echo DvAvOpenhomeOrgWebDeviceConfig1.cs
	$(ohNetGen) --language=cs --stack=dv "--xml=OpenHome/Net/Service/Upnp/OpenHome/WebDeviceConfig1.xml" --output=$(deviceCs) --domain=av.openhome.org --type=WebDeviceConfig --version=1
$(deviceCs)DvAvOpenhomeOrgWebProcessorConfig1.cs : $(tt) OpenHome/Net/T4/Templates/DvUpnpCs.tt OpenHome/Net/Service/Upnp/OpenHome/WebProcessorConfig1.xml
	echo DvAvOpenhomeOrgWebProcessorConfig1.cs
	$(ohNetGen) --language=cs --stack=dv "--xml=OpenHome/Net/Service/Upnp/OpenHome/WebProcessorConfig1.xml" --output=$(deviceCs) --domain=av.openhome.org --type=WebProcessorConfig --version=1
$(deviceCs)DvAvOpenhomeOrgWebDACConfig1.cs : $(tt) OpenHome/Net/T4/Templates/DvUpnpCs.tt OpenHome/Net/Service/Upnp/OpenHome/WebDACConfig1.xml
	echo DvAvOpenhomeOrgWebDACConfig1.cs
	$(ohNetGen) --language=cs --stack=dv "--xml=OpenHome/Net/Service/Upnp/OpenHome/WebDACConfig1.xml" --output=$(deviceCs) --domain=av.openhome.org --type=WebDACConfig --version=1
$(deviceCs)DvAvOpenhomeOrgWebClockConfig1.cs : $(tt) OpenHome/Net/T4/Templates/DvUpnpCs.tt OpenHome/Net/Service/Upnp/OpenHome/WebClockConfig1.xml
	echo DvAvOpenhomeOrgWebClockConfig1.cs
	$(ohNetGen) --language=cs --stack=dv "--xml=OpenHome/Net/Service/Upnp/OpenHome/WebClockConfig1.xml" --output=$(deviceCs) --domain=av.openhome.org --type=WebClockConfig --version=1
$(deviceCs)DvAvOpenhomeOrgDACConfig1.cs : $(tt) OpenHome/Net/T4/Templates/DvUpnpCs.tt OpenHome/Net/Service/Upnp/OpenHome/DACConfig1.xml
	echo DvAvOpenhomeOrgDACConfig1.cs
	$(ohNetGen) --language=cs --stack=dv "--xml=OpenHome/Net/Service/Upnp/OpenHome/DACConfig1.xml" --output=$(deviceCs) --domain=av.openhome.org --type=DACConfig --version=1
...
$(deviceCs)DvAvOpenhomeOrgServerConfig1.cs : $(tt) OpenHome/Net/T4/Templates/DvUpnpCs.tt OpenHome/Net/Service/Upnp/OpenHome/ServerConfig1.xml
	echo DvAvOpenhomeOrgServerConfig1.cs
	$(ohNetGen) --language=cs --stack=dv "--xml=OpenHome/Net/Service/Upnp/OpenHome/ServerConfig1.xml" --output=$(deviceCs) --domain=av.openhome.org --type=ServerConfig --version=1
$(deviceCs)DvAvOpenhomeOrgMessageCenter1.cs : $(tt) OpenHome/Net/T4/Templates/DvUpnpCs.tt OpenHome/Net/Service/Upnp/OpenHome/MessageCenter1.xml
	echo DvAvOpenhomeOrgMessageCenter1.cs
	$(ohNetGen) --language=cs --stack=dv "--xml=OpenHome/Net/Service/Upnp/OpenHome/MessageCenter1.xml" --output=$(deviceCs) --domain=av.openhome.org --type=MessageCenter --version=1
$(deviceCs)DvAvOpenhomeOrgRenderingInfo1.cs : $(tt) OpenHome/Net/T4/Templates/DvUpnpCs.tt OpenHome/Net/Service/Upnp/OpenHome/RenderingInfo1.xml
	echo DvAvOpenhomeOrgRenderingInfo1.cs
	$(ohNetGen) --language=cs --stack=dv "--xml=OpenHome/Net/Service/Upnp/OpenHome/RenderingInfo1.xml" --output=$(deviceCs) --domain=av.openhome.org --type=RenderingInfo --version=1
$(deviceCs)DvAvOpenhomeOrgGroupConfig1.cs : $(tt) OpenHome/Net/T4/Templates/DvUpnpCs.tt OpenHome/Net/Service/Upnp/OpenHome/GroupConfig1.xml
	echo DvAvOpenhomeOrgGroupConfig1.cs
	$(ohNetGen) --language=cs --stack=dv "--xml=OpenHome/Net/Service/Upnp/OpenHome/GroupConfig1.xml" --output=$(deviceCs) --domain=av.openhome.org --type=GroupConfig --version=1
$(deviceCs)DvAvOpenhomeOrgRoon1.cs : $(tt) OpenHome/Net/T4/Templates/DvUpnpCs.tt OpenHome/Net/Service/Upnp/OpenHome/Roon1.xml
	echo DvAvOpenhomeOrgRoon1.cs
	$(ohNetGen) --language=cs --stack=dv "--xml=OpenHome/Net/Service/Upnp/OpenHome/Roon1.xml" --output=$(deviceCs) --domain=av.openhome.org --type=Roon --version=1
$(deviceCs)DvAvOpenhomeOrgTidalConnect1.cs : $(tt) OpenHome/Net/T4/Templates/DvUpnpCs.tt OpenHome/Net/Service/Upnp/OpenHome/TidalConnect1.xml
	echo DvAvOpenhomeOrgTidalConnect1.cs
	$(ohNetGen) --language=cs --stack=dv "--xml=OpenHome/Net/Service/Upnp/OpenHome/TidalConnect1.xml" --output=$(deviceCs) --domain=av.openhome.org --type=TidalConnect --version=1
$(deviceCs)DvAvOpenhomeOrgBluetooth1.cs : $(tt) OpenHome/Net/T4/Templates/DvUpnpCs.tt OpenHome/Net/Service/Upnp/OpenHome/Bluetooth1.xml
	echo DvAvOpenhomeOrgBluetooth1.cs
	$(ohNetGen) --language=cs --stack=dv "--xml=OpenHome/Net/Service/Upnp/OpenHome/Bluetooth1.xml" --output=$(deviceCs) --domain=av.openhome.org --type=Bluetooth --version=1
$(deviceCs)DvAvOpenhomeOrgAirplay1.cs : $(tt) OpenHome/Net/T4/Templates/DvUpnpCs.tt OpenHome/Net/Service/Upnp/OpenHome/Airplay1.xml
	echo DvAvOpenhomeOrgAirplay1.cs
	$(ohNetGen) --language=cs --stack=dv "--xml=OpenHome/Net/Service/Upnp/OpenHome/Airplay1.xml" --output=$(deviceCs) --domain=av.openhome.org --type=Airplay --version=1
$(deviceCs)DvAvOpenhomeOrgMusicStation1.cs : $(tt) OpenHome/Net/T4/Templates/DvUpnpCs.tt OpenHome/Net/Service/Upnp/OpenHome/MusicStation1.xml
	echo DvAvOpenhomeOrgMusicStation1.cs
	$(ohNetGen) --language=cs --stack=dv "--xml=OpenHome/Net/Service/Upnp/OpenHome/MusicStation1.xml" --output=$(deviceCs) --domain=av.openhome.org --type=MusicStation --version=1
$(deviceCs)DvAvOpenhomeOrgSpotify1.cs : $(tt) OpenHome/Net/T4/Templates/DvUpnpCs.tt OpenHome/Net/Service/Upnp/OpenHome/Spotify1.xml
	echo DvAvOpenhomeOrgSpotify1.cs
	$(ohNetGen) --language=cs --stack=dv "--xml=OpenHome/Net/Service/Upnp/OpenHome/Spotify1.xml" --output=$(deviceCs) --domain=av.openhome.org --type=Spotify --version=1
$(deviceCs)DvAvOpenhomeOrgInternetRadio1.cs : $(tt) OpenHome/Net/T4/Templates/DvUpnpCs.tt OpenHome/Net/Service/Upnp/OpenHome/InternetRadio1.xml
	echo DvAvOpenhomeOrgInternetRadio1.cs
	$(ohNetGen) --language=cs --stack=dv "--xml=OpenHome/Net/Service/Upnp/OpenHome/InternetRadio1.xml" --output=$(deviceCs) --domain=av.openhome.org --type=InternetRadio --version=1
$(deviceCs)DvAvOpenhomeOrgStreaming1.cs : $(tt) OpenHome/Net/T4/Templates/DvUpnpCs.tt OpenHome/Net/Service/Upnp/OpenHome/Streaming1.xml
	echo DvAvOpenhomeOrgStreaming1.cs
	$(ohNetGen) --language=cs --stack=dv "--xml=OpenHome/Net/Service/Upnp/OpenHome/Streaming1.xml" --output=$(deviceCs) --domain=av.openhome.org --type=Streaming --version=1
...
$(deviceCs)DvTencentComQPlay1.cs : $(tt) OpenHome/Net/T4/Templates/DvUpnpCs.tt OpenHome/Net/Service/Upnp/Upnp/MediaServer_3/QPlay1.xml
	echo DvTencentComQPlay1.cs
	$(ohNetGen) --language=cs --stack=dv "--xml=OpenHome/Net/Service/Upnp/Upnp/MediaServer_3/QPlay1.xml" --output=$(deviceCs) --domain=tencent.com --type=QPlay --version=1

DvJava:   $(deviceJava)DvProviderUpnpOrgAVTransport1.java $(deviceJava)DvProviderUpnpOrgAVTransport2.java $(deviceJava)DvProviderUpnpOrgConnectionManager1.java $(deviceJava)DvProviderUpnpOrgConnectionManager2.java $(deviceJava)DvProviderUpnpOrgContentDirectory1.java $(deviceJava)DvProviderUpnpOrgContentDirectory2.java $(deviceJava)DvProviderUpnpOrgContentDirectory3.java $(deviceJava)DvProviderUpnpOrgRenderingControl1.java $(deviceJava)DvProviderUpnpOrgRenderingControl2.java $(deviceJava)DvProviderUpnpOrgScheduledRecording1.java $(deviceJava)DvProviderUpnpOrgScheduledRecording2.java $(deviceJava)DvProviderUpnpOrgSwitchPower1.java $(deviceJava)DvProviderUpnpOrgDimming1.java $(deviceJava)DvProviderAvOpenhomeOrgInfo1.java $(deviceJava)DvProviderAvOpenhomeOrgTime1.java $(deviceJava)DvProviderAvOpenhomeOrgPlaylist1.java $(deviceJava)DvProviderAvOpenhomeOrgVolume1.java $(deviceJava)DvProviderAvOpenhomeOrgHardwareConfig1.java $(deviceJava)DvProviderAvOpenhomeOrgTestResamplerConfig1.java $(deviceJava)DvProviderAvOpenhomeOrgWebRendererConfig1.java $(deviceJava)DvProviderAvOpenhomeOrgWebDeviceConfig1.java $(deviceJava)DvProviderAvOpenhomeOrgWebProcessorConfig1.java $(deviceJava)DvProviderAvOpenhomeOrgWebDACConfig1.java $(deviceJava)DvProviderAvOpenhomeOrgWebClockConfig1.java $(deviceJava)DvProviderAvOpenhomeOrgDACConfig1.java $(deviceJava)DvProviderAvOpenhomeOrgCredentials1.java $(deviceJava)DvProviderAvOpenhomeOrgServerConfig1.java $(deviceJava)DvProviderAvOpenhomeOrgMessageCenter1.java $(deviceJava)DvProviderAvOpenhomeOrgRenderingInfo1.java $(deviceJava)DvProviderAvOpenhomeOrgGroupConfig1.java $(deviceJava)DvProviderAvOpenhomeOrgRoon1.java $(deviceJava)DvProviderAvOpenhomeOrgTidalConnect1.java $(deviceJava)DvProviderAvOpenhomeOrgBluetooth1.java $(deviceJava)DvProviderAvOpenhomeOrgAirplay1.java $(deviceJava)DvProviderAvOpenhomeOrgMusicStation1.java $(deviceJava)DvProviderAvOpenhomeOrgSpotify1.java $(deviceJava)DvProviderAvOpenhomeOrgInternetRadio1.java $(deviceJava)DvProviderAvOpenhomeOrgStreaming1.java $(deviceJava)DvProviderAvOpenhomeOrgProduct1.java $(deviceJava)DvProviderAvOpenhomeOrgRadio1.java $(deviceJava)DvProviderAvOpenhomeOrgReceiver1.java $(deviceJava)DvProviderAvOpenhomeOrgSender1.java $(deviceJava)DvProviderAvOpenhomeOrgPlaylistManager1.java $(deviceJava)DvProviderAvOpenhomeOrgMediaServer1.java $(deviceJava)DvProviderAvOpenhomeOrgNetworkMonitor1.java $(deviceJava)DvProviderOpenhomeOrgTestBasic1.java $(deviceJava)DvProviderOpenhomeOrgTestLights1.java $(deviceJava)DvProviderOpenhomeOrgSubscriptionLongPoll1.java $(deviceJava)DvProviderTencentComQPlay1.java
...
$(deviceJava)DvProviderAvOpenhomeOrgHardwareConfig1.java : $(tt) OpenHome/Net/T4/Templates/DvUpnpJava.tt OpenHome/Net/Service/Upnp/OpenHome/HardwareConfig1.xml
	echo DvProviderAvOpenhomeOrgHardwareConfig1.java
	$(ohNetGen) --language=java --stack=dv "--xml=OpenHome/Net/Service/Upnp/OpenHome/HardwareConfig1.xml" --output=$(deviceJava) --domain=av.openhome.org --type=HardwareConfig --version=1
$(deviceJava)DvProviderAvOpenhomeOrgTestResamplerConfig1.java : $(tt) OpenHome/Net/T4/Templates/DvUpnpJava.tt OpenHome/Net/Service/Upnp/OpenHome/TestResamplerConfig1.xml
	echo DvProviderAvOpenhomeOrgTestResamplerConfig1.java
	$(ohNetGen) --language=java --stack=dv "--xml=OpenHome/Net/Service/Upnp/OpenHome/TestResamplerConfig1.xml" --output=$(deviceJava) --domain=av.openhome.org --type=TestResamplerConfig --version=1
$(deviceJava)DvProviderAvOpenhomeOrgWebRendererConfig1.java : $(tt) OpenHome/Net/T4/Templates/DvUpnpJava.tt OpenHome/Net/Service/Upnp/OpenHome/WebRendererConfig1.xml
	echo DvProviderAvOpenhomeOrgWebRendererConfig1.java
	$(ohNetGen) --language=java --stack=dv "--xml=OpenHome/Net/Service/Upnp/OpenHome/WebRendererConfig1.xml" --output=$(deviceJava) --domain=av.openhome.org --type=WebRendererConfig --version=1
$(deviceJava)DvProviderAvOpenhomeOrgWebDeviceConfig1.java : $(tt) OpenHome/Net/T4/Templates/DvUpnpJava.tt OpenHome/Net/Service/Upnp/OpenHome/WebDeviceConfig1.xml
	echo DvProviderAvOpenhomeOrgWebDeviceConfig1.java
	$(ohNetGen) --language=java --stack=dv "--xml=OpenHome/Net/Service/Upnp/OpenHome/WebDeviceConfig1.xml" --output=$(deviceJava) --domain=av.openhome.org --type=WebDeviceConfig --version=1
$(deviceJava)DvProviderAvOpenhomeOrgWebProcessorConfig1.java : $(tt) OpenHome/Net/T4/Templates/DvUpnpJava.tt OpenHome/Net/Service/Upnp/OpenHome/WebProcessorConfig1.xml
	echo DvProviderAvOpenhomeOrgWebProcessorConfig1.java
	$(ohNetGen) --language=java --stack=dv "--xml=OpenHome/Net/Service/Upnp/OpenHome/WebProcessorConfig1.xml" --output=$(deviceJava) --domain=av.openhome.org --type=WebProcessorConfig --version=1
$(deviceJava)DvProviderAvOpenhomeOrgWebDACConfig1.java : $(tt) OpenHome/Net/T4/Templates/DvUpnpJava.tt OpenHome/Net/Service/Upnp/OpenHome/WebDACConfig1.xml
	echo DvProviderAvOpenhomeOrgWebDACConfig1.java
	$(ohNetGen) --language=java --stack=dv "--xml=OpenHome/Net/Service/Upnp/OpenHome/WebDACConfig1.xml" --output=$(deviceJava) --domain=av.openhome.org --type=WebDACConfig --version=1
$(deviceJava)DvProviderAvOpenhomeOrgWebClockConfig1.java : $(tt) OpenHome/Net/T4/Templates/DvUpnpJava.tt OpenHome/Net/Service/Upnp/OpenHome/WebClockConfig1.xml
	echo DvProviderAvOpenhomeOrgWebClockConfig1.java
	$(ohNetGen) --language=java --stack=dv "--xml=OpenHome/Net/Service/Upnp/OpenHome/WebClockConfig1.xml" --output=$(deviceJava) --domain=av.openhome.org --type=WebClockConfig --version=1
$(deviceJava)DvProviderAvOpenhomeOrgDACConfig1.java : $(tt) OpenHome/Net/T4/Templates/DvUpnpJava.tt OpenHome/Net/Service/Upnp/OpenHome/DACConfig1.xml
	echo DvProviderAvOpenhomeOrgDACConfig1.java
	$(ohNetGen) --language=java --stack=dv "--xml=OpenHome/Net/Service/Upnp/OpenHome/DACConfig1.xml" --output=$(deviceJava) --domain=av.openhome.org --type=DACConfig --version=1
...
$(deviceJava)DvProviderAvOpenhomeOrgServerConfig1.java : $(tt) OpenHome/Net/T4/Templates/DvUpnpJava.tt OpenHome/Net/Service/Upnp/OpenHome/ServerConfig1.xml
	echo DvProviderAvOpenhomeOrgServerConfig1.java
	$(ohNetGen) --language=java --stack=dv "--xml=OpenHome/Net/Service/Upnp/OpenHome/ServerConfig1.xml" --output=$(deviceJava) --domain=av.openhome.org --type=ServerConfig --version=1
$(deviceJava)DvProviderAvOpenhomeOrgMessageCenter1.java : $(tt) OpenHome/Net/T4/Templates/DvUpnpJava.tt OpenHome/Net/Service/Upnp/OpenHome/MessageCenter1.xml
	echo DvProviderAvOpenhomeOrgMessageCenter1.java
	$(ohNetGen) --language=java --stack=dv "--xml=OpenHome/Net/Service/Upnp/OpenHome/MessageCenter1.xml" --output=$(deviceJava) --domain=av.openhome.org --type=MessageCenter --version=1
$(deviceJava)DvProviderAvOpenhomeOrgRenderingInfo1.java : $(tt) OpenHome/Net/T4/Templates/DvUpnpJava.tt OpenHome/Net/Service/Upnp/OpenHome/RenderingInfo1.xml
	echo DvProviderAvOpenhomeOrgRenderingInfo1.java
	$(ohNetGen) --language=java --stack=dv "--xml=OpenHome/Net/Service/Upnp/OpenHome/RenderingInfo1.xml" --output=$(deviceJava) --domain=av.openhome.org --type=RenderingInfo --version=1
$(deviceJava)DvProviderAvOpenhomeOrgGroupConfig1.java : $(tt) OpenHome/Net/T4/Templates/DvUpnpJava.tt OpenHome/Net/Service/Upnp/OpenHome/GroupConfig1.xml
	echo DvProviderAvOpenhomeOrgGroupConfig1.java
	$(ohNetGen) --language=java --stack=dv "--xml=OpenHome/Net/Service/Upnp/OpenHome/GroupConfig1.xml" --output=$(deviceJava) --domain=av.openhome.org --type=GroupConfig --version=1
$(deviceJava)DvProviderAvOpenhomeOrgRoon1.java : $(tt) OpenHome/Net/T4/Templates/DvUpnpJava.tt OpenHome/Net/Service/Upnp/OpenHome/Roon1.xml
	echo DvProviderAvOpenhomeOrgRoon1.java
	$(ohNetGen) --language=java --stack=dv "--xml=OpenHome/Net/Service/Upnp/OpenHome/Roon1.xml" --output=$(deviceJava) --domain=av.openhome.org --type=Roon --version=1
$(deviceJava)DvProviderAvOpenhomeOrgTidalConnect1.java : $(tt) OpenHome/Net/T4/Templates/DvUpnpJava.tt OpenHome/Net/Service/Upnp/OpenHome/TidalConnect1.xml
	echo DvProviderAvOpenhomeOrgTidalConnect1.java
	$(ohNetGen) --language=java --stack=dv "--xml=OpenHome/Net/Service/Upnp/OpenHome/TidalConnect1.xml" --output=$(deviceJava) --domain=av.openhome.org --type=TidalConnect --version=1
$(deviceJava)DvProviderAvOpenhomeOrgBluetooth1.java : $(tt) OpenHome/Net/T4/Templates/DvUpnpJava.tt OpenHome/Net/Service/Upnp/OpenHome/Bluetooth1.xml
	echo DvProviderAvOpenhomeOrgBluetooth1.java
	$(ohNetGen) --language=java --stack=dv "--xml=OpenHome/Net/Service/Upnp/OpenHome/Bluetooth1.xml" --output=$(deviceJava) --domain=av.openhome.org --type=Bluetooth --version=1
$(deviceJava)DvProviderAvOpenhomeOrgAirplay1.java : $(tt) OpenHome/Net/T4/Templates/DvUpnpJava.tt OpenHome/Net/Service/Upnp/OpenHome/Airplay1.xml
	echo DvProviderAvOpenhomeOrgAirplay1.java
	$(ohNetGen) --language=java --stack=dv "--xml=OpenHome/Net/Service/Upnp/OpenHome/Airplay1.xml" --output=$(deviceJava) --domain=av.openhome.org --type=Airplay --version=1
$(deviceJava)DvProviderAvOpenhomeOrgMusicStation1.java : $(tt) OpenHome/Net/T4/Templates/DvUpnpJava.tt OpenHome/Net/Service/Upnp/OpenHome/MusicStation1.xml
	echo DvProviderAvOpenhomeOrgMusicStation1.java
	$(ohNetGen) --language=java --stack=dv "--xml=OpenHome/Net/Service/Upnp/OpenHome/MusicStation1.xml" --output=$(deviceJava) --domain=av.openhome.org --type=MusicStation --version=1
$(deviceJava)DvProviderAvOpenhomeOrgSpotify1.java : $(tt) OpenHome/Net/T4/Templates/DvUpnpJava.tt OpenHome/Net/Service/Upnp/OpenHome/Spotify1.xml
	echo DvProviderAvOpenhomeOrgSpotify1.java
	$(ohNetGen) --language=java --stack=dv "--xml=OpenHome/Net/Service/Upnp/OpenHome/Spotify1.xml" --output=$(deviceJava) --domain=av.openhome.org --type=Spotify --version=1
$(deviceJava)DvProviderAvOpenhomeOrgInternetRadio1.java : $(tt) OpenHome/Net/T4/Templates/DvUpnpJava.tt OpenHome/Net/Service/Upnp/OpenHome/InternetRadio1.xml
	echo DvProviderAvOpenhomeOrgInternetRadio1.java
	$(ohNetGen) --language=java --stack=dv "--xml=OpenHome/Net/Service/Upnp/OpenHome/InternetRadio1.xml" --output=$(deviceJava) --domain=av.openhome.org --type=InternetRadio --version=1
$(deviceJava)DvProviderAvOpenhomeOrgStreaming1.java : $(tt) OpenHome/Net/T4/Templates/DvUpnpJava.tt OpenHome/Net/Service/Upnp/OpenHome/Streaming1.xml
	echo DvProviderAvOpenhomeOrgStreaming1.java
	$(ohNetGen) --language=java --stack=dv "--xml=OpenHome/Net/Service/Upnp/OpenHome/Streaming1.xml" --output=$(deviceJava) --domain=av.openhome.org --type=Streaming --version=1
...
$(deviceJava)DvProviderTencentComQPlay1.java : $(tt) OpenHome/Net/T4/Templates/DvUpnpJava.tt OpenHome/Net/Service/Upnp/Upnp/MediaServer_3/QPlay1.xml
	echo DvProviderTencentComQPlay1.java
	$(ohNetGen) --language=java --stack=dv "--xml=OpenHome/Net/Service/Upnp/Upnp/MediaServer_3/QPlay1.xml" --output=$(deviceJava) --domain=tencent.com --type=QPlay --version=1
