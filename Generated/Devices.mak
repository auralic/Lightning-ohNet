...
objects_devices = \
                  ...
                  $(objdir)DvAvOpenhomeOrgGroupConfig1.$(objext) \
                  $(objdir)DvAvOpenhomeOrgGroupConfig1Std.$(objext) \
                  $(objdir)DvAvOpenhomeOrgGroupConfig1C.$(objext) \
                  ...
                  $(objdir)DvAvOpenhomeOrgStreaming1.$(objext) \
                  $(objdir)DvAvOpenhomeOrgStreaming1Std.$(objext) \
                  $(objdir)DvAvOpenhomeOrgStreaming1C.$(objext) \
                  ...
                  $(objdir)DvTencentComQPlay1.$(objext) \
                  $(objdir)DvTencentComQPlay1Std.$(objext) \
                  $(objdir)DvTencentComQPlay1C.$(objext) \
...
device_dotnet_assemblies_with_path = \
        ...
        $(objdir)DvTencentComQPlay1.net.dll \
...
device_java_classes_with_path = \
        ...
        $(objdir)org/openhome/net/device/providers/DvProviderTencentComQPlay1.class \
...
$(objdir)DvAvOpenhomeOrgHardwareConfig1.$(objext) : $(deviceCppCore)DvAvOpenhomeOrgHardwareConfig1.cpp $(headers_device) OpenHome/Net/Device/Providers/DvAvOpenhomeOrgHardwareConfig1.h
	$(compiler)DvAvOpenhomeOrgHardwareConfig1.$(objext) -c $(cppflags) $(includes) $(deviceCppCore)DvAvOpenhomeOrgHardwareConfig1.cpp
$(objdir)DvAvOpenhomeOrgHardwareConfig1Std.$(objext) : $(deviceCppStd)DvAvOpenhomeOrgHardwareConfig1Std.cpp $(headers_device) OpenHome/Net/Bindings/Cpp/Device/Providers/DvAvOpenhomeOrgHardwareConfig1.h
...
$(objdir)DvAvOpenhomeOrgServerConfig1Std.$(objext) : $(deviceCppStd)DvAvOpenhomeOrgServerConfig1Std.cpp $(headers_device) OpenHome/Net/Bindings/Cpp/Device/Providers/DvAvOpenhomeOrgServerConfig1.h
	$(compiler)DvAvOpenhomeOrgServerConfig1Std.$(objext) -c $(cppflags) $(includes) $(deviceCppStd)DvAvOpenhomeOrgServerConfig1Std.cpp
$(objdir)DvAvOpenhomeOrgServerConfig1C.$(objext) : $(deviceC)DvAvOpenhomeOrgServerConfig1C.cpp $(headers_device) OpenHome/Net/Bindings/C/Device/Providers/DvAvOpenhomeOrgServerConfig1.h
	$(compiler)DvAvOpenhomeOrgServerConfig1C.$(objext) -c $(cppflags) $(includes) $(deviceC)DvAvOpenhomeOrgServerConfig1C.cpp
$(objdir)DvAvOpenhomeOrgMessageCenter1.$(objext) : $(deviceCppCore)DvAvOpenhomeOrgMessageCenter1.cpp $(headers_device) OpenHome/Net/Device/Providers/DvAvOpenhomeOrgMessageCenter1.h
	$(compiler)DvAvOpenhomeOrgMessageCenter1.$(objext) -c $(cppflags) $(includes) $(deviceCppCore)DvAvOpenhomeOrgMessageCenter1.cpp
$(objdir)DvAvOpenhomeOrgMessageCenter1Std.$(objext) : $(deviceCppStd)DvAvOpenhomeOrgMessageCenter1Std.cpp $(headers_device) OpenHome/Net/Bindings/Cpp/Device/Providers/DvAvOpenhomeOrgMessageCenter1.h
...
$(objdir)DvAvOpenhomeOrgGroupConfig1.$(objext) : $(deviceCppCore)DvAvOpenhomeOrgGroupConfig1.cpp $(headers_device) OpenHome/Net/Device/Providers/DvAvOpenhomeOrgGroupConfig1.h
	$(compiler)DvAvOpenhomeOrgGroupConfig1.$(objext) -c $(cppflags) $(includes) $(deviceCppCore)DvAvOpenhomeOrgGroupConfig1.cpp
$(objdir)DvAvOpenhomeOrgGroupConfig1Std.$(objext) : $(deviceCppStd)DvAvOpenhomeOrgGroupConfig1Std.cpp $(headers_device) OpenHome/Net/Bindings/Cpp/Device/Providers/DvAvOpenhomeOrgGroupConfig1.h
	$(compiler)DvAvOpenhomeOrgGroupConfig1Std.$(objext) -c $(cppflags) $(includes) $(deviceCppStd)DvAvOpenhomeOrgGroupConfig1Std.cpp
$(objdir)DvAvOpenhomeOrgGroupConfig1C.$(objext) : $(deviceC)DvAvOpenhomeOrgGroupConfig1C.cpp $(headers_device) OpenHome/Net/Bindings/C/Device/Providers/DvAvOpenhomeOrgGroupConfig1.h
	$(compiler)DvAvOpenhomeOrgGroupConfig1C.$(objext) -c $(cppflags) $(includes) $(deviceC)DvAvOpenhomeOrgGroupConfig1C.cpp
$(objdir)DvAvOpenhomeOrgRoon1.$(objext) : $(deviceCppCore)DvAvOpenhomeOrgRoon1.cpp $(headers_device) OpenHome/Net/Device/Providers/DvAvOpenhomeOrgRoon1.h
	$(compiler)DvAvOpenhomeOrgRoon1.$(objext) -c $(cppflags) $(includes) $(deviceCppCore)DvAvOpenhomeOrgRoon1.cpp
$(objdir)DvAvOpenhomeOrgRoon1Std.$(objext) : $(deviceCppStd)DvAvOpenhomeOrgRoon1Std.cpp $(headers_device) OpenHome/Net/Bindings/Cpp/Device/Providers/DvAvOpenhomeOrgRoon1.h
...
$(objdir)DvAvOpenhomeOrgInternetRadio1Std.$(objext) : $(deviceCppStd)DvAvOpenhomeOrgInternetRadio1Std.cpp $(headers_device) OpenHome/Net/Bindings/Cpp/Device/Providers/DvAvOpenhomeOrgInternetRadio1.h
	$(compiler)DvAvOpenhomeOrgInternetRadio1Std.$(objext) -c $(cppflags) $(includes) $(deviceCppStd)DvAvOpenhomeOrgInternetRadio1Std.cpp
$(objdir)DvAvOpenhomeOrgInternetRadio1C.$(objext) : $(deviceC)DvAvOpenhomeOrgInternetRadio1C.cpp $(headers_device) OpenHome/Net/Bindings/C/Device/Providers/DvAvOpenhomeOrgInternetRadio1.h
	$(compiler)DvAvOpenhomeOrgInternetRadio1C.$(objext) -c $(cppflags) $(includes) $(deviceC)DvAvOpenhomeOrgInternetRadio1C.cpp
$(objdir)DvAvOpenhomeOrgStreaming1.$(objext) : $(deviceCppCore)DvAvOpenhomeOrgStreaming1.cpp $(headers_device) OpenHome/Net/Device/Providers/DvAvOpenhomeOrgStreaming1.h
	$(compiler)DvAvOpenhomeOrgStreaming1.$(objext) -c $(cppflags) $(includes) $(deviceCppCore)DvAvOpenhomeOrgStreaming1.cpp
$(objdir)DvAvOpenhomeOrgStreaming1Std.$(objext) : $(deviceCppStd)DvAvOpenhomeOrgStreaming1Std.cpp $(headers_device) OpenHome/Net/Bindings/Cpp/Device/Providers/DvAvOpenhomeOrgStreaming1.h
	$(compiler)DvAvOpenhomeOrgStreaming1Std.$(objext) -c $(cppflags) $(includes) $(deviceCppStd)DvAvOpenhomeOrgStreaming1Std.cpp
$(objdir)DvAvOpenhomeOrgStreaming1C.$(objext) : $(deviceC)DvAvOpenhomeOrgStreaming1C.cpp $(headers_device) OpenHome/Net/Bindings/C/Device/Providers/DvAvOpenhomeOrgStreaming1.h
	$(compiler)DvAvOpenhomeOrgStreaming1C.$(objext) -c $(cppflags) $(includes) $(deviceC)DvAvOpenhomeOrgStreaming1C.cpp
...
$(objdir)DvTencentComQPlay1.$(objext) : $(deviceCppCore)DvTencentComQPlay1.cpp $(headers_device) OpenHome/Net/Device/Providers/DvTencentComQPlay1.h
	$(compiler)DvTencentComQPlay1.$(objext) -c $(cppflags) $(includes) $(deviceCppCore)DvTencentComQPlay1.cpp
$(objdir)DvTencentComQPlay1Std.$(objext) : $(deviceCppStd)DvTencentComQPlay1Std.cpp $(headers_device) OpenHome/Net/Bindings/Cpp/Device/Providers/DvTencentComQPlay1.h
	$(compiler)DvTencentComQPlay1Std.$(objext) -c $(cppflags) $(includes) $(deviceCppStd)DvTencentComQPlay1Std.cpp
$(objdir)DvTencentComQPlay1C.$(objext) : $(deviceC)DvTencentComQPlay1C.cpp $(headers_device) OpenHome/Net/Bindings/C/Device/Providers/DvTencentComQPlay1.h
	$(compiler)DvTencentComQPlay1C.$(objext) -c $(cppflags) $(includes) $(deviceC)DvTencentComQPlay1C.cpp
...
DvAvOpenhomeOrgGroupConfig1Dll: $(objdir)$(dllprefix)DvAvOpenhomeOrgGroupConfig1.$(dllext) 
$(objdir)$(dllprefix)DvAvOpenhomeOrgGroupConfig1.$(dllext) : ZappUpnpDll $(objdir)DvAvOpenhomeOrgGroupConfig1.$(objext)
	$(link_dll_service) $(linkoutput)$(objdir)$(dllprefix)DvAvOpenhomeOrgGroupConfig1.$(dllext) $(objdir)DvAvOpenhomeOrgGroupConfig1.$(objext)
...
DvAvOpenhomeOrgStreaming1Dll: $(objdir)$(dllprefix)DvAvOpenhomeOrgStreaming1.$(dllext) 
$(objdir)$(dllprefix)DvAvOpenhomeOrgStreaming1.$(dllext) : ZappUpnpDll $(objdir)DvAvOpenhomeOrgStreaming1.$(objext)
	$(link_dll_service) $(linkoutput)$(objdir)$(dllprefix)DvAvOpenhomeOrgStreaming1.$(dllext) $(objdir)DvAvOpenhomeOrgStreaming1.$(objext)
...
DvTencentComQPlay1Dll: $(objdir)$(dllprefix)DvTencentComQPlay1.$(dllext) 
$(objdir)$(dllprefix)DvTencentComQPlay1.$(dllext) : ZappUpnpDll $(objdir)DvTencentComQPlay1.$(objext)
	$(link_dll_service) $(linkoutput)$(objdir)$(dllprefix)DvTencentComQPlay1.$(dllext) $(objdir)DvTencentComQPlay1.$(objext)
...
$(objdir)DvAvOpenhomeOrgHardwareConfig1.net.dll: $(objdir)ohNet.net.dll $(deviceCs)DvAvOpenhomeOrgHardwareConfig1.cs
	$(csharp) /t:library \
...
$(objdir)DvAvOpenhomeOrgServerConfig1.net.dll: $(objdir)ohNet.net.dll $(deviceCs)DvAvOpenhomeOrgServerConfig1.cs
	$(csharp) /t:library \
        ...
        /reference:$(objdir)ohNet.net.dll \
        $(deviceCs)DvAvOpenhomeOrgServerConfig1.cs
$(objdir)DvAvOpenhomeOrgMessageCenter1.net.dll: $(objdir)ohNet.net.dll $(deviceCs)DvAvOpenhomeOrgMessageCenter1.cs
	$(csharp) /t:library \
...
$(objdir)DvAvOpenhomeOrgGroupConfig1.net.dll: $(objdir)ohNet.net.dll $(deviceCs)DvAvOpenhomeOrgGroupConfig1.cs
	$(csharp) /t:library \
        /out:$(objdir)DvAvOpenhomeOrgGroupConfig1.net.dll \
        /reference:$(objdir)ohNet.net.dll \
        $(deviceCs)DvAvOpenhomeOrgGroupConfig1.cs
$(objdir)DvAvOpenhomeOrgRoon1.net.dll: $(objdir)ohNet.net.dll $(deviceCs)DvAvOpenhomeOrgRoon1.cs
	$(csharp) /t:library \
...
$(objdir)DvAvOpenhomeOrgInternetRadio1.net.dll: $(objdir)ohNet.net.dll $(deviceCs)DvAvOpenhomeOrgInternetRadio1.cs
	$(csharp) /t:library \
        ...
        /reference:$(objdir)ohNet.net.dll \
        $(deviceCs)DvAvOpenhomeOrgInternetRadio1.cs
$(objdir)DvAvOpenhomeOrgStreaming1.net.dll: $(objdir)ohNet.net.dll $(deviceCs)DvAvOpenhomeOrgStreaming1.cs
	$(csharp) /t:library \
        /out:$(objdir)DvAvOpenhomeOrgStreaming1.net.dll \
        /reference:$(objdir)ohNet.net.dll \
        $(deviceCs)DvAvOpenhomeOrgStreaming1.cs
...
$(objdir)DvTencentComQPlay1.net.dll: $(objdir)ohNet.net.dll $(deviceCs)DvTencentComQPlay1.cs
	$(csharp) /t:library \
        /out:$(objdir)DvTencentComQPlay1.net.dll \
        /reference:$(objdir)ohNet.net.dll \
        $(deviceCs)DvTencentComQPlay1.cs
...
$(objdir)org/openhome/net/device/providers/DvProviderAvOpenhomeOrgGroupConfig1.class : $(objdir)ohnet.jar $(deviceJava)DvProviderAvOpenhomeOrgGroupConfig1.java
...
$(objdir)org/openhome/net/device/providers/DvProviderAvOpenhomeOrgStreaming1.class : $(objdir)ohnet.jar $(deviceJava)DvProviderAvOpenhomeOrgStreaming1.java
	$(javac) -classpath $(objdir)ohnet.jar -d $(objdir) $(deviceJava)DvProviderAvOpenhomeOrgStreaming1.java
...
$(objdir)org/openhome/net/device/providers/DvProviderTencentComQPlay1.class : $(objdir)ohnet.jar $(deviceJava)DvProviderTencentComQPlay1.java
	$(javac) -classpath $(objdir)ohnet.jar -d $(objdir) $(deviceJava)DvProviderTencentComQPlay1.java
