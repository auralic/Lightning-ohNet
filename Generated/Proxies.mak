...
objects_proxies = \
                  ...
                  $(objdir)CpAvOpenhomeOrgMessageCenter1.$(objext) \
                  $(objdir)CpAvOpenhomeOrgMessageCenter1C.$(objext) \
                  $(objdir)CpAvOpenhomeOrgMessageCenter1Std.$(objext) \
                  ...
                  $(objdir)CpAvOpenhomeOrgGroupConfig1.$(objext) \
                  $(objdir)CpAvOpenhomeOrgGroupConfig1C.$(objext) \
                  $(objdir)CpAvOpenhomeOrgGroupConfig1Std.$(objext) \
                  ...
                  $(objdir)CpAvOpenhomeOrgStreaming1.$(objext) \
                  $(objdir)CpAvOpenhomeOrgStreaming1C.$(objext) \
                  $(objdir)CpAvOpenhomeOrgStreaming1Std.$(objext) \
...
$(objdir)CpAvOpenhomeOrgHardwareConfig1.$(objext) : $(proxyCppCore)CpAvOpenhomeOrgHardwareConfig1.cpp $(headers_proxy) OpenHome/Net/ControlPoint/Proxies/CpAvOpenhomeOrgHardwareConfig1.h
	$(compiler)CpAvOpenhomeOrgHardwareConfig1.$(objext) -c $(cppflags) $(includes) $(proxyCppCore)CpAvOpenhomeOrgHardwareConfig1.cpp
$(objdir)CpAvOpenhomeOrgHardwareConfig1C.$(objext) : $(proxyC)CpAvOpenhomeOrgHardwareConfig1C.cpp $(headers_proxy) OpenHome/Net/Bindings/C/ControlPoint/Proxies/CpAvOpenhomeOrgHardwareConfig1.h
...
$(objdir)CpAvOpenhomeOrgServerConfig1C.$(objext) : $(proxyC)CpAvOpenhomeOrgServerConfig1C.cpp $(headers_proxy) OpenHome/Net/Bindings/C/ControlPoint/Proxies/CpAvOpenhomeOrgServerConfig1.h
	$(compiler)CpAvOpenhomeOrgServerConfig1C.$(objext) -c $(cppflags) $(includes) $(proxyC)CpAvOpenhomeOrgServerConfig1C.cpp
$(objdir)CpAvOpenhomeOrgServerConfig1Std.$(objext) : $(proxyCppStd)CpAvOpenhomeOrgServerConfig1Std.cpp $(headers_proxy) OpenHome/Net/Bindings/Cpp/ControlPoint/Proxies/CpAvOpenhomeOrgServerConfig1.h
	$(compiler)CpAvOpenhomeOrgServerConfig1Std.$(objext) -c $(cppflags) $(includes) $(proxyCppStd)CpAvOpenhomeOrgServerConfig1Std.cpp
$(objdir)CpAvOpenhomeOrgMessageCenter1.$(objext) : $(proxyCppCore)CpAvOpenhomeOrgMessageCenter1.cpp $(headers_proxy) OpenHome/Net/ControlPoint/Proxies/CpAvOpenhomeOrgMessageCenter1.h
	$(compiler)CpAvOpenhomeOrgMessageCenter1.$(objext) -c $(cppflags) $(includes) $(proxyCppCore)CpAvOpenhomeOrgMessageCenter1.cpp
$(objdir)CpAvOpenhomeOrgMessageCenter1C.$(objext) : $(proxyC)CpAvOpenhomeOrgMessageCenter1C.cpp $(headers_proxy) OpenHome/Net/Bindings/C/ControlPoint/Proxies/CpAvOpenhomeOrgMessageCenter1.h
	$(compiler)CpAvOpenhomeOrgMessageCenter1C.$(objext) -c $(cppflags) $(includes) $(proxyC)CpAvOpenhomeOrgMessageCenter1C.cpp
$(objdir)CpAvOpenhomeOrgMessageCenter1Std.$(objext) : $(proxyCppStd)CpAvOpenhomeOrgMessageCenter1Std.cpp $(headers_proxy) OpenHome/Net/Bindings/Cpp/ControlPoint/Proxies/CpAvOpenhomeOrgMessageCenter1.h
	$(compiler)CpAvOpenhomeOrgMessageCenter1Std.$(objext) -c $(cppflags) $(includes) $(proxyCppStd)CpAvOpenhomeOrgMessageCenter1Std.cpp
$(objdir)CpAvOpenhomeOrgRenderingInfo1.$(objext) : $(proxyCppCore)CpAvOpenhomeOrgRenderingInfo1.cpp $(headers_proxy) OpenHome/Net/ControlPoint/Proxies/CpAvOpenhomeOrgRenderingInfo1.h
	$(compiler)CpAvOpenhomeOrgRenderingInfo1.$(objext) -c $(cppflags) $(includes) $(proxyCppCore)CpAvOpenhomeOrgRenderingInfo1.cpp
$(objdir)CpAvOpenhomeOrgRenderingInfo1C.$(objext) : $(proxyC)CpAvOpenhomeOrgRenderingInfo1C.cpp $(headers_proxy) OpenHome/Net/Bindings/C/ControlPoint/Proxies/CpAvOpenhomeOrgRenderingInfo1.h
...
$(objdir)CpAvOpenhomeOrgGroupConfig1.$(objext) : $(proxyCppCore)CpAvOpenhomeOrgGroupConfig1.cpp $(headers_proxy) OpenHome/Net/ControlPoint/Proxies/CpAvOpenhomeOrgGroupConfig1.h
	$(compiler)CpAvOpenhomeOrgGroupConfig1.$(objext) -c $(cppflags) $(includes) $(proxyCppCore)CpAvOpenhomeOrgGroupConfig1.cpp
$(objdir)CpAvOpenhomeOrgGroupConfig1C.$(objext) : $(proxyC)CpAvOpenhomeOrgGroupConfig1C.cpp $(headers_proxy) OpenHome/Net/Bindings/C/ControlPoint/Proxies/CpAvOpenhomeOrgGroupConfig1.h
	$(compiler)CpAvOpenhomeOrgGroupConfig1C.$(objext) -c $(cppflags) $(includes) $(proxyC)CpAvOpenhomeOrgGroupConfig1C.cpp
$(objdir)CpAvOpenhomeOrgGroupConfig1Std.$(objext) : $(proxyCppStd)CpAvOpenhomeOrgGroupConfig1Std.cpp $(headers_proxy) OpenHome/Net/Bindings/Cpp/ControlPoint/Proxies/CpAvOpenhomeOrgGroupConfig1.h
	$(compiler)CpAvOpenhomeOrgGroupConfig1Std.$(objext) -c $(cppflags) $(includes) $(proxyCppStd)CpAvOpenhomeOrgGroupConfig1Std.cpp
...
$(objdir)CpAvOpenhomeOrgInternetRadio1C.$(objext) : $(proxyC)CpAvOpenhomeOrgInternetRadio1C.cpp $(headers_proxy) OpenHome/Net/Bindings/C/ControlPoint/Proxies/CpAvOpenhomeOrgInternetRadio1.h
	$(compiler)CpAvOpenhomeOrgInternetRadio1C.$(objext) -c $(cppflags) $(includes) $(proxyC)CpAvOpenhomeOrgInternetRadio1C.cpp
$(objdir)CpAvOpenhomeOrgInternetRadio1Std.$(objext) : $(proxyCppStd)CpAvOpenhomeOrgInternetRadio1Std.cpp $(headers_proxy) OpenHome/Net/Bindings/Cpp/ControlPoint/Proxies/CpAvOpenhomeOrgInternetRadio1.h
	$(compiler)CpAvOpenhomeOrgInternetRadio1Std.$(objext) -c $(cppflags) $(includes) $(proxyCppStd)CpAvOpenhomeOrgInternetRadio1Std.cpp
$(objdir)CpAvOpenhomeOrgStreaming1.$(objext) : $(proxyCppCore)CpAvOpenhomeOrgStreaming1.cpp $(headers_proxy) OpenHome/Net/ControlPoint/Proxies/CpAvOpenhomeOrgStreaming1.h
	$(compiler)CpAvOpenhomeOrgStreaming1.$(objext) -c $(cppflags) $(includes) $(proxyCppCore)CpAvOpenhomeOrgStreaming1.cpp
$(objdir)CpAvOpenhomeOrgStreaming1C.$(objext) : $(proxyC)CpAvOpenhomeOrgStreaming1C.cpp $(headers_proxy) OpenHome/Net/Bindings/C/ControlPoint/Proxies/CpAvOpenhomeOrgStreaming1.h
	$(compiler)CpAvOpenhomeOrgStreaming1C.$(objext) -c $(cppflags) $(includes) $(proxyC)CpAvOpenhomeOrgStreaming1C.cpp
$(objdir)CpAvOpenhomeOrgStreaming1Std.$(objext) : $(proxyCppStd)CpAvOpenhomeOrgStreaming1Std.cpp $(headers_proxy) OpenHome/Net/Bindings/Cpp/ControlPoint/Proxies/CpAvOpenhomeOrgStreaming1.h
	$(compiler)CpAvOpenhomeOrgStreaming1Std.$(objext) -c $(cppflags) $(includes) $(proxyCppStd)CpAvOpenhomeOrgStreaming1Std.cpp
...
CpAvOpenhomeOrgMessageCenter1Dll: $(objdir)$(dllprefix)CpAvOpenhomeOrgMessageCenter1.$(dllext)
$(objdir)$(dllprefix)CpAvOpenhomeOrgMessageCenter1.$(dllext) : ZappUpnpDll $(objdir)CpAvOpenhomeOrgMessageCenter1.$(objext)
	$(link_dll_service) $(linkoutput)$(objdir)$(dllprefix)CpAvOpenhomeOrgMessageCenter1.$(dllext) $(objdir)CpAvOpenhomeOrgMessageCenter1.$(objext)
...
CpAvOpenhomeOrgGroupConfig1Dll: $(objdir)$(dllprefix)CpAvOpenhomeOrgGroupConfig1.$(dllext)
$(objdir)$(dllprefix)CpAvOpenhomeOrgGroupConfig1.$(dllext) : ZappUpnpDll $(objdir)CpAvOpenhomeOrgGroupConfig1.$(objext)
	$(link_dll_service) $(linkoutput)$(objdir)$(dllprefix)CpAvOpenhomeOrgGroupConfig1.$(dllext) $(objdir)CpAvOpenhomeOrgGroupConfig1.$(objext)
...
CpAvOpenhomeOrgStreaming1Dll: $(objdir)$(dllprefix)CpAvOpenhomeOrgStreaming1.$(dllext)
$(objdir)$(dllprefix)CpAvOpenhomeOrgStreaming1.$(dllext) : ZappUpnpDll $(objdir)CpAvOpenhomeOrgStreaming1.$(objext)
	$(link_dll_service) $(linkoutput)$(objdir)$(dllprefix)CpAvOpenhomeOrgStreaming1.$(dllext) $(objdir)CpAvOpenhomeOrgStreaming1.$(objext)
...
$(objdir)CpAvOpenhomeOrgHardwareConfig1.net.dll: $(objdir)ohNet.net.dll $(proxyCs)CpAvOpenhomeOrgHardwareConfig1.cs
	$(csharp) /t:library \
...
$(objdir)CpAvOpenhomeOrgServerConfig1.net.dll: $(objdir)ohNet.net.dll $(proxyCs)CpAvOpenhomeOrgServerConfig1.cs
	$(csharp) /t:library \
        ...
        /reference:$(objdir)ohNet.net.dll \
        $(proxyCs)CpAvOpenhomeOrgServerConfig1.cs
$(objdir)CpAvOpenhomeOrgMessageCenter1.net.dll: $(objdir)ohNet.net.dll $(proxyCs)CpAvOpenhomeOrgMessageCenter1.cs
	$(csharp) /t:library \
        /out:$(objdir)CpAvOpenhomeOrgMessageCenter1.net.dll \
        /reference:$(objdir)ohNet.net.dll \
        $(proxyCs)CpAvOpenhomeOrgMessageCenter1.cs
$(objdir)CpAvOpenhomeOrgRenderingInfo1.net.dll: $(objdir)ohNet.net.dll $(proxyCs)CpAvOpenhomeOrgRenderingInfo1.cs
	$(csharp) /t:library \
        /out:$(objdir)CpAvOpenhomeOrgRenderingInfo1.net.dll \
        /reference:$(objdir)ohNet.net.dll \
        $(proxyCs)CpAvOpenhomeOrgRenderingInfo1.cs
$(objdir)CpAvOpenhomeOrgGroupConfig1.net.dll: $(objdir)ohNet.net.dll $(proxyCs)CpAvOpenhomeOrgGroupConfig1.cs
	$(csharp) /t:library \
        /out:$(objdir)CpAvOpenhomeOrgGroupConfig1.net.dll \
        /reference:$(objdir)ohNet.net.dll \
        $(proxyCs)CpAvOpenhomeOrgGroupConfig1.cs
...
$(objdir)CpAvOpenhomeOrgInternetRadio1.net.dll: $(objdir)ohNet.net.dll $(proxyCs)CpAvOpenhomeOrgInternetRadio1.cs
	$(csharp) /t:library \
        ...
        /reference:$(objdir)ohNet.net.dll \
        $(proxyCs)CpAvOpenhomeOrgInternetRadio1.cs
$(objdir)CpAvOpenhomeOrgStreaming1.net.dll: $(objdir)ohNet.net.dll $(proxyCs)CpAvOpenhomeOrgStreaming1.cs
	$(csharp) /t:library \
        /out:$(objdir)CpAvOpenhomeOrgStreaming1.net.dll \
        /reference:$(objdir)ohNet.net.dll \
        $(proxyCs)CpAvOpenhomeOrgStreaming1.cs
...
$(objdir)org/openhome/net/controlpoint/proxies/CpProxyAvOpenhomeOrgGroupConfig1.class : $(objdir)ohnet.jar $(proxyJava)CpProxyAvOpenhomeOrgGroupConfig1.java
...
$(objdir)org/openhome/net/controlpoint/proxies/CpProxyAvOpenhomeOrgStreaming1.class : $(objdir)ohnet.jar $(proxyJava)CpProxyAvOpenhomeOrgStreaming1.java
	$(javac) -classpath $(objdir)ohnet.jar -d $(objdir) $(proxyJava)CpProxyAvOpenhomeOrgStreaming1.java
