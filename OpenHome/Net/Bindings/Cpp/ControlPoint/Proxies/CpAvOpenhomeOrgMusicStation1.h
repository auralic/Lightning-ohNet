#ifndef HEADER_AVOPENHOMEORGMUSICSTATION1CPP
#define HEADER_AVOPENHOMEORGMUSICSTATION1CPP
...
class PropertyUint;
class CpProxy;
class ICpProxyAvOpenhomeOrgMusicStation1Cpp : public ICpProxy
{
public:
    virtual ~ICpProxyAvOpenhomeOrgMusicStation1Cpp() {}
...
/**
 * Proxy for av.openhome.org:MusicStation:1
 * @ingroup Proxies
 */
class CpProxyAvOpenhomeOrgMusicStation1Cpp : public ICpProxyAvOpenhomeOrgMusicStation1Cpp
{
public:
    /**
     * Constructor.
     ...
     */
    CpProxyAvOpenhomeOrgMusicStation1Cpp(CpDeviceCpp& aDevice);
    /**
     * Destructor.
     ...
     */
    ~CpProxyAvOpenhomeOrgMusicStation1Cpp();
     ...
     * CpProxyAvOpenhomeOrgMusicStation1Cpp instance will not overlap.
     *
...
#endif // HEADER_AVOPENHOMEORGMUSICSTATION1CPP
