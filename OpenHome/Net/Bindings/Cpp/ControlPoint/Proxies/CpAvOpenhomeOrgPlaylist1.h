...
public:
    ...
    virtual void SyncSimpleReadList(const std::string& aIdList, std::string& aTrackList) = 0;
    virtual void BeginSimpleReadList(const std::string& aIdList, FunctorAsync& aFunctor) = 0;
    virtual void EndSimpleReadList(IAsync& aAsync, std::string& aTrackList) = 0;
    ...
    virtual void SyncBatchInsert(uint32_t aAfterId, const std::string& aSongList, uint32_t& aNewId) = 0;
    virtual void BeginBatchInsert(uint32_t aAfterId, const std::string& aSongList, FunctorAsync& aFunctor) = 0;
    virtual void EndBatchInsert(IAsync& aAsync, uint32_t& aNewId) = 0;
...
public:
     ...
     */
    void SyncSimpleReadList(const std::string& aIdList, std::string& aTrackList);
    /**
     * Invoke the action asynchronously.
     * Returns immediately and will run the client-specified callback when the action
     * later completes.  Any output arguments can then be retrieved by calling
     ...
     *                       This is guaranteed to be run but may indicate an error
     */
    void BeginSimpleReadList(const std::string& aIdList, FunctorAsync& aFunctor);
    /**
     * Retrieve the output arguments from an asynchronously invoked action.
     * This may only be called from the callback set in the above Begin function.
     *
     ...
     * @param[out] aTrackList
     */
    void EndSimpleReadList(IAsync& aAsync, std::string& aTrackList);
     ...
     * @param[out] aNewId
     */
    void SyncBatchInsert(uint32_t aAfterId, const std::string& aSongList, uint32_t& aNewId);
    /**
     * Invoke the action asynchronously.
     * Returns immediately and will run the client-specified callback when the action
     * later completes.  Any output arguments can then be retrieved by calling
     ...
     *                       This is guaranteed to be run but may indicate an error
     */
    void BeginBatchInsert(uint32_t aAfterId, const std::string& aSongList, FunctorAsync& aFunctor);
    /**
     * Retrieve the output arguments from an asynchronously invoked action.
     * This may only be called from the callback set in the above Begin function.
     *
     ...
     * @param[out] aNewId
     */
    void EndBatchInsert(IAsync& aAsync, uint32_t& aNewId);
     ...
     * @param[out] aAutoPlay
     */
    void PropertyAutoPlay(bool& aAutoPlay) const;
    /**
