#ifndef HEADER_AVOPENHOMEORGAIRPLAY1CPP
#define HEADER_AVOPENHOMEORGAIRPLAY1CPP
...
class PropertyUint;
class CpProxy;
class ICpProxyAvOpenhomeOrgAirplay1Cpp : public ICpProxy
{
public:
    virtual ~ICpProxyAvOpenhomeOrgAirplay1Cpp() {}
...
/**
 * Proxy for av.openhome.org:Airplay:1
 * @ingroup Proxies
 */
class CpProxyAvOpenhomeOrgAirplay1Cpp : public ICpProxyAvOpenhomeOrgAirplay1Cpp
{
public:
    /**
     * Constructor.
     ...
     */
    CpProxyAvOpenhomeOrgAirplay1Cpp(CpDeviceCpp& aDevice);
    /**
     * Destructor.
     ...
     */
    ~CpProxyAvOpenhomeOrgAirplay1Cpp();
     ...
     * CpProxyAvOpenhomeOrgAirplay1Cpp instance will not overlap.
     *
...
#endif // HEADER_AVOPENHOMEORGAIRPLAY1CPP
