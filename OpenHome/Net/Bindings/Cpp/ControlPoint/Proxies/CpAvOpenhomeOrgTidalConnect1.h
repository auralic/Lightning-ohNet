#ifndef HEADER_AVOPENHOMEORGTIDALCONNECT1CPP
#define HEADER_AVOPENHOMEORGTIDALCONNECT1CPP
...
class PropertyUint;
class CpProxy;
class ICpProxyAvOpenhomeOrgTidalConnect1Cpp : public ICpProxy
{
public:
    virtual ~ICpProxyAvOpenhomeOrgTidalConnect1Cpp() {}
 ...
 * @ingroup Proxies
 */
class CpProxyAvOpenhomeOrgTidalConnect1Cpp : public ICpProxyAvOpenhomeOrgTidalConnect1Cpp
{
public:
    /**
     * Constructor.
     ...
     */
    CpProxyAvOpenhomeOrgTidalConnect1Cpp(CpDeviceCpp& aDevice);
    /**
     * Destructor.
     ...
     */
    ~CpProxyAvOpenhomeOrgTidalConnect1Cpp();
     ...
     * CpProxyAvOpenhomeOrgTidalConnect1Cpp instance will not overlap.
     *
...
#endif // HEADER_AVOPENHOMEORGTIDALCONNECT1CPP
