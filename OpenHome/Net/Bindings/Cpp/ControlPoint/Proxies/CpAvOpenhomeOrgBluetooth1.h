#ifndef HEADER_AVOPENHOMEORGBLUETOOTH1CPP
#define HEADER_AVOPENHOMEORGBLUETOOTH1CPP
...
class PropertyUint;
class CpProxy;
class ICpProxyAvOpenhomeOrgBluetooth1Cpp : public ICpProxy
{
public:
    virtual ~ICpProxyAvOpenhomeOrgBluetooth1Cpp() {}
    ...
    virtual void SyncSetRepeatOne(bool aValue) = 0;
    virtual void BeginSetRepeatOne(bool aValue, FunctorAsync& aFunctor) = 0;
    virtual void EndSetRepeatOne(IAsync& aAsync) = 0;
    virtual void SyncRepeatOne(bool& aValue) = 0;
    virtual void BeginRepeatOne(FunctorAsync& aFunctor) = 0;
    virtual void EndRepeatOne(IAsync& aAsync, bool& aValue) = 0;
...
/**
 * Proxy for av.openhome.org:Bluetooth:1
 * @ingroup Proxies
 */
class CpProxyAvOpenhomeOrgBluetooth1Cpp : public ICpProxyAvOpenhomeOrgBluetooth1Cpp
{
public:
    /**
     * Constructor.
     ...
     */
    CpProxyAvOpenhomeOrgBluetooth1Cpp(CpDeviceCpp& aDevice);
    /**
     * Destructor.
     ...
     */
    ~CpProxyAvOpenhomeOrgBluetooth1Cpp();
     ...
     *                       This is guaranteed to be run but may indicate an error
     */
    void BeginSetRepeatOne(bool aValue, FunctorAsync& aFunctor);
    /**
     * Retrieve the output arguments from an asynchronously invoked action.
     * This may only be called from the callback set in the above Begin function.
     *
     ...
     * @param[out] aValue
     */
    void SyncRepeatOne(bool& aValue);
    /**
     * Invoke the action asynchronously.
     * Returns immediately and will run the client-specified callback when the action
     * later completes.  Any output arguments can then be retrieved by calling
     ...
     * @param[out] aValue
     */
    void EndRepeatOne(IAsync& aAsync, bool& aValue);
     ...
     * CpProxyAvOpenhomeOrgBluetooth1Cpp instance will not overlap.
     *
...
#endif // HEADER_AVOPENHOMEORGBLUETOOTH1CPP
