#ifndef HEADER_AVOPENHOMEORGSPOTIFY1CPP
#define HEADER_AVOPENHOMEORGSPOTIFY1CPP
...
class PropertyUint;
class CpProxy;
class ICpProxyAvOpenhomeOrgSpotify1Cpp : public ICpProxy
{
public:
    virtual ~ICpProxyAvOpenhomeOrgSpotify1Cpp() {}
 ...
 * @ingroup Proxies
 */
class CpProxyAvOpenhomeOrgSpotify1Cpp : public ICpProxyAvOpenhomeOrgSpotify1Cpp
{
public:
    /**
     * Constructor.
     ...
     */
    CpProxyAvOpenhomeOrgSpotify1Cpp(CpDeviceCpp& aDevice);
    /**
     * Destructor.
     ...
     */
    ~CpProxyAvOpenhomeOrgSpotify1Cpp();
     ...
     * CpProxyAvOpenhomeOrgSpotify1Cpp instance will not overlap.
     *
...
#endif // HEADER_AVOPENHOMEORGSPOTIFY1CPP
