#ifndef HEADER_AVOPENHOMEORGAMAZONMUSIC1CPP
#define HEADER_AVOPENHOMEORGAMAZONMUSIC1CPP
...
class PropertyUint;
class CpProxy;
class ICpProxyAvOpenhomeOrgAmazonMusic1Cpp : public ICpProxy
{
public:
    virtual ~ICpProxyAvOpenhomeOrgAmazonMusic1Cpp() {}
    virtual void SyncLogIn() = 0;
    virtual void BeginLogIn(FunctorAsync& aFunctor) = 0;
    virtual void EndLogIn(IAsync& aAsync) = 0;
...
/**
 * Proxy for av.openhome.org:AmazonMusic:1
 * @ingroup Proxies
 */
class CpProxyAvOpenhomeOrgAmazonMusic1Cpp : public ICpProxyAvOpenhomeOrgAmazonMusic1Cpp
{
public:
    /**
     * Constructor.
     ...
     */
    CpProxyAvOpenhomeOrgAmazonMusic1Cpp(CpDeviceCpp& aDevice);
    /**
     * Destructor.
     ...
     */
    ~CpProxyAvOpenhomeOrgAmazonMusic1Cpp();
     ...
     * CpProxyAvOpenhomeOrgAmazonMusic1Cpp instance will not overlap.
     *
...
#endif // HEADER_AVOPENHOMEORGAMAZONMUSIC1CPP
