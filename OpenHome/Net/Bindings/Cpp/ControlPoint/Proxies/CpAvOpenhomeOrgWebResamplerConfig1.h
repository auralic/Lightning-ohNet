#ifndef HEADER_AVOPENHOMEORGWEBRESAMPLERCONFIG1CPP
#define HEADER_AVOPENHOMEORGWEBRESAMPLERCONFIG1CPP
 ...
 * @ingroup Proxies
 */
class CpProxyAvOpenhomeOrgWebResamplerConfig1Cpp : public CpProxy
{
public:
    /**
     * Constructor.
     ...
     */
    CpProxyAvOpenhomeOrgWebResamplerConfig1Cpp(CpDeviceCpp& aDevice);
    /**
     * Destructor.
     ...
     */
    ~CpProxyAvOpenhomeOrgWebResamplerConfig1Cpp();
     ...
     * CpProxyAvOpenhomeOrgWebResamplerConfig1Cpp instance will not overlap.
     *
...
#endif // HEADER_AVOPENHOMEORGWEBRESAMPLERCONFIG1CPP
