...
public:
    ...
    virtual void SyncCanSetVolume(uint32_t aValue) = 0;
    virtual void BeginCanSetVolume(uint32_t aValue, FunctorAsync& aFunctor) = 0;
    ...
    virtual void SyncCanSetMute(bool aValue) = 0;
    virtual void BeginCanSetMute(bool aValue, FunctorAsync& aFunctor) = 0;
