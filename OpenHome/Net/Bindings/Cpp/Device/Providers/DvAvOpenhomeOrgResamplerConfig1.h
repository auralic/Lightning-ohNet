#ifndef HEADER_DVAVOPENHOMEORGRESAMPLERCONFIG1CPP
#define HEADER_DVAVOPENHOMEORGRESAMPLERCONFIG1CPP
 ...
 * @ingroup Providers
 */
class DvProviderAvOpenhomeOrgResamplerConfig1Cpp : public DvProvider
{
public:
    virtual ~DvProviderAvOpenhomeOrgResamplerConfig1Cpp() {}
    /**
...
protected:
     ...
     */
    DvProviderAvOpenhomeOrgResamplerConfig1Cpp(DvDeviceStd& aDevice);
    /**
...
private:
    DvProviderAvOpenhomeOrgResamplerConfig1Cpp();
...
#endif // HEADER_DVAVOPENHOMEORGRESAMPLERCONFIG1CPP
