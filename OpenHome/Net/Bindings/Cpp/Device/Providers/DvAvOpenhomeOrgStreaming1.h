#ifndef HEADER_DVAVOPENHOMEORGSTREAMING1CPP
#define HEADER_DVAVOPENHOMEORGSTREAMING1CPP
 ...
 * @ingroup Providers
 */
class DvProviderAvOpenhomeOrgStreaming1Cpp : public DvProvider
{
public:
    virtual ~DvProviderAvOpenhomeOrgStreaming1Cpp() {}
    /**
...
protected:
     ...
     */
    DvProviderAvOpenhomeOrgStreaming1Cpp(DvDeviceStd& aDevice);
    /**
...
private:
    DvProviderAvOpenhomeOrgStreaming1Cpp();
...
#endif // HEADER_DVAVOPENHOMEORGSTREAMING1CPP
