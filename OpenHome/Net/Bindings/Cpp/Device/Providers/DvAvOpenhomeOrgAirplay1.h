#ifndef HEADER_DVAVOPENHOMEORGAIRPLAY1CPP
#define HEADER_DVAVOPENHOMEORGAIRPLAY1CPP
 ...
 * @ingroup Providers
 */
class DvProviderAvOpenhomeOrgAirplay1Cpp : public DvProvider
{
public:
    virtual ~DvProviderAvOpenhomeOrgAirplay1Cpp() {}
    /**
...
protected:
     ...
     */
    DvProviderAvOpenhomeOrgAirplay1Cpp(DvDeviceStd& aDevice);
    /**
...
private:
    DvProviderAvOpenhomeOrgAirplay1Cpp();
...
#endif // HEADER_DVAVOPENHOMEORGAIRPLAY1CPP
