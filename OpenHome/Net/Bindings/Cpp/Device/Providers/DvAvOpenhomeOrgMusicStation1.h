#ifndef HEADER_DVAVOPENHOMEORGMUSICSTATION1CPP
#define HEADER_DVAVOPENHOMEORGMUSICSTATION1CPP
 ...
 * @ingroup Providers
 */
class DvProviderAvOpenhomeOrgMusicStation1Cpp : public DvProvider
{
public:
    virtual ~DvProviderAvOpenhomeOrgMusicStation1Cpp() {}
    /**
...
protected:
     ...
     */
    DvProviderAvOpenhomeOrgMusicStation1Cpp(DvDeviceStd& aDevice);
    /**
...
private:
    DvProviderAvOpenhomeOrgMusicStation1Cpp();
...
#endif // HEADER_DVAVOPENHOMEORGMUSICSTATION1CPP
