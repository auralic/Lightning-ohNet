...
/**
* Service Proxy for CpProxyAvOpenhomeOrgStreaming1
* @module ohnet
* @class Streaming
*/
    
var CpProxyAvOpenhomeOrgStreaming1 = function(udn){ 

    this.url = window.location.protocol + "//" + window.location.host + "/" + udn + "/av.openhome.org-Streaming-1/control";  // upnp control url
    this.domain = "av-openhome-org";
    this.type = "Streaming";
    this.version = "1";
    this.serviceName = "av.openhome.org-Streaming-1";
...
*/
CpProxyAvOpenhomeOrgStreaming1.prototype.subscribe = function (serviceAddedFunction) {
...
* @method Unsubscribe
*/
CpProxyAvOpenhomeOrgStreaming1.prototype.unsubscribe = function () {
...
*/
CpProxyAvOpenhomeOrgStreaming1.prototype.TransportState_Changed = function (stateChangedFunction) {
...
* @param {Function} stateChangedFunction The handler for state changes
*/
CpProxyAvOpenhomeOrgStreaming1.prototype.Repeat_Changed = function (stateChangedFunction) {
...
* @param {Function} stateChangedFunction The handler for state changes
*/
CpProxyAvOpenhomeOrgStreaming1.prototype.Shuffle_Changed = function (stateChangedFunction) {
...
* @param {Function} stateChangedFunction The handler for state changes
*/
CpProxyAvOpenhomeOrgStreaming1.prototype.Id_Changed = function (stateChangedFunction) {
...
* @param {Function} stateChangedFunction The handler for state changes
*/
CpProxyAvOpenhomeOrgStreaming1.prototype.IdArray_Changed = function (stateChangedFunction) {
...
* @param {Function} stateChangedFunction The handler for state changes
*/
CpProxyAvOpenhomeOrgStreaming1.prototype.TracksMax_Changed = function (stateChangedFunction) {
...
* @param {Function} stateChangedFunction The handler for state changes
*/
CpProxyAvOpenhomeOrgStreaming1.prototype.ProtocolInfo_Changed = function (stateChangedFunction) {
...
*/
CpProxyAvOpenhomeOrgStreaming1.prototype.Play = function(successFunction, errorFunction){ 
...
* @param {Function} errorFunction The function that is executed when the action has cause an error
*/
CpProxyAvOpenhomeOrgStreaming1.prototype.Pause = function(successFunction, errorFunction){ 
...
* @param {Function} errorFunction The function that is executed when the action has cause an error
*/
CpProxyAvOpenhomeOrgStreaming1.prototype.Stop = function(successFunction, errorFunction){ 
...
* @param {Function} errorFunction The function that is executed when the action has cause an error
*/
CpProxyAvOpenhomeOrgStreaming1.prototype.Next = function(successFunction, errorFunction){ 
...
* @param {Function} errorFunction The function that is executed when the action has cause an error
*/
CpProxyAvOpenhomeOrgStreaming1.prototype.Previous = function(successFunction, errorFunction){ 
...
* @param {Function} errorFunction The function that is executed when the action has cause an error
*/
CpProxyAvOpenhomeOrgStreaming1.prototype.SetRepeat = function(Value, successFunction, errorFunction){ 
...
* @param {Function} errorFunction The function that is executed when the action has cause an error
*/
CpProxyAvOpenhomeOrgStreaming1.prototype.Repeat = function(successFunction, errorFunction){ 
...
* @param {Function} errorFunction The function that is executed when the action has cause an error
*/
CpProxyAvOpenhomeOrgStreaming1.prototype.SetShuffle = function(Value, successFunction, errorFunction){ 
...
* @param {Function} errorFunction The function that is executed when the action has cause an error
*/
CpProxyAvOpenhomeOrgStreaming1.prototype.Shuffle = function(successFunction, errorFunction){ 
...
* @param {Function} errorFunction The function that is executed when the action has cause an error
*/
CpProxyAvOpenhomeOrgStreaming1.prototype.SeekSecondAbsolute = function(Value, successFunction, errorFunction){ 
...
* @param {Function} errorFunction The function that is executed when the action has cause an error
*/
CpProxyAvOpenhomeOrgStreaming1.prototype.SeekSecondRelative = function(Value, successFunction, errorFunction){ 
...
* @param {Function} errorFunction The function that is executed when the action has cause an error
*/
CpProxyAvOpenhomeOrgStreaming1.prototype.SeekId = function(Value, successFunction, errorFunction){ 
...
* @param {Function} errorFunction The function that is executed when the action has cause an error
*/
CpProxyAvOpenhomeOrgStreaming1.prototype.SeekIndex = function(Value, successFunction, errorFunction){ 
...
* @param {Function} errorFunction The function that is executed when the action has cause an error
*/
CpProxyAvOpenhomeOrgStreaming1.prototype.TransportState = function(successFunction, errorFunction){ 
...
* @param {Function} errorFunction The function that is executed when the action has cause an error
*/
CpProxyAvOpenhomeOrgStreaming1.prototype.Id = function(successFunction, errorFunction){ 
...
* @param {Function} errorFunction The function that is executed when the action has cause an error
*/
CpProxyAvOpenhomeOrgStreaming1.prototype.Read = function(Id, successFunction, errorFunction){ 
...
* @param {Function} errorFunction The function that is executed when the action has cause an error
*/
CpProxyAvOpenhomeOrgStreaming1.prototype.ReadList = function(IdList, successFunction, errorFunction){ 
...
* @param {Function} errorFunction The function that is executed when the action has cause an error
*/
CpProxyAvOpenhomeOrgStreaming1.prototype.Insert = function(AfterId, Uri, Metadata, successFunction, errorFunction){ 
...
* @param {Function} errorFunction The function that is executed when the action has cause an error
*/
CpProxyAvOpenhomeOrgStreaming1.prototype.DeleteId = function(Value, successFunction, errorFunction){ 
...
* @param {Function} errorFunction The function that is executed when the action has cause an error
*/
CpProxyAvOpenhomeOrgStreaming1.prototype.DeleteAll = function(successFunction, errorFunction){ 
...
* @param {Function} errorFunction The function that is executed when the action has cause an error
*/
CpProxyAvOpenhomeOrgStreaming1.prototype.TracksMax = function(successFunction, errorFunction){ 
...
* @param {Function} errorFunction The function that is executed when the action has cause an error
*/
CpProxyAvOpenhomeOrgStreaming1.prototype.IdArray = function(successFunction, errorFunction){ 
...
* @param {Function} errorFunction The function that is executed when the action has cause an error
*/
CpProxyAvOpenhomeOrgStreaming1.prototype.IdArrayChanged = function(Token, successFunction, errorFunction){ 
...
* @param {Function} errorFunction The function that is executed when the action has cause an error
*/
CpProxyAvOpenhomeOrgStreaming1.prototype.ProtocolInfo = function(successFunction, errorFunction){ 
