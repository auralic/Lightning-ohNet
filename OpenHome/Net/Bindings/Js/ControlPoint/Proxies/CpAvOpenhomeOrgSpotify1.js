...
/**
* Service Proxy for CpProxyAvOpenhomeOrgSpotify1
* @module ohnet
* @class Spotify
*/
    
var CpProxyAvOpenhomeOrgSpotify1 = function(udn){ 

    this.url = window.location.protocol + "//" + window.location.host + "/" + udn + "/av.openhome.org-Spotify-1/control";  // upnp control url
    this.domain = "av-openhome-org";
    this.type = "Spotify";
    this.version = "1";
    this.serviceName = "av.openhome.org-Spotify-1";
...
*/
CpProxyAvOpenhomeOrgSpotify1.prototype.subscribe = function (serviceAddedFunction) {
...
* @method Unsubscribe
*/
CpProxyAvOpenhomeOrgSpotify1.prototype.unsubscribe = function () {
...
*/
CpProxyAvOpenhomeOrgSpotify1.prototype.TransportState_Changed = function (stateChangedFunction) {
...
*/
CpProxyAvOpenhomeOrgSpotify1.prototype.Play = function(successFunction, errorFunction){ 
...
* @param {Function} errorFunction The function that is executed when the action has cause an error
*/
CpProxyAvOpenhomeOrgSpotify1.prototype.Pause = function(successFunction, errorFunction){ 
...
* @param {Function} errorFunction The function that is executed when the action has cause an error
*/
CpProxyAvOpenhomeOrgSpotify1.prototype.Next = function(successFunction, errorFunction){ 
...
* @param {Function} errorFunction The function that is executed when the action has cause an error
*/
CpProxyAvOpenhomeOrgSpotify1.prototype.Previous = function(successFunction, errorFunction){ 
...
* @param {Function} errorFunction The function that is executed when the action has cause an error
*/
CpProxyAvOpenhomeOrgSpotify1.prototype.TransportState = function(successFunction, errorFunction){ 
