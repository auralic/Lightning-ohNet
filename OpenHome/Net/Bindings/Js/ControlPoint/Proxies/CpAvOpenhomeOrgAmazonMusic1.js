...
/**
* Service Proxy for CpProxyAvOpenhomeOrgAmazonMusic1
* @module ohnet
* @class AmazonMusic
*/
    
var CpProxyAvOpenhomeOrgAmazonMusic1 = function(udn){ 

    this.url = window.location.protocol + "//" + window.location.host + "/" + udn + "/av.openhome.org-AmazonMusic-1/control";  // upnp control url
    this.domain = "av-openhome-org";
    this.type = "AmazonMusic";
    this.version = "1";
    this.serviceName = "av.openhome.org-AmazonMusic-1";
...
*/
CpProxyAvOpenhomeOrgAmazonMusic1.prototype.subscribe = function (serviceAddedFunction) {
...
* @method Unsubscribe
*/
CpProxyAvOpenhomeOrgAmazonMusic1.prototype.unsubscribe = function () {
...
*/
CpProxyAvOpenhomeOrgAmazonMusic1.prototype.TransportState_Changed = function (stateChangedFunction) {
...
* @param {Function} stateChangedFunction The handler for state changes
*/
CpProxyAvOpenhomeOrgAmazonMusic1.prototype.Id_Changed = function (stateChangedFunction) {
...
*/
CpProxyAvOpenhomeOrgAmazonMusic1.prototype.LogIn = function(successFunction, errorFunction){ 
...
* @param {Function} errorFunction The function that is executed when the action has cause an error
*/
CpProxyAvOpenhomeOrgAmazonMusic1.prototype.Play = function(successFunction, errorFunction){ 
...
* @param {Function} errorFunction The function that is executed when the action has cause an error
*/
CpProxyAvOpenhomeOrgAmazonMusic1.prototype.Pause = function(successFunction, errorFunction){ 
...
* @param {Function} errorFunction The function that is executed when the action has cause an error
*/
CpProxyAvOpenhomeOrgAmazonMusic1.prototype.Stop = function(successFunction, errorFunction){ 
...
* @param {Function} errorFunction The function that is executed when the action has cause an error
*/
CpProxyAvOpenhomeOrgAmazonMusic1.prototype.Next = function(successFunction, errorFunction){ 
...
* @param {Function} errorFunction The function that is executed when the action has cause an error
*/
CpProxyAvOpenhomeOrgAmazonMusic1.prototype.Previous = function(successFunction, errorFunction){ 
...
* @param {Function} errorFunction The function that is executed when the action has cause an error
*/
CpProxyAvOpenhomeOrgAmazonMusic1.prototype.SeekSecondAbsolute = function(Value, successFunction, errorFunction){ 
...
* @param {Function} errorFunction The function that is executed when the action has cause an error
*/
CpProxyAvOpenhomeOrgAmazonMusic1.prototype.SeekSecondRelative = function(Value, successFunction, errorFunction){ 
...
* @param {Function} errorFunction The function that is executed when the action has cause an error
*/
CpProxyAvOpenhomeOrgAmazonMusic1.prototype.TransportState = function(successFunction, errorFunction){ 
...
* @param {Function} errorFunction The function that is executed when the action has cause an error
*/
CpProxyAvOpenhomeOrgAmazonMusic1.prototype.Insert = function(AfterId, Uri, Metadata, successFunction, errorFunction){ 
