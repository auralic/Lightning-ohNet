...
/**
* Service Proxy for CpProxyAvOpenhomeOrgResamplerConfig1
* @module ohnet
* @class ResamplerConfig
*/
    
var CpProxyAvOpenhomeOrgResamplerConfig1 = function(udn){ 

    this.url = window.location.protocol + "//" + window.location.host + "/" + udn + "/av.openhome.org-ResamplerConfig-1/control";  // upnp control url
    this.domain = "av-openhome-org";
    this.type = "ResamplerConfig";
    this.version = "1";
    this.serviceName = "av.openhome.org-ResamplerConfig-1";
...
*/
CpProxyAvOpenhomeOrgResamplerConfig1.prototype.subscribe = function (serviceAddedFunction) {
...
* @method Unsubscribe
*/
CpProxyAvOpenhomeOrgResamplerConfig1.prototype.unsubscribe = function () {
...
*/
CpProxyAvOpenhomeOrgResamplerConfig1.prototype.CurrentAction_Changed = function (stateChangedFunction) {
...
*/
CpProxyAvOpenhomeOrgResamplerConfig1.prototype.SetResamplerConfig = function(ResamplerConfig, successFunction, errorFunction){ 
...
* @param {Function} errorFunction The function that is executed when the action has cause an error
*/
CpProxyAvOpenhomeOrgResamplerConfig1.prototype.GetResamplerConfig = function(successFunction, errorFunction){ 
...
* @param {Function} errorFunction The function that is executed when the action has cause an error
*/
CpProxyAvOpenhomeOrgResamplerConfig1.prototype.SetPCMAutoDetect = function(PCMAutoDetect, successFunction, errorFunction){ 
...
* @param {Function} errorFunction The function that is executed when the action has cause an error
*/
CpProxyAvOpenhomeOrgResamplerConfig1.prototype.GetPCMAutoDetect = function(successFunction, errorFunction){ 
...
* @param {Function} errorFunction The function that is executed when the action has cause an error
*/
CpProxyAvOpenhomeOrgResamplerConfig1.prototype.SetDSDtoPCM = function(DSDtoPCM, successFunction, errorFunction){ 
...
* @param {Function} errorFunction The function that is executed when the action has cause an error
*/
CpProxyAvOpenhomeOrgResamplerConfig1.prototype.GetDSDtoPCM = function(successFunction, errorFunction){ 
