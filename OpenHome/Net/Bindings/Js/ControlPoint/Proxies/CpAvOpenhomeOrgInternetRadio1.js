...
/**
* Service Proxy for CpProxyAvOpenhomeOrgInternetRadio1
* @module ohnet
* @class InternetRadio
*/
    
var CpProxyAvOpenhomeOrgInternetRadio1 = function(udn){ 

    this.url = window.location.protocol + "//" + window.location.host + "/" + udn + "/av.openhome.org-InternetRadio-1/control";  // upnp control url
    this.domain = "av-openhome-org";
    this.type = "InternetRadio";
    this.version = "1";
    this.serviceName = "av.openhome.org-InternetRadio-1";
...
*/
CpProxyAvOpenhomeOrgInternetRadio1.prototype.subscribe = function (serviceAddedFunction) {
...
* @method Unsubscribe
*/
CpProxyAvOpenhomeOrgInternetRadio1.prototype.unsubscribe = function () {
...
*/
CpProxyAvOpenhomeOrgInternetRadio1.prototype.Uri_Changed = function (stateChangedFunction) {
...
* @param {Function} stateChangedFunction The handler for state changes
*/
CpProxyAvOpenhomeOrgInternetRadio1.prototype.Metadata_Changed = function (stateChangedFunction) {
...
* @param {Function} stateChangedFunction The handler for state changes
*/
CpProxyAvOpenhomeOrgInternetRadio1.prototype.TransportState_Changed = function (stateChangedFunction) {
...
*/
CpProxyAvOpenhomeOrgInternetRadio1.prototype.Play = function(successFunction, errorFunction){ 
...
* @param {Function} errorFunction The function that is executed when the action has cause an error
*/
CpProxyAvOpenhomeOrgInternetRadio1.prototype.Stop = function(successFunction, errorFunction){ 
...
* @param {Function} errorFunction The function that is executed when the action has cause an error
*/
CpProxyAvOpenhomeOrgInternetRadio1.prototype.SetSender = function(Uri, Metadata, successFunction, errorFunction){ 
...
* @param {Function} errorFunction The function that is executed when the action has cause an error
*/
CpProxyAvOpenhomeOrgInternetRadio1.prototype.Sender = function(successFunction, errorFunction){ 
...
* @param {Function} errorFunction The function that is executed when the action has cause an error
*/
CpProxyAvOpenhomeOrgInternetRadio1.prototype.TransportState = function(successFunction, errorFunction){ 
