...
interface IDvProviderAvOpenhomeOrgAmazonMusic1
{
 ...
 */
public class DvProviderAvOpenhomeOrgAmazonMusic1 extends DvProvider implements IDvProviderAvOpenhomeOrgAmazonMusic1
{
     ...
     */
    protected DvProviderAvOpenhomeOrgAmazonMusic1(DvDevice aDevice)
    {
        super(aDevice, "av.openhome.org", "AmazonMusic", 1);
    }
     ...
     */
    protected void logIn(IDvInvocation aInvocation)
    {
