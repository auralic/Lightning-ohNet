...
import org.openhome.net.controlpoint.proxies.CpProxyAvOpenhomeOrgSpotify1.*;
import org.openhome.net.core.*;

    
interface ICpProxyAvOpenhomeOrgSpotify1 extends ICpProxy
{
...
class SyncPlayAvOpenhomeOrgSpotify1 extends SyncProxyAction
{
    private CpProxyAvOpenhomeOrgSpotify1 iService;

    public SyncPlayAvOpenhomeOrgSpotify1(CpProxyAvOpenhomeOrgSpotify1 aProxy)
    {
        iService = aProxy;
    }
...
class SyncPauseAvOpenhomeOrgSpotify1 extends SyncProxyAction
{
    private CpProxyAvOpenhomeOrgSpotify1 iService;

    public SyncPauseAvOpenhomeOrgSpotify1(CpProxyAvOpenhomeOrgSpotify1 aProxy)
    {
        iService = aProxy;
    }
    protected void completeRequest(long aAsyncHandle)
...
class SyncNextAvOpenhomeOrgSpotify1 extends SyncProxyAction
{
    private CpProxyAvOpenhomeOrgSpotify1 iService;

    public SyncNextAvOpenhomeOrgSpotify1(CpProxyAvOpenhomeOrgSpotify1 aProxy)
    {
        iService = aProxy;
    }
    protected void completeRequest(long aAsyncHandle)
...
class SyncPreviousAvOpenhomeOrgSpotify1 extends SyncProxyAction
{
    private CpProxyAvOpenhomeOrgSpotify1 iService;

    public SyncPreviousAvOpenhomeOrgSpotify1(CpProxyAvOpenhomeOrgSpotify1 aProxy)
    {
        iService = aProxy;
    }
    protected void completeRequest(long aAsyncHandle)
...
class SyncTransportStateAvOpenhomeOrgSpotify1 extends SyncProxyAction
{
    private CpProxyAvOpenhomeOrgSpotify1 iService;
    private String iValue;

    public SyncTransportStateAvOpenhomeOrgSpotify1(CpProxyAvOpenhomeOrgSpotify1 aProxy)
    {
        iService = aProxy;
    }
...
/**
 * Proxy for the av.openhome.org:Spotify:1 UPnP service
 */
public class CpProxyAvOpenhomeOrgSpotify1 extends CpProxy implements ICpProxyAvOpenhomeOrgSpotify1
{
    ...
    public CpProxyAvOpenhomeOrgSpotify1(CpDevice aDevice)
    {
        super("av-openhome-org", "Spotify", 1, aDevice);
        Parameter param;
    ...
    public void syncPlay()
    {
        SyncPlayAvOpenhomeOrgSpotify1 sync = new SyncPlayAvOpenhomeOrgSpotify1(this);
    ...
    public void syncPause()
    {
        SyncPauseAvOpenhomeOrgSpotify1 sync = new SyncPauseAvOpenhomeOrgSpotify1(this);
    ...
    public void syncNext()
    {
        SyncNextAvOpenhomeOrgSpotify1 sync = new SyncNextAvOpenhomeOrgSpotify1(this);
    ...
    public void syncPrevious()
    {
        SyncPreviousAvOpenhomeOrgSpotify1 sync = new SyncPreviousAvOpenhomeOrgSpotify1(this);
    ...
    public String syncTransportState()
    {
        SyncTransportStateAvOpenhomeOrgSpotify1 sync = new SyncTransportStateAvOpenhomeOrgSpotify1(this);
