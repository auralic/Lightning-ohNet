...
/**
 * Callback which runs when the GetBitPerfectMode action is invoked
 *
 * @param[in]  aPtr           Opaque data passed to DvProviderAvOpenhomeOrgGroupConfig1EnableActionGetBitPerfectMode
 * @param[in]  aInvocation    Table of function pointers allowing access to the version of the service being used
 *                            and other queries.
 * @param[in] aInvocationPtr  aPtr argument to all functions contained in aInvocation.
 ...
 * @return  0 if the action succeeded; non-zero if the action failed
 */
typedef int32_t (STDCALL *CallbackGroupConfig1GetBitPerfectMode)(void* aPtr, IDvInvocationC* aInvocation, void* aInvocationPtr, uint32_t* aBitPerfectMode);
/**
 * Callback which runs when the SetBitPerfectMode action is invoked
 *
 * @param[in]  aPtr           Opaque data passed to DvProviderAvOpenhomeOrgGroupConfig1EnableActionSetBitPerfectMode
 * @param[in]  aInvocation    Table of function pointers allowing access to the version of the service being used
 *                            and other queries.
 * @param[in] aInvocationPtr  aPtr argument to all functions contained in aInvocation.
 ...
 * @return  0 if the action succeeded; non-zero if the action failed
 */
typedef int32_t (STDCALL *CallbackGroupConfig1SetBitPerfectMode)(void* aPtr, IDvInvocationC* aInvocation, void* aInvocationPtr, uint32_t aBitPerfectMode);
 ...
 */
DllExport void STDCALL DvProviderAvOpenhomeOrgGroupConfig1EnablePropertyBitPerfectMode(THandle aProvider);
...
/**
 * Register a callback for the action GetBitPerfectMode
 *
 * If this is called, the action's availability will be published in the device's service.xml.
 * If this is not called, any attempt to invoke the action on a control point will fail.
 *
 ...
 * @param[in] aPtr       Client-specified data which will be passed to the callback
 */
DllExport void STDCALL DvProviderAvOpenhomeOrgGroupConfig1EnableActionGetBitPerfectMode(THandle aProvider, CallbackGroupConfig1GetBitPerfectMode aCallback, void* aPtr);
/**
 * Register a callback for the action SetBitPerfectMode
 *
 * If this is called, the action's availability will be published in the device's service.xml.
 * If this is not called, any attempt to invoke the action on a control point will fail.
 *
 ...
 * @param[in] aPtr       Client-specified data which will be passed to the callback
 */
DllExport void STDCALL DvProviderAvOpenhomeOrgGroupConfig1EnableActionSetBitPerfectMode(THandle aProvider, CallbackGroupConfig1SetBitPerfectMode aCallback, void* aPtr);
 ...
 *
 * Can only be called if DvProviderAvOpenhomeOrgGroupConfig1EnablePropertyBitPerfectMode has previously been called.
 *
 * @param[in]  aProvider  Handle returned by DvProviderAvOpenhomeOrgGroupConfig1Create
 * @param[in]  aValue     New value for the property
 * @param[out] aChanged   1 if the value has been updated; 0 if it was the same as the previous value
 ...
 *          an attempt to set a property to a value not in its allowed range/set)
 */
DllExport int32_t STDCALL DvProviderAvOpenhomeOrgGroupConfig1SetPropertyBitPerfectMode(THandle aProvider, uint32_t aValue, uint32_t* aChanged);
/**
 ...
 * @param[out] aValue     Value for the property
 */
DllExport void STDCALL DvProviderAvOpenhomeOrgGroupConfig1GetPropertyBitPerfectMode(THandle aProvider, uint32_t* aValue);
