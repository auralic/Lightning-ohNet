...
{
    public interface ICpProxyAvOpenhomeOrgSpotify1 : ICpProxy, IDisposable
    {
        void SyncPlay();
    ...
    internal class SyncPlayAvOpenhomeOrgSpotify1 : SyncProxyAction
    {
    ...
    internal class SyncPauseAvOpenhomeOrgSpotify1 : SyncProxyAction
    {
        private CpProxyAvOpenhomeOrgSpotify1 iService;
    ...
    internal class SyncNextAvOpenhomeOrgSpotify1 : SyncProxyAction
    {
        private CpProxyAvOpenhomeOrgSpotify1 iService;
    ...
    internal class SyncPreviousAvOpenhomeOrgSpotify1 : SyncProxyAction
    {
        private CpProxyAvOpenhomeOrgSpotify1 iService;
    ...
    internal class SyncTransportStateAvOpenhomeOrgSpotify1 : SyncProxyAction
    {
        private CpProxyAvOpenhomeOrgSpotify1 iService;
    ...
    /// </summary>
    public class CpProxyAvOpenhomeOrgSpotify1 : CpProxy, IDisposable, ICpProxyAvOpenhomeOrgSpotify1
    {
        ...
        public CpProxyAvOpenhomeOrgSpotify1(ICpDevice aDevice)
            : base("av-openhome-org", "Spotify", 1, aDevice)
        {
        ...
        /// CpProxyAvOpenhomeOrgSpotify1 instance will not overlap.</remarks>
