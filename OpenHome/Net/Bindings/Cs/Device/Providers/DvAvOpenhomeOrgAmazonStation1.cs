...
{
    public interface IDvProviderAvOpenhomeOrgAmazonStation1 : IDisposable
    {
    ...
    /// </summary>
    public class DvProviderAvOpenhomeOrgAmazonStation1 : DvProvider, IDisposable, IDvProviderAvOpenhomeOrgAmazonStation1
    {
        ...
        protected DvProviderAvOpenhomeOrgAmazonStation1(DvDevice aDevice)
            : base(aDevice, "av.openhome.org", "AmazonStation", 1)
        {
        ...
        private static int DoPlay(IntPtr aPtr, IntPtr aInvocation)
        {
            ...
            DvProviderAvOpenhomeOrgAmazonStation1 self = (DvProviderAvOpenhomeOrgAmazonStation1)gch.Target;
