...
{
    public interface IDvProviderAvOpenhomeOrgAirplay1 : IDisposable
    {
    ...
    /// </summary>
    public class DvProviderAvOpenhomeOrgAirplay1 : DvProvider, IDisposable, IDvProviderAvOpenhomeOrgAirplay1
    {
        ...
        protected DvProviderAvOpenhomeOrgAirplay1(DvDevice aDevice)
            : base(aDevice, "av.openhome.org", "Airplay", 1)
        {
        ...
        private static int DoPlay(IntPtr aPtr, IntPtr aInvocation)
        {
            ...
            DvProviderAvOpenhomeOrgAirplay1 self = (DvProviderAvOpenhomeOrgAirplay1)gch.Target;
