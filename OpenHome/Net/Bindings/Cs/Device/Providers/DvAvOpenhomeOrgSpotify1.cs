...
{
    public interface IDvProviderAvOpenhomeOrgSpotify1 : IDisposable
    {
    ...
    /// </summary>
    public class DvProviderAvOpenhomeOrgSpotify1 : DvProvider, IDisposable, IDvProviderAvOpenhomeOrgSpotify1
    {
        ...
        protected DvProviderAvOpenhomeOrgSpotify1(DvDevice aDevice)
            : base(aDevice, "av.openhome.org", "Spotify", 1)
        {
        ...
        private static int DoPlay(IntPtr aPtr, IntPtr aInvocation)
        {
            ...
            DvProviderAvOpenhomeOrgSpotify1 self = (DvProviderAvOpenhomeOrgSpotify1)gch.Target;
