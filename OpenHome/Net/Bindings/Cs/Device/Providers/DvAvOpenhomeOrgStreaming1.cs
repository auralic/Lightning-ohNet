...
{
    public interface IDvProviderAvOpenhomeOrgStreaming1 : IDisposable
    {
    ...
    /// </summary>
    public class DvProviderAvOpenhomeOrgStreaming1 : DvProvider, IDisposable, IDvProviderAvOpenhomeOrgStreaming1
    {
        ...
        protected DvProviderAvOpenhomeOrgStreaming1(DvDevice aDevice)
            : base(aDevice, "av.openhome.org", "Streaming", 1)
        {
        ...
        private static int DoPlay(IntPtr aPtr, IntPtr aInvocation)
        {
            ...
            DvProviderAvOpenhomeOrgStreaming1 self = (DvProviderAvOpenhomeOrgStreaming1)gch.Target;
