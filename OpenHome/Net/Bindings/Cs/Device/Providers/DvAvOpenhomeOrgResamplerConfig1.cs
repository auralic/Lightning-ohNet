...
{
    public interface IDvProviderAvOpenhomeOrgResamplerConfig1 : IDisposable
    {
    ...
    /// </summary>
    public class DvProviderAvOpenhomeOrgResamplerConfig1 : DvProvider, IDisposable, IDvProviderAvOpenhomeOrgResamplerConfig1
    {
        ...
        protected DvProviderAvOpenhomeOrgResamplerConfig1(DvDevice aDevice)
            : base(aDevice, "av.openhome.org", "ResamplerConfig", 1)
        {
        ...
        private static int DoSetResamplerConfig(IntPtr aPtr, IntPtr aInvocation)
        {
            ...
            DvProviderAvOpenhomeOrgResamplerConfig1 self = (DvProviderAvOpenhomeOrgResamplerConfig1)gch.Target;
