...
{
    public interface IDvProviderAvOpenhomeOrgInternetRadio1 : IDisposable
    {
    ...
    /// </summary>
    public class DvProviderAvOpenhomeOrgInternetRadio1 : DvProvider, IDisposable, IDvProviderAvOpenhomeOrgInternetRadio1
    {
        ...
        protected DvProviderAvOpenhomeOrgInternetRadio1(DvDevice aDevice)
            : base(aDevice, "av.openhome.org", "InternetRadio", 1)
        {
        ...
        private static int DoPlay(IntPtr aPtr, IntPtr aInvocation)
        {
            ...
            DvProviderAvOpenhomeOrgInternetRadio1 self = (DvProviderAvOpenhomeOrgInternetRadio1)gch.Target;
