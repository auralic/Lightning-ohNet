#ifndef HEADER_DVAVOPENHOMEORGRESAMPLERCONFIG1
#define HEADER_DVAVOPENHOMEORGRESAMPLERCONFIG1
 ...
 * @ingroup Providers
 */
class DvProviderAvOpenhomeOrgResamplerConfig1 : public DvProvider
{
public:
    virtual ~DvProviderAvOpenhomeOrgResamplerConfig1() {}
    /**
...
protected:
     ...
     */
    DvProviderAvOpenhomeOrgResamplerConfig1(DvDevice& aDevice);
    /**
     * Constructor.  Not for external use.
     *
     * @param[in] aDevice  Device which owns this provider
     */
    DvProviderAvOpenhomeOrgResamplerConfig1(DviDevice& aDevice);
    /**
...
private:
    DvProviderAvOpenhomeOrgResamplerConfig1();
    void Construct();
...
#endif // HEADER_DVAVOPENHOMEORGRESAMPLERCONFIG1
