#ifndef HEADER_DVAVOPENHOMEORGAIRPLAY1
#define HEADER_DVAVOPENHOMEORGAIRPLAY1
 ...
 * @ingroup Providers
 */
class DvProviderAvOpenhomeOrgAirplay1 : public DvProvider
{
public:
    virtual ~DvProviderAvOpenhomeOrgAirplay1() {}
    /**
...
protected:
     ...
     */
    DvProviderAvOpenhomeOrgAirplay1(DvDevice& aDevice);
    /**
     * Constructor.  Not for external use.
     *
     * @param[in] aDevice  Device which owns this provider
     */
    DvProviderAvOpenhomeOrgAirplay1(DviDevice& aDevice);
    /**
...
private:
    DvProviderAvOpenhomeOrgAirplay1();
    void Construct();
...
#endif // HEADER_DVAVOPENHOMEORGAIRPLAY1
