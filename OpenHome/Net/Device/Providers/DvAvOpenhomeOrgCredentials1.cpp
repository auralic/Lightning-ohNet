...
void DvProviderAvOpenhomeOrgCredentials1::WritePropertyIds(IWriter& aWriter)
{
    iPropertyIds->Write(aWriter);
}
...
void DvProviderAvOpenhomeOrgCredentials1::WritePropertyPublicKey(IWriter& aWriter)
{
    iPropertyPublicKey->Write(aWriter);
}
