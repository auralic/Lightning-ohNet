#ifndef HEADER_DVAVOPENHOMEORGMUSICSTATION1
#define HEADER_DVAVOPENHOMEORGMUSICSTATION1
 ...
 * @ingroup Providers
 */
class DvProviderAvOpenhomeOrgMusicStation1 : public DvProvider
{
public:
    virtual ~DvProviderAvOpenhomeOrgMusicStation1() {}
    /**
...
protected:
     ...
     */
    DvProviderAvOpenhomeOrgMusicStation1(DvDevice& aDevice);
    /**
     * Constructor.  Not for external use.
     *
     * @param[in] aDevice  Device which owns this provider
     */
    DvProviderAvOpenhomeOrgMusicStation1(DviDevice& aDevice);
    /**
...
private:
    DvProviderAvOpenhomeOrgMusicStation1();
    void Construct();
...
#endif // HEADER_DVAVOPENHOMEORGMUSICSTATION1
