#ifndef HEADER_DVAVOPENHOMEORGSTREAMING1
#define HEADER_DVAVOPENHOMEORGSTREAMING1
 ...
 * @ingroup Providers
 */
class DvProviderAvOpenhomeOrgStreaming1 : public DvProvider
{
public:
    virtual ~DvProviderAvOpenhomeOrgStreaming1() {}
    /**
...
protected:
     ...
     */
    DvProviderAvOpenhomeOrgStreaming1(DvDevice& aDevice);
    /**
     * Constructor.  Not for external use.
     *
     * @param[in] aDevice  Device which owns this provider
     */
    DvProviderAvOpenhomeOrgStreaming1(DviDevice& aDevice);
    /**
...
private:
    DvProviderAvOpenhomeOrgStreaming1();
    void Construct();
...
#endif // HEADER_DVAVOPENHOMEORGSTREAMING1
