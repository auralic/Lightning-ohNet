#ifndef HEADER_DVAVOPENHOMEORGTIDALCONNECT1
#define HEADER_DVAVOPENHOMEORGTIDALCONNECT1
 ...
 * @ingroup Providers
 */
class DvProviderAvOpenhomeOrgTidalConnect1 : public DvProvider
{
public:
    virtual ~DvProviderAvOpenhomeOrgTidalConnect1() {}
    /**
...
protected:
     ...
     */
    DvProviderAvOpenhomeOrgTidalConnect1(DvDevice& aDevice);
    /**
     * Constructor.  Not for external use.
     *
     * @param[in] aDevice  Device which owns this provider
     */
    DvProviderAvOpenhomeOrgTidalConnect1(DviDevice& aDevice);
    /**
...
private:
     ...
     */
    virtual void RequestMetadata(IDvInvocation& aInvocation);
    /**
...
private:
    DvProviderAvOpenhomeOrgTidalConnect1();
    void Construct();
...
#endif // HEADER_DVAVOPENHOMEORGTIDALCONNECT1
