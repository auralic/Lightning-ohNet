#ifndef HEADER_AVOPENHOMEORGRESAMPLERCONFIG1
#define HEADER_AVOPENHOMEORGRESAMPLERCONFIG1
 ...
 * @ingroup Proxies
 */
class CpProxyAvOpenhomeOrgResamplerConfig1 : public CpProxy
{
public:
    /**
     * Constructor.
     ...
     */
    CpProxyAvOpenhomeOrgResamplerConfig1(CpDevice& aDevice);
    /**
     * Destructor.
     ...
     */
    ~CpProxyAvOpenhomeOrgResamplerConfig1();
...
#endif // HEADER_AVOPENHOMEORGRESAMPLERCONFIG1
