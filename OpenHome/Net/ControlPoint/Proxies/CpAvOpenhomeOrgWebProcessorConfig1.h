#ifndef HEADER_AVOPENHOMEORGWEBPROCESSORCONFIG1
#define HEADER_AVOPENHOMEORGWEBPROCESSORCONFIG1
...
class PropertyUint;
class CpProxy;
class ICpProxyAvOpenhomeOrgWebProcessorConfig1 : public ICpProxy
{
public:
    virtual ~ICpProxyAvOpenhomeOrgWebProcessorConfig1() {}
    virtual void SyncGetProcessorConfig(Brh& aProcessorConfig) = 0;
    virtual void BeginGetProcessorConfig(FunctorAsync& aFunctor) = 0;
    virtual void EndGetProcessorConfig(IAsync& aAsync, Brh& aProcessorConfig) = 0;
    virtual void SyncSetProcessorConfig(const Brx& aProcessorConfig) = 0;
    virtual void BeginSetProcessorConfig(const Brx& aProcessorConfig, FunctorAsync& aFunctor) = 0;
    ...
    virtual void PropertyProcessorConfig(Brhz& aProcessorConfig) const = 0;
};
 ...
 * @ingroup Proxies
 */
class CpProxyAvOpenhomeOrgWebProcessorConfig1 : public ICpProxyAvOpenhomeOrgWebProcessorConfig1
{
public:
    /**
     * Constructor.
     ...
     */
    CpProxyAvOpenhomeOrgWebProcessorConfig1(CpDevice& aDevice);
    /**
     * Destructor.
...
#endif // HEADER_AVOPENHOMEORGWEBPROCESSORCONFIG1
