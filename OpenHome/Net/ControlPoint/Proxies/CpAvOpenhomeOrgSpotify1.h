#ifndef HEADER_AVOPENHOMEORGSPOTIFY1
#define HEADER_AVOPENHOMEORGSPOTIFY1
...
class PropertyUint;
class CpProxy;
class ICpProxyAvOpenhomeOrgSpotify1 : public ICpProxy
{
public:
    virtual ~ICpProxyAvOpenhomeOrgSpotify1() {}
 ...
 * @ingroup Proxies
 */
class CpProxyAvOpenhomeOrgSpotify1 : public ICpProxyAvOpenhomeOrgSpotify1
{
public:
    /**
     * Constructor.
     ...
     */
    CpProxyAvOpenhomeOrgSpotify1(CpDevice& aDevice);
    /**
     * Destructor.
...
#endif // HEADER_AVOPENHOMEORGSPOTIFY1
