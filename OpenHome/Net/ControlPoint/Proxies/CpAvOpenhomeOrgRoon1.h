#ifndef HEADER_AVOPENHOMEORGROON1
#define HEADER_AVOPENHOMEORGROON1
...
class PropertyUint;
class CpProxy;
class ICpProxyAvOpenhomeOrgRoon1 : public ICpProxy
{
public:
    virtual ~ICpProxyAvOpenhomeOrgRoon1() {}
 ...
 * @ingroup Proxies
 */
class CpProxyAvOpenhomeOrgRoon1 : public ICpProxyAvOpenhomeOrgRoon1
{
public:
    /**
     * Constructor.
     ...
     */
    CpProxyAvOpenhomeOrgRoon1(CpDevice& aDevice);
    /**
     * Destructor.
...
#endif // HEADER_AVOPENHOMEORGROON1
