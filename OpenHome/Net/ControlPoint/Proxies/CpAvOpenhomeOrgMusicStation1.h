#ifndef HEADER_AVOPENHOMEORGMUSICSTATION1
#define HEADER_AVOPENHOMEORGMUSICSTATION1
...
class PropertyUint;
class CpProxy;
class ICpProxyAvOpenhomeOrgMusicStation1 : public ICpProxy
{
public:
    virtual ~ICpProxyAvOpenhomeOrgMusicStation1() {}
 ...
 * @ingroup Proxies
 */
class CpProxyAvOpenhomeOrgMusicStation1 : public ICpProxyAvOpenhomeOrgMusicStation1
{
public:
    /**
     * Constructor.
     ...
     */
    CpProxyAvOpenhomeOrgMusicStation1(CpDevice& aDevice);
    /**
     * Destructor.
...
#endif // HEADER_AVOPENHOMEORGMUSICSTATION1
