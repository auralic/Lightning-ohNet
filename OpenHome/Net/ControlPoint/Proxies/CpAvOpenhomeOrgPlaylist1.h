...
public:
    ...
    virtual void SyncSimpleReadList(const Brx& aIdList, Brh& aTrackList) = 0;
    virtual void BeginSimpleReadList(const Brx& aIdList, FunctorAsync& aFunctor) = 0;
    virtual void EndSimpleReadList(IAsync& aAsync, Brh& aTrackList) = 0;
    ...
    virtual void SyncBatchInsert(TUint aAfterId, const Brx& aSongList, TUint& aNewId) = 0;
    virtual void BeginBatchInsert(TUint aAfterId, const Brx& aSongList, FunctorAsync& aFunctor) = 0;
    virtual void EndBatchInsert(IAsync& aAsync, TUint& aNewId) = 0;
