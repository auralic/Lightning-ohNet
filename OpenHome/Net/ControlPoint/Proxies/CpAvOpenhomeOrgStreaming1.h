#ifndef HEADER_AVOPENHOMEORGSTREAMING1
#define HEADER_AVOPENHOMEORGSTREAMING1
...
class PropertyUint;
class CpProxy;
class ICpProxyAvOpenhomeOrgStreaming1 : public ICpProxy
{
public:
    virtual ~ICpProxyAvOpenhomeOrgStreaming1() {}
 ...
 * @ingroup Proxies
 */
class CpProxyAvOpenhomeOrgStreaming1 : public ICpProxyAvOpenhomeOrgStreaming1
{
public:
    /**
     * Constructor.
     ...
     */
    CpProxyAvOpenhomeOrgStreaming1(CpDevice& aDevice);
    /**
     * Destructor.
...
#endif // HEADER_AVOPENHOMEORGSTREAMING1
